...
tableextension 6272 "Sust. Service Cr. Memo Header" extends "Service Cr.Memo Header"
{
    fields
    {
        field(6210; "Sustainability Lines Exist"; Boolean)
        {
            ...
            CalcFormula = exist("Service Cr.Memo Line" where("Sust. Account No." = filter('<>'''''), "Document No." = field("No.")));
        }
