...
table 6254 "Sust. Standard Requirement"
{
    ...
    fields
    {
        field(1; StandardRequirementId; Guid)
        {
            ExternalName = 'msdyn_standardrequirementid';
        ...
        field(25; StateCode; Option)
        {
            ...
            Description = 'Status of the Standard Requirement';
            Caption = 'Status';
            InitValue = " ";
        ...
        field(27; StatusCode; Option)
        {
            ...
            ExternalType = 'Status';
            Description = 'Reason for the status of the Standard Requirement';
        ...
        field(45; ParentStdRequirementId; Guid)
        {
            ExternalName = 'msdyn_parentstdrequirementid';
            ExternalType = 'Lookup';
            Description = 'Parent requirement';
            Caption = 'Parent Requirement';
            TableRelation = "Sust. Standard Requirement".StandardRequirementId;
        }
        field(46; ShortCode; Text[800])
        {
        ...
        field(48; ParentStdRequirementIdName; Text[830])
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Sust. Standard Requirement".Name where(StandardRequirementId = field(ParentStdRequirementId)));
            ExternalName = 'msdyn_parentstdrequirementidname';
            ExternalType = 'String';
            ExternalAccess = Read;
        }
    }
