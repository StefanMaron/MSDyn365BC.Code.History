...
page 6284 "Water Type Intensity Bar Chart"
{
    PageType = CardPart;
    SourceTable = "Business Chart Buffer";
    Caption = 'Water Type Intensity Bar Chart';
    ...
    begin
        SustainabilityChartMgmt.UpdateBarByEmissionGas(Rec, SustainabilityChartMgmt.GetWater(), true);
