    ...
    actions
    {
        addlast("PBI Reports")
        {
            group("Sustainability Reports")
            {
                ...
                action("Sustainability Overview")
                {
                    ApplicationArea = Basic, Suite;
                ...
                action("Realized Emissions vs Target")
                {
                    ApplicationArea = Basic, Suite;
                ...
                action("Realized Emissions vs Baseline")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Realized Emissions vs. Baseline';
                    Image = "PowerBI";
                    RunObject = page "Emissions vs Baseline Power BI";
                    ToolTip = 'Open the Power BI Report page Realized Emissions vs. Baseline which showcases the differences between an organization''s emissions and the baseline they have set.';
                }
                action("Water and Waste Analysis")
                {
                    ApplicationArea = Basic, Suite;
                ...
                action("Emissions by Category and Scope")
                {
                    ApplicationArea = Basic, Suite;
                ...
                action("Journey to Net Zero Carbon")
                {
                    ApplicationArea = Basic, Suite;
                ...
                action("CO2e Decomposition Tree")
                {
                    ApplicationArea = Basic, Suite;
