...
tableextension 6229 "Sust. Item Charge" extends "Item Charge"
{
    fields
    {
    ...
    local procedure ClearDefaultEmissionInformation(var ItemCharge: Record "Item Charge")
    begin
        ItemCharge.Validate("Default N2O Emission", 0);
        ItemCharge.Validate("Default CH4 Emission", 0);
        ItemCharge.Validate("Default CO2 Emission", 0);
    end;
}