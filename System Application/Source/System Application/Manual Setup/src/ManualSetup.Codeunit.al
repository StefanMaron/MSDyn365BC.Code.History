...
codeunit 1875 "Manual Setup"
{
    ...
    begin
        ManualSetupImpl.Open(ManualSetupCategory);
    end;
    ...
    begin
        ManualSetupImpl.GetPageIDs(PageIDs);
    end;
    ...
    internal procedure GetTemporaryRecord(var TemporaryManualSetup: Record "Manual Setup" temporary);
    begin
