...
codeunit 139688 "Recurring Billing Test"
{
    ...
    procedure CreateCustomerContract(BillingPeriod: Text; BillingBasePeriod: Text)
    begin
    ...
    procedure CreateCustomerContract(PeriodCalculation: Enum "Period Calculation"; BillingPeriod: Text; BillingBasePeriod: Text; BillFromDate: Date; UnitPrice: Decimal; UnitCost: Decimal)
    begin
        InitTest();
    ...
    procedure CreateBillingProposalForCustomerContractUsingRealTemplate()
    begin
    ...
    procedure CreateBillingProposalForCustomerContractUsingTempTemplate(PeriodCalculation: Enum "Period Calculation"; BillingPeriod: Text; BillingBasePeriod: Text; BillFromDate: Date; BillToDate: Date)
    var
    ...
    procedure CreateVendorContract(BillingPeriod: Text; BillingBasePeriod: Text)
    begin
    ...
    procedure CreateVendorContract(PeriodCalculation: Enum "Period Calculation"; BillingPeriod: Text; BillingBasePeriod: Text; BillFromDate: Date; UnitPrice: Decimal; UnitCost: Decimal)
    begin
        InitTest();
        CreateServiceObjectWithItemSetup();
        ContractTestLibrary.UpdateItemUnitCostAndPrice(Item, UnitCost, UnitPrice, false);
    ...
    procedure CreateBillingProposalForVendorContractUsingRealTemplate()
    var
        GLSetup: Record "General Ledger Setup";
    begin
        GLSetup.Get();
    ...
    procedure CreateBillingProposalForVendorContractUsingTempTemplate(PeriodCalculation: Enum "Period Calculation"; BillingPeriod: Text; BillingBasePeriod: Text; BillFromDate: Date; BillToDate: Date)
    begin
