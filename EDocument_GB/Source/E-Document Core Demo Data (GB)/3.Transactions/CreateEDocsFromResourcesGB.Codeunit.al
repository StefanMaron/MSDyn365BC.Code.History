...
codeunit 10546 "Create EDocs From Resources GB"
{
    ...
    begin
        ...
        CreateEDocFromResourceMapping(EDocFromResourceMapping, 'IT support Support period: January', Enum::"Purchase Line Type"::"G/L Account", CreateGBGLAccounts.ITServices());
        CreateEDocFromResourceMapping(EDocFromResourceMapping, 'IT Support Support period: February', Enum::"Purchase Line Type"::"G/L Account", CreateGBGLAccounts.ITServices());
        CreateEDocFromResourceMapping(EDocFromResourceMapping, 'IT Services Support period: March', Enum::"Purchase Line Type"::"G/L Account", CreateGBGLAccounts.ITServices());
        CreateEDocFromResourceMapping(EDocFromResourceMapping, 'IT Support Support period: May', Enum::"Purchase Line Type"::"G/L Account", CreateGBGLAccounts.ITServices());
        CreateEDocFromResourceMapping(EDocFromResourceMapping, 'Support period: December IT Services', Enum::"Purchase Line Type"::"G/L Account", CreateGBGLAccounts.ITServices());
        IsHandled := true;
    end;
