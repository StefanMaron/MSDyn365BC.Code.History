...
permissionset 11782 "CZ Cash Desk - Objects CZP"
{
    ...
    Permissions = Codeunit "Bank Account Handler CZP" = X,
                  ...
                  Codeunit "Sync.Dep.Fld-BankAccount CZP" = X,
                  Codeunit "Sync.Dep.Fld-CashDeskEvent CZP" = X,
                  Codeunit "Sync.Dep.Fld-CashDeskUser CZP" = X,
                  Codeunit "Sync.Dep.Fld-CurrNomValue CZP" = X,
                  Codeunit "Sync.Dep.Fld-GLSetup CZP" = X,
                  Codeunit "Sync.Dep.Fld-PaymentMethod CZP" = X,
                  Codeunit "Sync.Dep.Fld-PostCashDocHd CZP" = X,
                  Codeunit "Sync.Dep.Fld-PostCashDocLn CZP" = X,
                  Codeunit "Sync.Dep.Fld-SrcCodeSetup CZP" = X,
                  Codeunit "Sync.Dep.Fld-UserSetup CZP" = X,
