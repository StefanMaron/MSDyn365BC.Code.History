codeunit 31055 "Manual Setup Handler CZP"
{
    ...
    local procedure RegisterCashDesk(var Sender: Codeunit "Manual Setup")
    var
    ...
    begin
        ...
        Sender.Insert(CashDeskNameTxt, CashDeskDescriptionTxt,
          CashDeskKeywordsTxt, Page::"Cash Desk List CZP",
          Info.Id(), ManualSetupCategory::Finance);
    end;

    local procedure RegisterCashDeskEvent(var Sender: Codeunit "Manual Setup")
    var
    ...
    begin
        NavApp.GetCurrentModuleInfo(Info);
        Sender.Insert(CashDeskEventNameTxt, CashDeskEventDescriptionTxt,
          CashDeskEventKeywordsTxt, Page::"Cash Desk Events Setup CZP",
          Info.Id(), ManualSetupCategory::Finance);
    end;

    local procedure RegisterNominalValue(var Sender: Codeunit "Manual Setup")
    var
    ...
    begin
        NavApp.GetCurrentModuleInfo(Info);
        Sender.Insert(CurrencyNominalValueNameTxt, CurrencyNominalValueDescriptionTxt,
          CurrencyNominalValueKeywordsTxt, Page::"Currency Nominal Values CZP",
          Info.Id(), ManualSetupCategory::Finance);
    end;

    local procedure RegisterPaymentMethod(var Sender: Codeunit "Manual Setup")
    var
    ...
    begin
        NavApp.GetCurrentModuleInfo(Info);
        Sender.Insert(CurrencyPaymentMethodNameTxt, CurrencyPaymentMethodDescriptionTxt,
