...
page 31221 "Posted Cash Doc. Stat. CZP"
{
    ...
    begin
        ...
        TotalPostedCashDocumentLineCZP.SetRange("Cash Document No.", Rec."No.");
        if IndexNo = 2 then
    ...
    begin
        ...
        PostedCashDocumentLineCZP.SetRange(PostedCashDocumentLineCZP."Cash Document No.", Rec."No.");
