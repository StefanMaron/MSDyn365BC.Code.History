...
page 31220 "Cash Doc. Statistics CZP"
{
    ...
    begin
        ...
        TotalCashDocumentLineCZP.SetRange("Cash Document No.", Rec."No.");
    ...
    local procedure UpdateLine(var VATAmountLine: Record "VAT Amount Line")
    var
    ...
    begin
        ...
        CashDocumentLineCZP.SetRange(CashDocumentLineCZP."Cash Document No.", Rec."No.");
    ...
    local procedure VATLinesDrillDown(var DrillDownVATAmountLine: Record "VAT Amount Line"; ThisTabAllowsVATEditing: Boolean)
    begin
        ...
        VATAmountLines.InitGlobals(
          ...
          Rec."Amounts Including VAT", false, 0);
