...
codeunit 31281 "Sync.Dep.Fld-Item Jnl. Line CZ"
{
    Access = Internal;
    ...
    local procedure SyncOnBeforeInsertItemJournalLine(var Rec: Record "Item Journal Line")
    begin
        SyncDeprecatedFields(Rec);
    end;

    [EventSubscriber(ObjectType::Table, Database::"Item Journal Line", 'OnBeforeModifyEvent', '', false, false)]
    local procedure SyncOnBeforeModifyItemJournalLine(var Rec: Record "Item Journal Line")
    begin
        SyncDeprecatedFields(Rec);
    end;
