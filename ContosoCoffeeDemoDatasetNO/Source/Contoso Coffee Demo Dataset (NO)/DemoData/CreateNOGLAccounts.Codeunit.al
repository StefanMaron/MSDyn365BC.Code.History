...
codeunit 10660 "Create NO GL Accounts"
{
    ...
    begin
        ...
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.Software(), CreateGLAccount.SoftwareName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.ConsultantServices(), CreateGLAccount.ConsultantServicesName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.ServicesPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.OtherComputerExpenses(), CreateGLAccount.OtherComputerExpensesName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.DeliveryExpenses(), EntertainmentDeductibleLbl, Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.GasolineandMotorOil(), ParkingLbl, Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.OtherCostsofOperations(), CarAllowanceLbl, Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.Travel(), CreateGLAccount.TravelName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroupsNO.NoVatPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ...
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.IncreasesduringtheYearBuildings(), CreateGLAccount.IncreasesduringtheYearBuildingsName(), Enum::"G/L Account Income/Balance"::"Balance Sheet", Enum::"G/L Account Category"::Assets, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", false, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.DecreasesduringtheYearBuildings(), CreateGLAccount.DecreasesduringtheYearBuildingsName(), Enum::"G/L Account Income/Balance"::"Balance Sheet", Enum::"G/L Account Category"::Assets, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.CustDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Sale, CreateVatPostingGroupNO.CUSTHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", false, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.IncreasesduringtheYearOperEquip(), CreateGLAccount.IncreasesduringtheYearOperEquipName(), Enum::"G/L Account Income/Balance"::"Balance Sheet", Enum::"G/L Account Category"::Assets, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ...
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.IncreasesduringtheYearVehicles(), CreateGLAccount.IncreasesduringtheYearVehiclesName(), Enum::"G/L Account Income/Balance"::"Balance Sheet", Enum::"G/L Account Category"::Assets, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ...
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.SalesOtherJobExpenses(), CreateGLAccount.SalesOtherJobExpensesName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Income, SubCategory, Enum::"G/L Account Type"::Posting, '', '', 0, '', Enum::"General Posting Type"::" ", '', FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ...
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.DeliveryExpensesRawMat(), CreateGLAccount.DeliveryExpensesRawMatName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::"Cost of Goods Sold", SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);

        SubCategory := Format(GLAccountCategoryMgt.GetUtilitiesExpense(), 80);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.Cleaning(), CreateGLAccount.CleaningName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.ElectricityandHeating(), CreateGLAccount.ElectricityandHeatingName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.RepairsandMaintenance(), CreateGLAccount.RepairsandMaintenanceName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.OfficeSupplies(), CreateGLAccount.OfficeSuppliesName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ...
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.Advertising(), SellingExpensesLbl, Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.EntertainmentandPR(), AdvertisingLbl, Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);

        SubCategory := Format(GLAccountCategoryMgt.GetRepairsExpense(), 80);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.RepairsandMaintenanceExpense(), CreateGLAccount.RepairsandMaintenanceExpenseName(), Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ...
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.LegalandAccountingServices(), AuditingServicesLbl, Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
        ContosoGLAccount.InsertGLAccount(CreateGLAccount.Miscellaneous(), LegalServicesLbl, Enum::"G/L Account Income/Balance"::"Income Statement", Enum::"G/L Account Category"::Expense, SubCategory, Enum::"G/L Account Type"::Posting, CreatePostingGroupsNO.VendDom(), CreatePostingGroup.MiscPostingGroup(), 0, '', Enum::"General Posting Type"::Purchase, CreateVatPostingGroupNO.VENDHIGH(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", true, false, false);
