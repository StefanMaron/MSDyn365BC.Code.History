codeunit 10726 "Create Acc. Schedule Line NO"
{
    SingleInstance = true;
    ...
    begin
        if Rec."Schedule Name" = CreateAccountScheduleName.CapitalStructure() then
            case Rec."Line No." of
                110000:
                    ValidateRecordFields(Rec, CreateGLAccount.GiroAccount(), Enum::"Acc. Schedule Line Totaling Type"::"Posting Accounts", false);
            end;
