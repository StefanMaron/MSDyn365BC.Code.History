codeunit 148103 "SAF-T XML Tests"
{
    ...
    begin
        ...
        SAFTTestHelper.MockCustLedgEntry(
            SAFTExportHeader."Starting Date", CustNo, Amount, Amount, CustLedgerEntry."Document Type"::Invoice);
        SAFTTestHelper.MockCustLedgEntry(
            SAFTExportHeader."Starting Date", CustNo, 0, -Amount, CustLedgerEntry."Document Type"::Payment);
    ...
    begin
        ...
        SAFTTestHelper.MockVendLedgEntry(
            SAFTExportHeader."Starting Date", VendNo, Amount, Amount, VendorLedgerEntry."Document Type"::Invoice);
        SAFTTestHelper.MockVendLedgEntry(
            SAFTExportHeader."Starting Date", VendNo, 0, -Amount, VendorLedgerEntry."Document Type"::Payment);
    ...
    begin
        ...
        SAFTTestHelper.MockCustLedgEntry(
            SAFTExportHeader."Starting Date", CustNo, Amount, Amount, CustLedgerEntry."Document Type"::Invoice);
        SAFTTestHelper.MockCustLedgEntry(
            SAFTExportHeader."Starting Date", CustNo, -Amount, -Amount, CustLedgerEntry."Document Type"::"Credit Memo");
    ...
    begin
        ...
        SAFTTestHelper.MockVendLedgEntry(
            SAFTExportHeader."Starting Date", VendNo, Amount, Amount, VendorLedgerEntry."Document Type"::Invoice);
        SAFTTestHelper.MockVendLedgEntry(
            SAFTExportHeader."Starting Date", VendNo, -Amount, -Amount, VendorLedgerEntry."Document Type"::"Credit Memo");
