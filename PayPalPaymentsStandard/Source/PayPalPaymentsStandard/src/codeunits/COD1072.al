codeunit 1072 "MS - PayPal Create Demo Data"
{
    ...
    begin
        ...
        MSPayPalStandardAccount.Name := DemoAccountPrefixTxt + MSPayPalStandardAccount.Name;
        MSPayPalStandardAccount.Description := DemoAccountPrefixTxt + MSPayPalStandardAccount.Description;
