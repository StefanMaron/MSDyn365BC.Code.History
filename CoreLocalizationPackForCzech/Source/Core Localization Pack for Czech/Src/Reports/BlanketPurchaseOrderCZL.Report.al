...
report 31204 "Blanket Purchase Order CZL"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Reports/BlanketPurchaseOrder.rdl';
                ...
                if not IsReportInPreviewMode() then begin
                    ...
                    if LogInteraction then begin
                        ...
                        SegManagement.LogDocument(
                          12, "No.", "Doc. No. Occurrence", "No. of Archived Versions", Database::Vendor, "Buy-from Vendor No.",
    ...
    requestpage
    {
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(LogInteractionCZL; LogInteraction)
                    {
                        ...
                        ToolTip = 'Specifies if you want the program to record the blanket order you print as Interactions and add them to the Interaction Log Entry table.';
        ...
        trigger OnOpenPage()
        begin
            ArchiveDocument := PurchasesPayablesSetup."Archive Blanket Orders";
            InitLogInteraction();
    ...
    var
        ...
        BodyLbl: Label 'The blanket purchase order is attached to this message.';
