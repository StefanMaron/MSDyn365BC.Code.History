...
report 31193 "Service Quote CZL"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Src/Reports/ServiceQuote.rdl';
    ...
    dataset
    {
        ...
        dataitem("Service Header"; "Service Header")
        {
            ...
            begin
                ...
                FormatAddress.GetCompanyAddr("Service Header"."Responsibility Center", ResponsibilityCenter, "Company Information", CompanyAddr);
