...
codeunit 31017 "Upgrade Application CZL"
{
    ...
    begin
        ...
        UpdateVendLedgerEntry();
        UpdateGenJournalLine();
        UpdateReminderHeader();
        UpdateIssuedReminderHeader();
        UpdateFinanceChargeMemoHeader();
        UpdateIssuedFinanceChargeMemoHeader();
    ...
    local procedure UpdateVendLedgerEntry();
    var
    ...
    local procedure UpdateReminderHeader();
    var
    ...
    local procedure UpdateIssuedReminderHeader();
    var
    ...
    local procedure UpdateFinanceChargeMemoHeader();
    var
    ...
    local procedure UpdateIssuedFinanceChargeMemoHeader();
    var
