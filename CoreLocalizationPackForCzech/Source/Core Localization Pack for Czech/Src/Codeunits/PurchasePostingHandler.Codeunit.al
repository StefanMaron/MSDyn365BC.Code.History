...
#else
    // TODO: Subscribe the new event OnPostLinesOnAfterGenJnlLinePost from "Purch Post Invoice" instead of obsoleted event OnAfterPostInvPostBuffer from "Purch.-Post"
#endif
