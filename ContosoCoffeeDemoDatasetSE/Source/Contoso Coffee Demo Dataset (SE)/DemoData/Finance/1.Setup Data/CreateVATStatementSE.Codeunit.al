...
codeunit 11248 "Create VAT Statement SE"
{
    ...
    begin
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 170000, '11', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Amount, 0, true, 1, OutputVAT12Lbl);
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 260000, '2004', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '', Enum::"VAT Statement Line Amount Type"::Base, 0, false, 0, PurchaseEU0Lbl);
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 390000, '30', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", '', Enum::"VAT Statement Line Amount Type"::Amount, 1, true, 1, OutputVAT25Lbl);
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 410000, '31', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Amount, 1, true, 1, OutputVAT12Lbl);
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 470000, '3501', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", '', Enum::"VAT Statement Line Amount Type"::Base, 0, false, 1, EUSales25Lbl);
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 480000, '3502', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Base, 0, false, 1, EUSales12Lbl);
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 500000, '3504', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '', Enum::"VAT Statement Line Amount Type"::Base, 0, false, 1, EUSales0Lbl);
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 680000, '42', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '', Enum::"VAT Statement Line Amount Type"::Base, 0, true, 1, OtherSalesetcLbl);
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 750000, '4804', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '', Enum::"VAT Statement Line Amount Type"::Amount, 0, false, 0, PurchaseSE0Lbl);
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 760000, '4805', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '', Enum::"VAT Statement Line Amount Type"::Amount, 0, false, 0, PurchaseSEOnlyLbl);
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), SESTD(), 800000, '48', Enum::"VAT Statement Line Type"::"Row Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '4800..4899', Enum::"VAT Statement Line Amount Type"::" ", 0, true, 0, InputVATLbl);
    ...
    begin
        ...
        if Rec."Statement Template Name" = CreateVATStatement.VATTemplateName() then
            if Rec."Statement Name" = DefaultLbl then
                case Rec."Line No." of
                    200000:
                        UpdateVATStatementLine(Rec, SalesStandardLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    210000:
                        UpdateVATStatementLine(Rec, SalesStandardFullLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    230000:
                        UpdateVATStatementLine(Rec, SalesReducedLbl, FinanceModuleSetup."VAT Prod. Post Grp. Reduced");
                    240000:
                        UpdateVATStatementLine(Rec, SalesReducedFullLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    250000:
                        UpdateVATStatementLine(Rec, SalesReducedTotalLbl, '');
                    270000:
                        UpdateVATStatementLine(Rec, EUStandardLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    290000:
                        UpdateVATStatementLine(Rec, EUReducedLbl, FinanceModuleSetup."VAT Prod. Post Grp. Reduced");
                    300000:
                        UpdateVATStatementLine(Rec, EUReducedTotalLbl, '');
                    320000:
                        UpdateVATStatementLine(Rec, PurchaseStandardLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    330000:
                        UpdateVATStatementLine(Rec, PurchaseStandardFullLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    350000:
                        UpdateVATStatementLine(Rec, PurchaseReducedLbl, FinanceModuleSetup."VAT Prod. Post Grp. Reduced");
                    360000:
                        UpdateVATStatementLine(Rec, PurchaseReducedFullLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    370000:
                    ...
                    420000:
                        UpdateVATStatementLine(Rec, EUReducedTotalLbl, '');
                    450000:
                        UpdateVATStatementLine(Rec, DomesticStandardSalesLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    470000:
                        UpdateVATStatementLine(Rec, DomesticReducedValueLbl, FinanceModuleSetup."VAT Prod. Post Grp. Reduced");
                    480000:
                        UpdateVATStatementLine(Rec, DomesticReducedTotalLbl, '');
                    500000:
                        UpdateVATStatementLine(Rec, EUStandardSuppliesLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    520000:
                        UpdateVATStatementLine(Rec, EUReducedSuppliesLbl, FinanceModuleSetup."VAT Prod. Post Grp. Reduced");
                    530000:
                        UpdateVATStatementLine(Rec, EUReducedSuppliesTotalLbl, '');
                    550000:
                        UpdateVATStatementLine(Rec, OverseasSalesValueLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    570000:
                        UpdateVATStatementLine(Rec, OverseasSalesReducedLbl, FinanceModuleSetup."VAT Prod. Post Grp. Reduced");
                    580000:
                        UpdateVATStatementLine(Rec, OverseasSalesReducedTotalLbl, '');
                    620000:
                        UpdateVATStatementLine(Rec, DomesticStandardPurchaseLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    640000:
                        UpdateVATStatementLine(Rec, DomesticReducedPurchaseValueLbl, FinanceModuleSetup."VAT Prod. Post Grp. Reduced");
                    650000:
                        UpdateVATStatementLine(Rec, DomesticReducedPurchaseTotalLbl, '');
                    670000:
                        UpdateVATStatementLine(Rec, EUAcquisitionStandardLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    690000:
                        UpdateVATStatementLine(Rec, EUAcquisitionReducedLbl, FinanceModuleSetup."VAT Prod. Post Grp. Reduced");
                    700000:
                        UpdateVATStatementLine(Rec, EUAcquisitionReducedTotalLbl, '');
                    720000:
                        UpdateVATStatementLine(Rec, OverseasPurchaseValueLbl, FinanceModuleSetup."VAT Prod. Post Grp. Standard");
                    740000:
                        UpdateVATStatementLine(Rec, OverseasPurchaseReducedLbl, FinanceModuleSetup."VAT Prod. Post Grp. Reduced");
                    750000:
                        UpdateVATStatementLine(Rec, OverseasPurchaseReducedTotalLbl, '');
                    770000:
                        UpdateVATStatementLine(Rec, NonVatLiablePurchaseLbl, FinanceModuleSetup."VAT Prod. Post Grp. No VAT");
                end;
    end;
