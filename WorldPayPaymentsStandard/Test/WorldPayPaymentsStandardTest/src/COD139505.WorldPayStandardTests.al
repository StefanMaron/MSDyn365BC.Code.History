codeunit 139505 "MS - WorldPay Standard Tests"
{
    ...
    var
        ...
        MSWorldPayStdMockEvents: Codeunit 139506;
    ...
    var
        ...
        MSWorldPayTransaction: Record 1367;
    ...
    var
        MSWorldPayStandardAccount: Record 1360;
        ExpectedMSWorldPayStandardAccount: Record 1360;
        PaymentServices: TestPage 1060;
        ChangeValuesOnSetupPage: Boolean;
    begin
        // Setup
    ...
    var
        MSWorldPayStdTemplate: Record 1361;
        NewMSWorldPayStdTemplate: Record 1361;
        MSWorldPayStandardMgt: Codeunit 1360;
        MSWorldPayStdTemplateSetupPage: TestPage 1361;
        NewName: Text;
        NewDescription: Text;
    ...
    var
        MSWorldPayStandardAccount1: Record 1360;
        MSWorldPayStandardAccount2: Record 1360;
        MSWorldPayStandardAccount: Record 1360;
    begin
        // Setup
        Initialize();
    ...
    var
        MSWorldPayStandardSetup: TestPage 1360;
        MSWorldPayStdTemplate: TestPage 1361;
        EnableServiceWhenClosingCard: Boolean;
    begin
    ...
    local procedure CreateWorldPayStandardAccount(var MSWorldPayStandardAccount: Record 1360)
    var
        MSWorldPayStdTemplate: Record 1361;
        MSWorldPayStandardMgt: Codeunit 1360;
    begin
    ...
    local procedure EnableWorldPayStandardAccount(var MSWorldPayStandardAccount: Record 1360)
    begin
        MSWorldPayStandardAccount.VALIDATE(Enabled, TRUE);
        MSWorldPayStandardAccount.MODIFY(TRUE);
    end;

    local procedure CreateDefaultWorldPayStandardAccount(var DefaultMSWorldPayStandardAccount: Record 1360)
    begin
    ...
    local procedure VerifyWorldPayAccountRecord(MSWorldPayStandardAccount: Record 1360; ExpectedMSWorldPayStandardAccount: Record 1360)
    var
        ExpectedTargetURL: Text;
    ...
    local procedure VerifyWorldPayTemplate(MSWorldPayStdTemplate: Record 1361; NewName: Text; NewDescription: Text; ExpectedTargetURL: Text; ExpectedLogoURL: Text)
    var
        ActualTargetURL: Text;
        ActualLogoURL: Text;
    begin
    ...
    local procedure VerifyPaymentServiceIsShownOnServiceConnectionsPage(var ServiceConnections: TestPage 1279; MSWorldPayStandardAccount: Record 1360)
    var
    ...
    local procedure VerifyWorldPayURL(var PaymentReportingArgument: Record 1062; MSWorldPayStandardAccount: Record 1360; SalesInvoiceHeader: Record 112)
    var
    ...
    local procedure VerifyBodyText(MSWorldPayStandardAccount: Record 1360; SalesInvoiceHeader: Record 112)
    var
        GeneralLedgerSetup: Record 98;
        BaseURL: Text;
        BodyHTMLText: Text;
    ...
    [ModalPageHandler]
    procedure AccountSetupPageModalPageHandler(var WorldPayStandardSetup: TestPage 1360)
    var
        NewName: Text;
        NewDescription: Text;
        AccountID: Text;
