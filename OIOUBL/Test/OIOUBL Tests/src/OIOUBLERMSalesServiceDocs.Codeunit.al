...
codeunit 148051 "OIOUBL-ERM Sales/Service Docs"
{
    ...
    begin
        ...
        CompanyInformation.GET();
        PostSalesInvoiceWithDiffCompanyInfo(
          CompanyInformation.Name, CompanyInformation."VAT Registration No.", '', '', '');
    end;
    ...
    local procedure PostSalesInvoiceWithDiffCompanyInfo(Name: Text[100]; VATRegistrationNo: Code[20]; Address: Text[100]; City: Text[30]; PostCode: Code[20]);
    var
        SalesLine: Record "Sales Line";
        CompanyInformation: Record "Company Information";
    begin
