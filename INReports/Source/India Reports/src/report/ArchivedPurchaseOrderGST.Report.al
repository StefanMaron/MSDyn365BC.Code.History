report 18021 "Archived Purchase Order GST"
{
    DefaultLayout = RDLC;
    RDLCLayout = './rdlc/ArchivedPurchaseOrder.rdl';
        ...
        dataitem("Purchase Header Archive"; "Purchase Header Archive")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                begin
                    ...
                    TempPurchLine."Prepayment Line" := true;
    ...
    var
        ...
        PurchasTextLbl: Label 'Purchaser', Locked = true;
        TotalTextLbl: Label 'Total %1', Comment = '%1 = LCY Code';
        ...
        Purchase_Line_Archive___Line_Discount___CaptionLbl: Label 'Disc. %', Locked = true;
        ...
        VATAmountLine__VAT____Control160CaptionLbl: Label 'VAT %', Locked = true;
