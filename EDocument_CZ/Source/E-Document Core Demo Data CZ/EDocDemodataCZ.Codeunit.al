...
codeunit 31500 "EDoc. Demodata CZ"
{
    Access = Internal;
    ...
    begin
        ...
        EDocumentModuleSetup."Recurring Expense G/L Acc. No" := CreateGLAccountCZ.OtherServices();
        EDocumentModuleSetup."Delivery Expense G/L Acc. No" := CreateGLAccountCZ.Postage();
