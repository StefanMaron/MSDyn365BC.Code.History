codeunit 4705 "VAT Group Submission Status"
{
    ...
    begin
        ...
        SendTraceTag('0000D7F', VATGroupTok, VERBOSITY::Normal, AllStatusUpdateMsg, DATACLASSIFICATION::SystemMetadata);
        ...
        SendTraceTag('0000D7G', VATGroupTok, VERBOSITY::Normal, AllStatusUpdateSuccMsg, DATACLASSIFICATION::SystemMetadata);
    end;
    ...
    begin
        ...
        SendTraceTag('0000D7H', VATGroupTok, VERBOSITY::Normal, SingleStatusUpdateMsg, DATACLASSIFICATION::SystemMetadata);
        ...
        SendTraceTag('0000D7I', VATGroupTok, VERBOSITY::Normal, SingleStatusUpdateSuccMsg, DATACLASSIFICATION::SystemMetadata);
    end;
    ...
    begin
        if not JsonObj.Get('responses', ResponsesJsonArrayToken) then begin
            SendTraceTag('0000DAF', VATGroupTok, VERBOSITY::Error, BatchEmptyResponseErr, DATACLASSIFICATION::SystemMetadata);
        ...
        foreach ElementJsonToken in ResponsesJsonArray do begin
            ...
            if StatusCode <> 200 then begin
                ...
                SendTraceTag('0000D7J', VATGroupTok, VERBOSITY::Error, StrSubstNo(BatchSingleRequestErrMsg, StatusCode, ErrMsg), DATACLASSIFICATION::SystemMetadata);
            end else
