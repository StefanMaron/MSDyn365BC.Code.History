...
codeunit 14105 "Create VAT Statement MX"
{
    ...
    begin
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), StatementNameUnrealLbl, 410000, '1020', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::"Unrealized Amount", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::"Opposite Sign", SalesVat8PercOutgoingLbl);
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), StatementNameUnrealLbl, 450000, '1040', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::"Unrealized Amount", VATStatementLine."Calculate with"::"Opposite Sign", false, VATStatementLine."Print with"::"Opposite Sign", Vat8PercOnEuPurchasesEtcLbl);
    ...
    begin
        ...
        if (Rec."Statement Template Name" = CreateVATStatement.VATTemplateName()) and (Rec."Statement Name" = DefaultStatementNameLbl) then
            case Rec."Line No." of
                10000:
                    ValidateRecordFields(Rec, '1010', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", '', Enum::"VAT Statement Line Amount Type"::"Amount", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::"Opposite Sign", SalesVat16PercOutgoingLbl);
                20000:
                    ValidateRecordFields(Rec, '1020', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::"Amount", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::"Opposite Sign", SalesVat8PercOutgoingLbl);
                30000:
                    ValidateRecordFields(Rec, '1050', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", '', Enum::"VAT Statement Line Amount Type"::"Amount", VATStatementLine."Calculate with"::"Opposite Sign", false, VATStatementLine."Print with"::"Opposite Sign", Vat16PercOnEuPurchasesEtcLbl);
                40000:
                    ValidateRecordFields(Rec, '1060', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::"Amount", VATStatementLine."Calculate with"::"Opposite Sign", false, VATStatementLine."Print with"::"Opposite Sign", Vat8PercOnEuPurchasesEtcLbl);
                50000:
                ...
                90000:
                    ValidateRecordFields(Rec, '1120', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::"Amount", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::Sign, PurchaseVat8PercDomesticLbl);
                100000:
                    ValidateRecordFields(Rec, '1150', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", '', Enum::"VAT Statement Line Amount Type"::"Amount", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::Sign, PurchaseVat16PercEuLbl);
                110000:
                    ValidateRecordFields(Rec, '1160', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::"Amount", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::Sign, PurchaseVat8PercEuLbl);
                120000:
                ...
                270000:
                    ValidateRecordFields(Rec, '', Enum::"VAT Statement Line Type"::Description, '', Enum::"General Posting Type"::" ", '', '', '', Enum::"VAT Statement Line Amount Type"::" ", VATStatementLine."Calculate with"::Sign, true, VATStatementLine."Print with"::Sign, '');
                280000:
                    ValidateRecordFields(Rec, '1210', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", '', Enum::"VAT Statement Line Amount Type"::"Base", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::Sign, ValueOfEuPurchases16PercLbl);
                290000:
                    ValidateRecordFields(Rec, '1220', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::"Base", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::Sign, ValueOfEuPurchases8PercLbl);
                300000:
                    ValidateRecordFields(Rec, '', Enum::"VAT Statement Line Type"::Description, '', Enum::"General Posting Type"::" ", '', '', '', Enum::"VAT Statement Line Amount Type"::" ", VATStatementLine."Calculate with"::Sign, true, VATStatementLine."Print with"::Sign, '');
                310000:
                ...
                320000:
                    ValidateRecordFields(Rec, '1250', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Sale, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::"Base", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::"Opposite Sign", ValueOfEuSales8PercLbl);
                330000:
                    ValidateRecordFields(Rec, '', Enum::"VAT Statement Line Type"::Description, '', Enum::"General Posting Type"::" ", '', '', '', Enum::"VAT Statement Line Amount Type"::" ", VATStatementLine."Calculate with"::Sign, true, VATStatementLine."Print with"::Sign, '');
                340000:
                ...
                350000:
                    ValidateRecordFields(Rec, '1320', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Sale, CreateVATPostingGroups.EXPORT(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::"Base", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::Sign, NonVatLiableSalesOverseasLbl);
                360000:
                ...
                370000:
                    ValidateRecordFields(Rec, '1340', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '', Enum::"VAT Statement Line Amount Type"::"Base", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::Sign, NonVatLiableSalesDomesticLbl);
                380000:
