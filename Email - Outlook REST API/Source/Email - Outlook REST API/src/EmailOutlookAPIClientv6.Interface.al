...
/// <summary>
/// Interface for the Email - Outlook API Client which extends v5 with email category management.
/// </summary>
interface "Email - Outlook API Client v6"
{
    ...
    /// <summary>
    /// Gets email categories from the Outlook API.
    /// </summary>
    /// <param name="AccessToken">The access token used for connecting to exchange via graph.</param>
    /// <param name="OutlookAccount">The email account to retrieve categories from.</param>
    /// <returns>The JSON array containing the information of the email categories.</returns>
    procedure GetEmailCategories(AccessToken: SecretText; OutlookAccount: Record "Email - Outlook Account"): JsonArray;

    /// <summary>
    /// Creates a new email category in the Outlook API.
    /// </summary>
    /// <param name="AccessToken">The access token used for connecting to exchange via graph.</param>
    /// <param name="OutlookAccount">The email account to create the category in.</param>
    ...
    /// <summary>
    /// Applies email categories to an email message in the Outlook API.
    /// </summary>
    /// <param name="AccessToken">The access token used for connecting to exchange via graph.</param>
    /// <param name="OutlookAccount">The email account containing the email.</param>
    /// <param name="ExternalMessageId">The external message ID of the email to update.</param>
