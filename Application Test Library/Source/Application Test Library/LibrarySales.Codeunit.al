...
codeunit 130509 "Library - Sales"
{
    ...
    local procedure CreateCorrectiveSalesDocument(var CorrSalesHeader: Record "Sales Header"; CustomerNo: Code[20]; CorrDocNo: Code[20]; DocType: Enum "Sales Document Type"; CorrectiveDocType: Option; CorrectedDocType: Option; PostingDate: Date)
    var
    ...
    begin
        ...
        if CorrSalesHeader."Corrective Doc. Type" = CorrSalesHeader."Corrective Doc. Type"::Correction then begin
            CorrectiveDocumentMgt.SetSalesHeader(CorrSalesHeader."Document Type".AsInteger(), CorrSalesHeader."No.");
