codeunit 11518 "Swiss QR-Bill Mgt."
{
    ...
    internal procedure FindCustLedgerEntry(var LedgerEntryNo: Integer; CustomerNo: Code[20]; DocumentType: Option; DocumentNo: Code[20]; PostingDate: Date) Found: Boolean
    var
    ...
    internal procedure FilterCustLedgerEntry(var CustLedgerEntry: Record "Cust. Ledger Entry"; CustomerNo: Code[20]; DocumentType: Option; DocumentNo: Code[20]; PostingDate: Date): Boolean
    begin
