table 5746 "Transfer Receipt Header"
{
    ...
    begin
        ...
        PostCodeCheck.DeleteAllAddressID(DATABASE::"Transfer Receipt Header", Rec.GetPosition);
    end;

    trigger OnRename()
    begin
        PostCodeCheck.MoveAllAddressID(
          DATABASE::"Transfer Receipt Header", Rec.GetPosition,
          DATABASE::"Transfer Receipt Header", xRec.GetPosition);
    end;
