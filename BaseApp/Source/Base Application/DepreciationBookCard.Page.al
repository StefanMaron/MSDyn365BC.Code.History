    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Compress Depreciation"; "Compress Depreciation")
                {
                    ApplicationArea = FixedAssets;
                ...
                field("Anticipated Depreciation Calc."; "Anticipated Depreciation Calc.")
                {
                    ApplicationArea = FixedAssets;
                ...
                field("Acc./Red. Depreciation Calc."; "Acc./Red. Depreciation Calc.")
                {
                    ApplicationArea = FixedAssets;
