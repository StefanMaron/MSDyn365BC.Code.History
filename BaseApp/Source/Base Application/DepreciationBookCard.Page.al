    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Derogatory Calculation"; "Derogatory Calculation")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies if this book is used as a tax depreciation book to calculate derogatory depreciation.';
                }
                field("Used with Derogatory Book"; "Used with Derogatory Book")
                {
                    ApplicationArea = FixedAssets;
            ...
            group(Integration)
            {
                ...
                group("G/L Integration")
                {
                    ...
                    field("G/L Integration - Derogatory"; "G/L Integration - Derogatory")
                    {
                        ApplicationArea = FixedAssets;
                        Caption = 'Derogatory';
