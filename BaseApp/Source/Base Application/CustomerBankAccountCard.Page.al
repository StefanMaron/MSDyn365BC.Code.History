    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the bank identifier code associated with the customer bank account.';
                }
                field(Name; Name)
                {
                    ApplicationArea = Basic, Suite;
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the city abbreviation associated with the customer bank account.';
                }
                field(City; City)
                {
                    ApplicationArea = Basic, Suite;
