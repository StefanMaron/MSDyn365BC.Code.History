    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Int. Arrears Amount to Pay"; Rec."Int. Arrears Amount to Pay")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the interest on arrears amount to be paid.';
                }
                field("Paid Int. Arrears Amount"; Rec."Paid Int. Arrears Amount")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the interest on arrears that has been paid on the customer transaction.';
                }
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the bank receipt that is associated with the customer ledger entry.';
                }
                field("Customer Bill No."; Rec."Customer Bill No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the bill number of the issued customer bill.';
                }
                field("Bank Receipts List No."; Rec."Bank Receipts List No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of the bank receipt list that is associated with the customer ledger entry.';
                }
                field("Bank Receipt Issued"; Rec."Bank Receipt Issued")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the bank receipt that is associated with the customer ledger entry has been issued.';
                    Visible = false;
                }
                field("Bank Receipt Temp. No."; Rec."Bank Receipt Temp. No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of the bank receipt template that is associated with the customer ledger entry.';
                    Visible = false;
                }
                field("Allow Issue"; Rec."Allow Issue")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if documents related to the customer are automatically issued.';
                    Visible = false;
                }
        ...
        area(navigation)
        {
            group("Ent&ry")
            {
                ...
                action("&Bill List")
                {
                    ...
                    RunPageLink = "No." = FIELD("Bank Receipts List No.");
                    ToolTip = 'Open the list of bills.';
                }
            }
        }
        area(processing)
