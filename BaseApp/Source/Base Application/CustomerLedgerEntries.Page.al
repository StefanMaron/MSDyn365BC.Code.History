    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Int. Arrears Amount to Pay"; "Int. Arrears Amount to Pay")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the interest on arrears amount to be paid.';
                }
                field("Paid Int. Arrears Amount"; "Paid Int. Arrears Amount")
                {
                    ApplicationArea = Basic, Suite;
