codeunit 5763 "Whse.-Post Shipment"
{
    ...
    begin
        if WhseShptLine."Assemble to Order" then
            exit;
        ItemTrackingMgt.CheckWhseItemTrkgSetup(WhseShptLine."Item No.", WhseShptLine."Location Code", WhseSNRequired, WhseLNRequired, WhseCDRequired, false);
        if not (WhseSNRequired or WhseLNRequired or WhseCDRequired) then
            exit;
            ...
            repeat
                if ReservationEntry.TrackingExists then begin
                    ...
                    WhseItemTrkgLine.SetTrackingFilter(
                      ReservationEntry."Serial No.", ReservationEntry."Lot No.", ReservationEntry."CD No.");
