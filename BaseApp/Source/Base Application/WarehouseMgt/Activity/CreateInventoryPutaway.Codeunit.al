...
codeunit 7321 "Create Inventory Put-away"
{
    ...
    begin
        ...
        repeat
            ...
            if not IsHandled and PurchaseLine.IsInventoriableItem() then
                if not NewWarehouseActivityLine.ActivityExists(Database::"Purchase Line", PurchaseLine."Document Type", PurchaseLine."Document No.", PurchaseLine."Line No.", 0, 0) then begin
                    ...
                    if (CurrLocation."Always Create Put-away Line" or not CurrLocation."Bin Mandatory") and (RemQtyToPutAway > 0) then
                        repeat
                            CreateWarehouseActivityLine(Database::"Purchase Line", PurchaseLine."Document Type".AsInteger(), PurchaseLine."Document No.", PurchaseLine."Line No.", PurchaseLine."Location Code",
    ...
    begin
        ...
        repeat
            ...
            CreateWarehouseActivityLine(Database::"Purchase Line", PurchaseLineToPutaway."Document Type".AsInteger(), PurchaseLineToPutaway."Document No.", PurchaseLineToPutaway."Line No.",
    ...
    begin
        ...
        repeat
            ...
            if not IsHandled and SalesLine.IsInventoriableItem() then
                if not NewWarehouseActivityLine.ActivityExists(Database::"Sales Line", SalesLine."Document Type", SalesLine."Document No.", SalesLine."Line No.", 0, 0) then begin
            ...
            if not IsHandled then
                if not NewWarehouseActivityLine.ActivityExists(Database::"Transfer Line", 1, TransferLine."Document No.", TransferLine."Line No.", 0, 0) then begin
                    ...
                    if (CurrLocation."Always Create Put-away Line" or not CurrLocation."Bin Mandatory") and (RemQtyToPutAway > 0) then
                        repeat
                            CreateWarehouseActivityLine(
                                Database::"Transfer Line", 1, TransferLine."Document No.", TransferLine."Line No.",
    ...
    begin
        ...
        repeat
            ...
            if not IsHandled then
                if not NewWarehouseActivityLine.ActivityExists(Database::"Prod. Order Line", ProdOrderLine.Status, ProdOrderLine."Prod. Order No.", ProdOrderLine."Line No.", 0, 0) then begin
                    ...
                    if (ProdOrderLine."Location Code" = '') or (CurrLocation."Prod. Output Whse. Handling" = CurrLocation."Prod. Output Whse. Handling"::"Inventory Put-away") then begin
                        ...
                        if (CurrLocation."Always Create Put-away Line" or not CurrLocation."Bin Mandatory") and (RemQtyToPutAway > 0) then
                            repeat
                                CreateWarehouseActivityLine(
                                    Database::"Prod. Order Line", ProdOrderLine.Status.AsInteger(), ProdOrderLine."Prod. Order No.", ProdOrderLine."Line No.",
            ...
            if not IsHandled then
                if not
                   NewWarehouseActivityLine.ActivityExists(
                     Database::"Prod. Order Component", ProdOrderComponent.Status, ProdOrderComponent."Prod. Order No.", ProdOrderComponent."Prod. Order Line No.", ProdOrderComponent."Line No.", 0)
                then begin
    ...
    begin
        ...
        CreatePutawayWithPutawayTemplateBinPolicy(
            Database::"Prod. Order Component", 1, ProdOrderComponent."Prod. Order No.", ProdOrderComponent."Line No.",
