    ...
    begin
        ...
        case ReportUsage2 of
            ...
            ReportUsage2::"UnPosted Advance Statement":
                Rec.SetRange(Usage, Rec.Usage::UAS);
            ReportUsage2::"Advance Statement":
                Rec.SetRange(Usage, Rec.Usage::AS);
            ReportUsage2::"UnPosted Invoice":
                Rec.SetRange(Usage, Rec.Usage::UPI);
            ReportUsage2::"UnPosted Cr. Memo":
                Rec.SetRange(Usage, Rec.Usage::UPCM);
        end;
            ...
            if Evaluate(NewReportUsage, Rec.GetFilter(Usage)) then
                case NewReportUsage of
                    ...
                    NewReportUsage::"P.V.Remit.":
                        ReportUsage2 := ReportUsage2::"Vendor Remittance";
                    NewReportUsage::UAS:
                        ReportUsage2 := ReportUsage2::"UnPosted Advance Statement";
                    NewReportUsage::AS:
                        ReportUsage2 := ReportUsage2::"Advance Statement";
                    NewReportUsage::UPI:
                        ReportUsage2 := ReportUsage2::"UnPosted Invoice";
                    NewReportUsage::UPCM:
                        ReportUsage2 := ReportUsage2::"UnPosted Cr. Memo";
                    else
