    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Same Ext. Doc. No. in Diff. FY"; Rec."Same Ext. Doc. No. in Diff. FY")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Ext. Doc. No. Period Source"; Rec."Ext. Doc. No. Period Source")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = Rec."Same Ext. Doc. No. in Diff. FY";
            ...
            group("Number Series")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series used for purchases and payables VAT exemptions.';
                }
            ...
            group(Bills)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series code used to assign temporary numbers to vendor bill lists.';
                }
            }
            group(Archiving)
            {
