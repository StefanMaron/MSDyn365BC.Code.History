...
codeunit 113 "Vend. Entry-Edit"
{
    ...
    begin
        ...
        if VendLedgEntry.Open then begin
            ...
            VendLedgEntry."Vendor VAT Invoice No." := Rec."Vendor VAT Invoice No.";
            VendLedgEntry."Vendor VAT Invoice Date" := Rec."Vendor VAT Invoice Date";
            VendLedgEntry."Vendor VAT Invoice Rcvd Date" := Rec."Vendor VAT Invoice Rcvd Date";
            VendLedgEntry."Vendor Receipts No." := Rec."Vendor Receipts No.";
            VendLedgEntry."Vendor Receipts Date" := Rec."Vendor Receipts Date";
        ...
        VendLedgEntry.Validate("VAT Entry Type", Rec."VAT Entry Type");
        VendLedgEntry.Description := Rec.Description;
