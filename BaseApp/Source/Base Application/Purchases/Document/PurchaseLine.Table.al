                        ...
                        QtyType::General:
                            begin
                                ...
                                VATAmountLine.SumLine(
                                  PurchLine."Line Amount", PurchLine."Inv. Discount Amount", PurchLine."Pmt. Discount Amount", PurchLine."VAT Difference", PurchLine."EC Difference",
                                  PurchLine."Allow Invoice Disc.", PurchLine."Prepayment Line");
                            end;
                        QtyType::Invoicing:
                            begin
                                IsHandled := false;
                                ...
                                if PurchHeader."Invoice Discount Calculation" <> PurchHeader."Invoice Discount Calculation"::Amount then
                                    VATAmountLine.SumLine(
                                      ...
                                      Round(PurchLine."Pmt. Discount Amount" * QtyToHandle / PurchLine.Quantity, Currency."Amount Rounding Precision"),
                                      PurchLine."VAT Difference", PurchLine."EC Difference", PurchLine."Allow Invoice Disc.", PurchLine."Prepayment Line")
                                else
                                    VATAmountLine.SumLine(
                                      AmtToHandle, PurchLine."Inv. Disc. Amount to Invoice",
                                      Round(PurchLine."Pmt. Discount Amount" * QtyToHandle / PurchLine.Quantity, Currency."Amount Rounding Precision"),
                                      PurchLine."VAT Difference", PurchLine."EC Difference", PurchLine."Allow Invoice Disc.", PurchLine."Prepayment Line");
                            end;
                        QtyType::Shipping:
