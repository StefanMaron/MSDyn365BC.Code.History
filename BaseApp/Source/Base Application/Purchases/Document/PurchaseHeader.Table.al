...
table 38 "Purchase Header"
{
    ...
    fields
    {
        ...
        field(32; "Currency Code"; Code[10])
        {
            ...
            begin
                ...
                if (CurrFieldNo <> FieldNo("Currency Code")) and ((not CurrencyCodeChanged) or
        ...
        field(12400; "Empl. Purchase"; Boolean)
        {
            Caption = 'Empl. Purchase';
        }
        field(12401; "Advance Purpose"; Text[30])
        {
            Caption = 'Advance Purpose';
        ...
        field(12402; "Remaining/Overdraft Doc. No."; Code[20])
        {
            Caption = 'Remaining/Overdraft Doc. No.';
        ...
        field(12404; "Prepmt. Diff."; Boolean)
        {
            Caption = 'Prepmt. Diff.';
            Editable = false;
        }
        field(12437; "No. of Documents"; Integer)
        {
            Caption = 'No. of Documents';
        }
        field(12438; "No. of Pages"; Integer)
        {
            Caption = 'No. of Pages';
        }
        ...
        field(12442; "Corrected Doc. No."; Code[20])
        {
            ...
            TableRelation = if ("Corrected Doc. Type" = const(Invoice)) "Purch. Inv. Header" where("Buy-from Vendor No." = field("Buy-from Vendor No."))
            else
            if ("Corrected Doc. Type" = const("Credit Memo")) "Purch. Cr. Memo Hdr." where("Buy-from Vendor No." = field("Buy-from Vendor No."));
        ...
        field(12480; "Outstanding Amount (LCY)"; Decimal)
        {
            AutoFormatType = 1;
        ...
        field(12486; "Include In Sales VAT Ledger"; Boolean)
        {
            Caption = 'Include In Sales VAT Ledger';
        ...
        field(12490; "Agreement No."; Code[20])
        {
            ...
            TableRelation = "Vendor Agreement"."No." where("Vendor No." = field("Pay-to Vendor No."),
                                                            Active = const(true));
                    ...
                    if ("Agreement No." <> '') then begin
                        ...
                        if Confirmed then begin
                            ...
                            if Rec."Posting Date" <> 0D then begin
                                ...
                                if (VendAgr."Expire Date" <> 0D) and (VendAgr."Expire Date" < "Posting Date") then
                                    Error(Text12403,
                                ...
                                if (VendAgr."Expire Date" <> 0D) and (VendAgr."Expire Date" < "Document Date") then
                                    Error(Text12403,
                                      VendAgr.FieldCaption("Expire Date"),
                                      FieldCaption("Document Date"));
                            end;
                            ...
                            UpdatePurchLinesByFieldNo(FieldNo("Agreement No."), CurrFieldNo <> 0);
                        end;
                    end else begin
    ...
    begin
        ...
        DocSignMgt.DeleteDocSign(DATABASE::"Purchase Header", Rec."Document Type".AsInteger(), Rec."No.");
    ...
    begin
        ...
        DocSignMgt.SetDefaults(DATABASE::"Purchase Header", Rec."Document Type".AsInteger(), Rec."No.");
    end;
...
#pragma warning restore AA0470
    ...
    begin
        ...
        case "Document Type" of
            ...
            "Document Type"::Invoice:
                if "Empl. Purchase" then
                    NoSeriesCode := PurchSetup."Advance Statement Nos."
                else
    ...
    [Scope('OnPrem')]
    procedure RecalculatePurchLines(TargetAmount: Decimal)
    var
        PurchLine: Record "Purchase Line";
        CalcAmount: Decimal;
        "Part": Decimal;
    ...
    [Scope('OnPrem')]
    procedure ShowAttorneyLetters()
    var
        LetterOfAttorney: Record "Letter of Attorney Header";
        LetterOfAttorneyList: Page "Letter of Attorney List";
    begin
        LetterOfAttorney.FilterGroup(2);
        LetterOfAttorney.SetRange("Source Document Type", "Document Type".AsInteger() + 1);
    ...
    [Scope('OnPrem')]
    procedure CreateAttorneyLetter()
    var
        LetterOfAttorney: Record "Letter of Attorney Header";
        LetterOfAttorneyCard: Page "Letter of Attorney Card";
    begin
        LetterOfAttorney.Init();
        LetterOfAttorney."Source Document Type" := "Document Type".AsInteger() + 1;
        ...
        LetterOfAttorney.SetRange("Source Document No.", "No.");
        LetterOfAttorney.FilterGroup(0);
        LetterOfAttorneyCard.SetSourceDocument("Document Type".AsInteger(), "No.");
    ...
    [Scope('OnPrem')]
    procedure CheckCorrPostingDate()
    var
        PurchInvHeader: Record "Purch. Inv. Header";
        PurchCrMemoHeader: Record "Purch. Cr. Memo Hdr.";
    begin
    ...
    [Scope('OnPrem')]
    procedure CheckCorrAgreementNo()
    var
        PurchInvHeader: Record "Purch. Inv. Header";
        PurchCrMemoHeader: Record "Purch. Cr. Memo Hdr.";
    begin
    ...
    [Scope('OnPrem')]
    procedure CheckCorrectiveDocument()
    begin
    ...
    begin
        ...
        DocumentPrint.InsertDocPrintBuffer(DocumentPrintBuffer, DATABASE::"Purchase Header", Rec."Document Type".AsInteger(), Rec."No.");
        Commit();
...
#pragma warning restore AL0432
            ...
            "Document Type"::Invoice:
                begin
                    if ("No. Series" <> '') and (PurchSetup."Invoice Nos." = PostingNoSeries) then begin
