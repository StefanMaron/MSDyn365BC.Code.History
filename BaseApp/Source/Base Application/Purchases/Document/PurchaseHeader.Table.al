...
table 38 "Purchase Header"
{
    ...
    fields
    {
        ...
        field(28072; "Tax Document Posting Date"; Date)
        {
    ...
    var
        ...
        Text1500000: Label 'Vendor %1 is not registered. Do you wish to continue?';
    ...
    local procedure ValidateAppliesToDocNo()
    begin
        GLSetup.Get();
        if ("Document Type" in ["Document Type"::"Credit Memo", "Document Type"::"Return Order"]) and
           GLSetup.GSTEnabled("Document Date")
    ...
    local procedure LookupAppliesToDocNo()
    begin
        GLSetup.Get();
        if ("Document Type" in ["Document Type"::"Credit Memo", "Document Type"::"Return Order"]) and
           GLSetup.GSTEnabled("Document Date")
    ...
    var
        Text1500001: Label '%1 %2 does not exist';
    begin
        CalcFields(Amount);
        VendLedgEntry.Reset();
        VendLedgEntry.SetCurrentKey("Vendor No.", Positive, "Applies-to Doc. Type", "Applies-to Doc. No.", "Due Date");
