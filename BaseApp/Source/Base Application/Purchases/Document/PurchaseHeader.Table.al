    ...
    fields
    {
        ...
        field(4; "Pay-to Vendor No."; Code[20])
        {
            ...
            begin
                ...
                "Vendor Bank Acc. Code" := Vend."Preferred Bank Account Code";
                    ...
                    if IsCreditDocType() and not PaymentTerms."Calc. Pmt. Disc. on Cr. Memos" then begin
                        ...
                        if not IsHandled then begin
                            ...
                            AdjustDueDate.PurchAdjustDueDate(
                              "Due Date", "Document Date", PaymentTerms.CalculateMaxDueDate("Document Date"), "Pay-to Vendor No.");
                        end;
                        IsHandled := false;
                    ...
                    if PurchLine.Find('-') then begin
                        ...
                        repeat
                            ...
                            if not RecalculatePrice then begin
                                ...
                                VatFactor := 1 + ((PurchLine."VAT %" / 100) + (PurchLine."EC %" / 100));
                                if VatFactor = 0 then
                                    VatFactor := 1;
                ...
                if ("Prepmt. Payment Terms Code" <> '') and ("Document Date" <> 0D) then begin
                    ...
                    if IsCreditDocType() and not PaymentTerms."Calc. Pmt. Disc. on Cr. Memos" then begin
                        ...
                        if not IsHandled then begin
                            ...
                            AdjustDueDate.PurchAdjustDueDate(
                              "Prepayment Due Date", "Document Date", PaymentTerms.CalculateMaxDueDate("Document Date"), "Pay-to Vendor No.");
                        end;
                        IsHandled := false;
        ...
        field(10703; "Generate Autocredit Memo"; Boolean)
        {
            Caption = 'Generate Autocredit Memo';
            Editable = false;
        }
        field(10705; "Corrected Invoice No."; Code[20])
        {
            ...
            begin
                if "Corrected Invoice No." <> '' then
                    PurchaseInvoiceHeader.CheckCorrectedDocumentExist("Pay-to Vendor No.", "Corrected Invoice No.");
            end;
        }
...
#pragma warning disable AA0470
        ...
        Text1100000: Label 'It exists a Posted Purchase Receipt %1 %2 with %3 set to %4';
        Text10700: Label '%1 cannot be different from 0 when %2 is %3';
#pragma warning restore AA0470
#pragma warning restore AA0074
...
#pragma warning restore AA0470
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            "VAT Country/Region Code" := OrderAddress."Country/Region Code";
        end;
