...
codeunit 5029 "P.Arch.Bl.Ord PDF Doc.Handler" implements IPdfDocumentHandler
{
    var
        PurchaseArchivedBlanketOrderLbl: Label 'Purchase Archived Blanket Order';

    /// <summary>
    /// Generates a PDF blob for Purchase Archived Blanket Order
    /// </summary>
    ...
    begin
        ...
        ReportUsage := "Report Selection Usage"::"P.Arch.Blanket";
        ReportSelections.GetPdfReportForVend(TempBlob, ReportUsage, PurchaseHeaderArchive, PurchaseHeaderArchive."Buy-from Vendor No.");
        DocumentMailing.GetAttachmentFileName(Name, PurchaseHeaderArchive."No.", PurchaseArchivedBlanketOrderLbl, ReportUsage.AsInteger());
