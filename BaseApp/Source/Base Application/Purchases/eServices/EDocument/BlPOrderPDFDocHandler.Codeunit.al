...
codeunit 5002 "Bl. P. Order PDF Doc.Handler" implements IPdfDocumentHandler
{
    /// <summary>
    /// Generates a PDF blob for Blanket Purchase Order
    /// </summary>
    ...
    begin
        ...
        ReportUsage := "Report Selection Usage"::"P.Blanket";
