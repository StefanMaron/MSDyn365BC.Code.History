...
codeunit 5006 "Purch. Quote PDF Doc.Handler" implements IPdfDocumentHandler
{
    /// <summary>
    /// Generates a PDF blob for Purchase Quote
    /// </summary>
    ...
    begin
        ...
        ReportUsage := "Report Selection Usage"::"P.Quote";
