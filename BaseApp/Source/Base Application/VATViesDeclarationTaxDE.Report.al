report 11007 "VAT-Vies Declaration Tax - DE"
{
    ...
    dataset
    {
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            column(The_data_that_is_required_in_this_summary_according_to_the_149_etc_German_Fiscal_Code_AO_and_Lbl; The_data_that_is_required_in_this_summary_according_to_the_149_etc_German_Fiscal_Code_AO_and_Lbl)
            {
            }
