    ...
    begin
        with ReportSelections do
            case ReportUsage of
                ...
                Usage::"S.Shipment":
                    InsertRepSelection(Usage::"S.Shipment", '1', REPORT::"Sales Shipment NA");
                Usage::"S.Ret.Rcpt.":
                    InsertRepSelection(Usage::"S.Ret.Rcpt.", '1', REPORT::"Return Receipt");
                Usage::"S.Test":
                    InsertRepSelection(Usage::"S.Test", '1', REPORT::"Sales Document - Test");
                Usage::"P.Quote":
                    InsertRepSelection(Usage::"P.Quote", '1', REPORT::"Purchase Quote NA");
                Usage::"P.Blanket":
                ...
                Usage::"P.Invoice":
                    InsertRepSelection(Usage::"P.Invoice", '1', REPORT::"Purchase Invoice NA");
                Usage::"P.Return":
                    InsertRepSelection(Usage::"P.Return", '1', REPORT::"Return Order");
                Usage::"P.Cr.Memo":
                    InsertRepSelection(Usage::"P.Cr.Memo", '1', REPORT::"Purchase Credit Memo NA");
                Usage::"P.Receipt":
                    InsertRepSelection(Usage::"P.Receipt", '1', REPORT::"Purchase Receipt NA");
                Usage::"P.Ret.Shpt.":
