codeunit 1901 "Report Selection Mgt."
{
    ...
    begin
        ...
        with ReportSelections do begin
            ...
            InitReportUsage(Usage::"S.TaxInvoice");
            InitReportUsage(Usage::"S.TaxCreditMemo");
            InitReportUsage(Usage::"WHT Certificate");
        end;
    ...
    begin
        ...
        with ReportSelections do begin
            ...
            InitReportUsage(Usage::"P.TaxInvoice");
            InitReportUsage(Usage::"P.TaxCreditMemo");
        end;
    ...
    begin
        ...
        with ReportSelections do begin
            ...
            InitReportUsage("Report Selection Usage"::"P.V.Remit.");
