table 7321 "Warehouse Shipment Line"
{
    ...
    begin
        if "Assemble to Order" then begin
            ...
            ItemTrackingMgt.CheckWhseItemTrkgSetup("Item No.", "Location Code", WhseSNRequired, WhseLNRequired, WhseCDRequired, false);
            if WhseSNRequired or WhseLNRequired or WhseCDRequired then
