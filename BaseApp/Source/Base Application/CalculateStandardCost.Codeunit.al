codeunit 5812 "Calculate Standard Cost"
{
    ...
    local procedure CalcRtngCostPerUnit(Type: Option "Work Center","Machine Center"," "; No: Code[20]; var DirUnitCost: Decimal; var IndirCostPct: Decimal; var OvhdRate: Decimal; var UnitCost: Decimal; var UnitCostCalculation: Option Time,Unit; Item: Record Item; StandardTaskCode: Code[20])
    var
