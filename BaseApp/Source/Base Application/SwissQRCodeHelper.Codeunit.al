...
codeunit 4113 "Swiss QR Code Helper"
{
    ...
    begin
        ...
        LoadSwissCrossImage(SwissCrossTempBlob);
        if GenerateQRCodeImageImpl(SourceText, QRCodeImageTempBlob) then
            exit(OverlaySwissCross(QRCodeImageTempBlob, SwissCrossTempBlob));
    ...
    local procedure LoadSwissCrossImage(TempBlob: Codeunit "Temp Blob")
    var
