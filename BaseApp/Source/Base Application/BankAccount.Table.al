table 270 "Bank Account"
{
    ...
    fields
    {
        ...
        field(12401; "Account Type"; Option)
        {
            Caption = 'Account Type';
            OptionCaption = 'Bank Account,Cash Account';
            OptionMembers = "Bank Account","Cash Account";
        }
        field(12402; "Debit Cash Order No. Series"; Code[20])
        {
            Caption = 'Debit Cash Order No. Series';
            TableRelation = "No. Series";
        }
        field(12403; "Credit Cash Order No. Series"; Code[20])
        {
            Caption = 'Credit Cash Order No. Series';
            TableRelation = "No. Series";
        }
        field(12404; "Last Cash Report Page No."; Code[20])
        {
            Caption = 'Last Cash Report Page No.';
        }
        field(12405; "Fin. Void with Correction"; Boolean)
        {
            Caption = 'Fin. Void with Correction';
        }
        field(12406; "VAT % for Document"; Decimal)
        {
            Caption = 'VAT % for Document';
        }
        field(12408; "Abbr. City"; Text[1])
        {
            Caption = 'Abbr. City';
        }
        field(12409; "Bank Payment Order No. Series"; Code[20])
        {
            Caption = 'Bank Payment Order No. Series';
            TableRelation = "No. Series";
        }
        ...
        field(12411; "Use Client-Bank"; Boolean)
        {
            Caption = 'Use Client-Bank';
    ...
    var
        ...
        Text12401: Label 'You cannot clear the %1 check box because there are bank payment orders with %2 set to G/L Account.';
