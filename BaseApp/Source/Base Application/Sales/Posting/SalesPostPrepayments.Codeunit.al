...
codeunit 442 "Sales-Post Prepayments"
{
        ...
        case DocumentType of
            DocumentType::Invoice:
                begin
                    ...
                    PaymentTerms.VerifyMaxNoDaysTillDueDate(
                        SalesHeader."Prepayment Due Date", SalesHeader."Document Date", SalesHeader.FieldCaption("Prepayment Due Date"));
                ...
                if NewAmount <> 0 then begin
                    ...
                    then
                        VATAmountLine.InsertNewLine(
                          ...
                          SalesLine."Prepayment VAT %", NewAmount >= 0, true, SalesLine."Prepayment EC %", 0);
        ...
        if FromSalesLine.Find('-') then begin
            ...
            if SalesSetup."Invoice Rounding" then begin
                ...
                if InitInvoiceRoundingLine(SalesHeader, TotalAmt, InvRoundingSalesLine) then begin
                    ...
                    ToSalesLine."Prepayment EC %" := ToSalesLine."EC %";
    ...
    begin
        ...
        SalesInvLine."EC %" := PrepmtInvLineBuffer."EC %";
    ...
    begin
        ...
        SalesCrMemoLine."EC %" := PrepmtInvLineBuffer."EC %";
        if VATPostingSetup.GET(PrepmtInvLineBuffer."VAT Bus. Posting Group", PrepmtInvLineBuffer."VAT Prod. Posting Group") then
