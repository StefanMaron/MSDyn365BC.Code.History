...
codeunit 442 "Sales-Post Prepayments"
{
    ...
    begin
        ...
        with SalesHeader do begin
            ...
            if "Operation Occurred Date" < GLSetup."Last Gen. Jour. Printing Date" then
                FieldError("Operation Occurred Date", Text1130007);
            if "Applies-to Doc. No." <> '' then
                if "Applies-to Occurrence No." = 0 then
                    Error(Text1130004, FieldCaption("Applies-to Occurrence No."));
    ...
    begin
        with PrepmtInvLineBuf do begin
            ...
            "G/L Account No." := GetPrepmtAccNo(SalesLine."VAT Bus. Posting Group", SalesLine."VAT Prod. Posting Group");
            ...
            "Prepmt. CM Refers to Period" := SalesLine."Prepmt. CM Refers to Period";
                    ...
                    if NewAmount <> 0 then begin
                        ...
                        then
                            VATAmountLine.InsertNewLine(
                              ...
                              "Prepayment VAT %", NewAmount >= 0, true, "Prepayment Deductible %");
    ...
    begin
        with GenJnlLine do begin
            ...
            Validate("Document Date", "Document Date");
            "Operation Occurred Date" := SalesHeader."Operation Occurred Date";
    ...
    begin
        with GenJnlLine do begin
            ...
            "Recipient Bank Account" := SalesHeader."Bank Account";
            "Cumulative Bank Receipts" := SalesHeader."Cumulative Bank Receipts";
            ...
            if PaymentMethod.Get(SalesHeader."Payment Method Code") and BillCode.Get(PaymentMethod."Bill Code") then begin
                "Bank Receipt" := BillCode."Bank Receipt";
                "Allow Issue" := BillCode."Allow Issue";
            end;
    ...
    begin
        with PrepmtInvLineBuffer do begin
            ...
            SalesInvLine."Deductible %" := "Deductible %";
    ...
    begin
        with PrepmtInvLineBuffer do begin
            ...
            SalesCrMemoLine."Deductible %" := "Deductible %";
            ...
            SalesCrMemoLine."Prepmt. CM Refers to Period" := "Prepmt. CM Refers to Period";
