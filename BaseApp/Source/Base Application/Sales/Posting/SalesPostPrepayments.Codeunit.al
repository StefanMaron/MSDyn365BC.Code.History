...
codeunit 442 "Sales-Post Prepayments"
{
        ...
        if SalesHeader."Currency Code" <> '' then begin
            ...
            if PrepmtInvLineBuf."VAT Base Amount" <> 0 then
                PrepmtInvLineBuf."VAT Base Amount" :=
                  Round(
                    PrepmtInvLineBuf.Amount * (1 - SalesHeader."Payment Discount %" / 100),
                    GetCurrencyAmountRoundingPrecision(SalesHeader."Currency Code"));
    ...
    begin
        ...
        PrepmtInvLineBuf.SetAmounts(
          ...
          Round(
            SalesLine."Prepayment Amount" * (1 - SalesHeader."Payment Discount %" / 100),
            GetCurrencyAmountRoundingPrecision(SalesHeader."Currency Code")),
    ...
    begin
        ...
        GenJnlLine."Country/Region Code" := Customer."Country/Region Code";
    ...
    begin
        ...
        SalesCrMemoLine."Responsibility Center" := SalesCrMemoHeader."Responsibility Center";
