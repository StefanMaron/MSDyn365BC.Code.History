...
table 21 "Cust. Ledger Entry"
{
    ...
    fields
    {
        ...
        field(12402; "Prepmt. Diff. Cust. Entry No."; Integer)
        {
            Caption = 'Prepmt. Diff. Cust. Entry No.';
        }
    ...
    keys
    {
        ...
        key(Key2; "Customer No.", "Posting Date", "Currency Code", "Agreement No.")
        {
        ...
        key(Key18; "Prepmt. Diff. Cust. Entry No.", "Prepmt. Diff. Appln. Entry No.")
        {
        }
