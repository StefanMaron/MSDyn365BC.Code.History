...
table 21 "Cust. Ledger Entry"
{
    ...
    fields
    {
        ...
        field(37; "Due Date"; Date)
        {
            ...
            begin
                ...
                if PostedPaymentLines.Get(
                  PostedPaymentLines."Sales/Purchase"::Sales,
                  "Document Type",
                  "Document No.",
        ...
        field(12170; "Document Occurrence"; Integer)
        {
        ...
        field(12172; "Bank Receipt"; Boolean)
        {
        ...
        field(12174; "Bank Receipt Issued"; Boolean)
        {
            Caption = 'Bank Receipt Issued';
        }
        field(12175; "Bank Receipt Temp. No."; Code[20])
        {
            Caption = 'Bank Receipt Temp. No.';
        }
        field(12176; "Cumulative Bank Receipts"; Boolean)
        {
        ...
        {
            Caption = 'Document Occurrence to Close';
        }
        field(12180; "Customer Bill No."; Code[20])
        {
            Caption = 'Customer Bill No.';
        }
        field(12181; "Bank Receipts List No."; Code[20])
        {
            Caption = 'Bank Receipts List No.';
        }
        field(12183; "Allow Issue"; Boolean)
        {
            Caption = 'Allow Issue';
        ...
        field(12184; "Int. Arrears Amount to Pay"; Decimal)
        {
            Caption = 'Int. Arrears Amount to Pay';
        }
        field(12185; "Paid Int. Arrears Amount"; Decimal)
        {
            Caption = 'Paid Int. Arrears Amount';
        }
    }
    ...
    keys
    {
        ...
        key(Key18; "Document Type", "Document No.", "Document Occurrence")
        {
            SumIndexFields = "Remaining Pmt. Disc. Possible";
        }
        key(Key19; "Customer No.", Open, Positive, "Applies-to ID")
        {
            Enabled = false;
        }
        key(Key20; Open, "Document Type", "Allow Issue", "Bank Receipt Issued", "Currency Code")
        {
        }
        key(Key21; "Currency Code", Open, "Payment Method Code", "Document Type", "Bank Receipts List No.", "Bank Receipt Issued", "Bank Receipt Temp. No.")
        {
        }
        key(Key22; "Customer No.", "Document No.", "Document Type", "Document Type to Close", "Document No. to Close", "Document Occurrence to Close")
        {
        }
        key(Key23; "Posting Date", "Transaction No.", "Entry No.")
        {
        }
        key(Key24; "Document Type", "Document No.", "Document Occurrence", "Customer No.", Open)
        {
        }
        key(Key25; "Customer No.", "Bank Receipt", "Document Type", "Due Date", "Currency Code", "Bank Receipt Issued", Open)
        {
        }
        key(Key26; "Document Type", "Customer No.", "Posting Date", "Document No.", "Currency Code")
        {
        }
        key(Key27; "Due Date", "Customer No.", "Bank Receipt", "Bank Receipt Temp. No.", "Customer Bill No.", Open, "Document Type")
        {
        }
        key(Key28; "Document Type", "Document Type to Close", "Document No. to Close", "Document Occurrence to Close")
        {
        }
        key(Key29; "Document Type", "Posting Date")
        {
            SumIndexFields = "Sales (LCY)";
        }
        key(Key30; "Document Type", "Customer No.", Open, "Due Date")
        {
        }
        key(Key31; "Customer Posting Group")
        {
        }
        key(Key32; "Document Type", Open, "Posting Date", "Closed at Date")
        {
        }
        key(Key33; "Salesperson Code")
        {
        }
        key(Key34; SystemModifiedAt)
        {
        }
