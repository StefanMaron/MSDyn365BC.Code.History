...
table 21 "Cust. Ledger Entry"
{
    ...
    keys
    {
        ...
        key(Key18; "Posting Date", "Customer No.")
        {
            SumIndexFields = "Sales (LCY)", "Profit (LCY)", "Inv. Discount (LCY)";
        }
        key(Key19; "LSV No.", "Customer No.")
        {
        }
        key(Key20; "Document Type", "Posting Date")
        {
            SumIndexFields = "Sales (LCY)";
        }
        key(Key21; "Document Type", "Customer No.", Open, "Due Date")
        {
        }
        key(Key22; "Customer Posting Group")
        {
        }
        key(Key23; "Document Type", Open, "Posting Date", "Closed at Date")
        {
        }
        key(Key24; "Salesperson Code")
        {
        }
        key(Key25; SystemModifiedAt)
        {
        }
