        ...
        dataitem("Reminder Header"; "Reminder Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem("Reminder Line"; "Reminder Line")
                {
                    ...
                    column(Reminder_Line_Line_No_; "Reminder Line"."Line No.")
                    {
                    }
                    ...
                    column(Reminder_Line_ReminderInterestAmount; ReminderInterestAmount)
                    {
                    }
                    ...
                    column(Reminder_Line__VAT_Amount_; "VAT Amount")
                    {
                    }
                    column(Reminder_Line_Description_Control1140010; Description)
                    {
                    }
