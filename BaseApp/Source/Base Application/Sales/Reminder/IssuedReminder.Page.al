    ...
    layout
    {
        area(content)
        {
            ...
            group(Posting)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies whether the customer is part of the EHF system and requires an electronic issued reminder.';
                }
                field("E-Invoice Created"; Rec."E-Invoice Created")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies whether an electronic issued reminder memo has been created and copied to the location specified in Sales & Receivables Setup.';
                }
