...
report 6631 "Return Order Confirmation"
{
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocDate_SalesHdr; Format("Sales Header"."Document Date", 0, '<Day,2>.<Month,2>.<Year4>'))
                    {
                    }
                    ...
                    column(No_SalesHdrCaption; "Sales Header".FieldCaption("No."))
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(SalesLineType; TempSalesLine.Type)
                        {
                        }
    ...
    begin
        ...
        CHReportManagement.PrepareHeader(RecRef, REPORT::"Return Order Confirmation", HeaderLabel, HeaderTxt);
    end;
    ...
    begin
        RecRef.GetTable("Sales Header");
        CHReportManagement.PrepareFooter(RecRef, REPORT::"Return Order Confirmation", FooterLabel, FooterTxt);
    end;
