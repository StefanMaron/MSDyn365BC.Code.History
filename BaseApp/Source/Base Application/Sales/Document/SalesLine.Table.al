        ...
        field(90; "VAT Prod. Posting Group"; Code[20])
        {
            ...
            begin
                ...
                if CurrFieldNo = FieldNo("VAT Prod. Posting Group") then begin
                    ...
                    CustLedgEntry.SetRange("Document No.", SalesHeader."Last Prepayment No.");
...
#pragma warning restore
    ...
    var
        ...
        Text1130000: Label 'You cannot change the %1 because there is an open prepayment invoice.';
        ...
        ReGenerateSplitVATLinesQst: Label 'If you change %1, the existing automatically generated split VAT sales lines will be deleted and new sales lines based on the new information will be created.\\Do you want to change %1?', Comment = '%1=A field name whose value is just being changed.';
    ...
    begin
        ...
        if ("Prepayment %" <> 0) and (Type <> Type::" ") then begin
            ...
            if "Prepmt. CM Refers to Period" = "Prepmt. CM Refers to Period"::" " then begin
                GetSalesHeader();
                if SalesHeader."Prepmt. CM Refers to Period" = SalesHeader."Prepmt. CM Refers to Period"::" " then
                    "Prepmt. CM Refers to Period" := "Prepmt. CM Refers to Period"::Current
                else
                    "Prepmt. CM Refers to Period" := SalesHeader."Prepmt. CM Refers to Period";
            end;
        end else
                ...
                if not SalesLine.ZeroAmountLine(QtyType) then begin
                    ...
                    then begin
                        VATAmountLine.InsertNewLine(
                          SalesLine."VAT Identifier", SalesLine."VAT Calculation Type", SalesLine."Tax Group Code", false, SalesLine."VAT %", SalesLine."Line Amount" >= 0, false, SalesLine."Deductible %");
...
"Document Type", Type, "No.", "Variant Code", "Drop Shipment", "Location Code", "Shipment Date");
    ...
    begin
        ...
        if Country.CheckNotEUCountry(SalesHeader."VAT Country/Region Code") and
    ...
    begin
        ...
        if not SalesHeader.GetSplitVATLines(SplitVATSalesLine) then
        ...
        SalesHeader.RemoveSplitVATLines(SplitVATSalesLine);
        exit(true);
    end;
