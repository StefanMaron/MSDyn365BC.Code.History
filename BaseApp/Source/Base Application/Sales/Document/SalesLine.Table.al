                        ...
                        if VATAmountLine.Modified then begin
                            ...
                            if QtyType = QtyType::General then begin
                                if SalesHeader."Prices Including VAT" then begin
                                    ...
                                    if ("VAT %" <> 0) and (VATAmountLine.CalcLineAmount() <> 0) then
                                        NewVATBaseAmount :=
                                          TempVATAmountLineRemainder."VAT Base (Lowered)" +
                                          VATAmountLine."VAT Base" * (1 - GetVatBaseDiscountPct(SalesHeader) / 100) *
                                          CalcLineAmount() / VATAmountLine.CalcLineAmount
                                    else
