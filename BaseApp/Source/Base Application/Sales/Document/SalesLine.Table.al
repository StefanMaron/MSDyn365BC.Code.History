                    ...
                    if not ZeroAmountLine(QtyType) then begin
                        ...
                        then
                            VATAmountLine.InsertNewLine(
                              "VAT Identifier", "VAT Calculation Type", "Tax Group Code", false, "VAT %", "Line Amount" >= 0, false, "EC %", 0);
                        ...
                        case QtyType of
                            QtyType::General:
                                begin
                                    ...
                                    VATAmountLine.SumLine("Line Amount", "Inv. Discount Amount", "Pmt. Discount Amount", "VAT Difference", "EC Difference", "Allow Invoice Disc.", "Prepayment Line");
                                end;
                            QtyType::Invoicing:
                                begin
                                    IsHandled := false;
