                    ...
                    if not ZeroAmountLine(QtyType) then begin
                        ...
                        then
                            VATAmountLine.InsertNewLine(
                              "VAT Identifier", "VAT Calculation Type", "Tax Group Code", false, "VAT %", "Line Amount" >= 0, false, FullGST, 0);
                                    ...
                                    if "Full GST on Prepayment" and "Includes Prepayment" then begin
                                        ...
                                        "VAT Base" :=
                                          Round(
                                            ...
                                            Currency."Amount Rounding Precision", Currency.VATRoundingDirection()) - "VAT Difference";
                                        "VAT Amount" :=
                                          "VAT Difference" +
                                          Round(
                                            PrevVatAmountLine."VAT Amount" +
