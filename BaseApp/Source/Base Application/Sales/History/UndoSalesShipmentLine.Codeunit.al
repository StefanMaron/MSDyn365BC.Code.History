...
codeunit 5815 "Undo Sales Shipment Line"
{
    ...
    begin
        ...
        NewSalesShipmentLine.Amount := -OldSalesShipmentLine.Amount;
        NewSalesShipmentLine."Amount Including VAT" := -OldSalesShipmentLine."Amount Including VAT";
        NewSalesShipmentLine."Amount (LCY)" := -OldSalesShipmentLine."Amount (LCY)";
        NewSalesShipmentLine."Amount Including VAT (LCY)" := -OldSalesShipmentLine."Amount Including VAT (LCY)";
