    ...
    layout
    {
        area(content)
        {
            ...
            group(Billing)
            {
                ...
                {
                    Editable = false;
                    ToolTip = 'Specifies the agreement number associated with this sales shipment header.';
                }
            }
        }
        area(factboxes)
        ...
        area(navigation)
        {
            group("&Shipment")
            {
                ...
                action(Invoices)
                {
                    Caption = 'Invoices';
                    Image = SalesInvoice;
                    ToolTip = 'View a list of ongoing sales invoices for the shipment.';

                    trigger OnAction()
                    begin
                        Rec.FindInvoices(Rec);
                    end;
                }
