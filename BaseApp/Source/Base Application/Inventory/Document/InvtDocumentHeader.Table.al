...
table 5850 "Invt. Document Header"
{
    ...
    begin
        DocSignMgt.DeleteDocSign(DATABASE::"Invt. Document Header", Rec."Document Type".AsInteger(), Rec."No.");
    ...
    begin
        ...
        DocSignMgt.SetDefaults(DATABASE::"Invt. Document Header", Rec."Document Type".AsInteger(), Rec."No.");
    end;
