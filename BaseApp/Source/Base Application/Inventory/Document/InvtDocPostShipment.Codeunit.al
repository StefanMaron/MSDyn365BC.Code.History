...
codeunit 5851 "Invt. Doc.-Post Shipment"
{
    ...
    begin
        ...
        with InvtDocHeader do begin
            ...
            DocSignMgt.CheckDocSignatures(DATABASE::"Invt. Document Header", Rec."Document Type".AsInteger(), Rec."No.");
    ...
    begin
        ...
        ItemJnlLine."FA No." := InvtShptLine2."FA No.";
        ItemJnlLine."Depreciation Book Code" := InvtShptLine2."Depreciation Book Code";
    ...
    var
        Sign: Integer;
    begin
        if InvtShipmentHeader.Correction then begin
            Sign := -1;
