...
#pragma warning restore AA0470
    ...
    begin
        ...
        ValueEntry."Posting Date" := GetValueEntryPostingDate(ValueEntry, ItemJournalLine."Posting Date");
    ...
    begin
        ...
        ItemLedgEntry."FA No." := ItemJnlLine."FA No.";
        ItemLedgEntry."Depreciation Book Code" := ItemJnlLine."Depreciation Book Code";
        if ItemJnlLine."FA No." <> '' then
    ...
    begin
        ...
        if ItemLedgerEntry."FA No." <> '' then begin
            ValueEntry."FA No." := ItemLedgerEntry."FA No.";
            ValueEntry."Depreciation Book Code" := ItemLedgerEntry."Depreciation Book Code";
    ...
    var
        ...
        ItemLedgerEntry: Record "Item Ledger Entry";
    begin
        if ItemLedgerEntry.Get(ValueLedgerEntry."Item Ledger Entry No.") then
            if ValueLedgerEntry."FA No." <> '' then
    ...
    var
        ...
        CapLedgEntryLoc: Record Microsoft.Manufacturing.Capacity."Capacity Ledger Entry";
...
#pragma warning restore AA0074
    begin
        ...
        if InvtSetup."Automatic Posting Date Adjmt." > 0 then begin
            ...
            if (ValueEntryLoc."Item Ledger Entry No." <> 0) then begin
                ...
                if (ValueEntryLoc."Capacity Ledger Entry No." <> 0) then
                    if CapLedgEntryLoc.Get(ValueEntryLoc."Capacity Ledger Entry No.") then
    ...
    begin
        ...
        if GLEntry.FindSet() then begin
            ...
            repeat
                if (GLEntry."Debit Amount" < 0) or (GLEntry."Credit Amount" < 0) then begin
