codeunit 5642 "FA Reclass. Transfer Line"
{
    ...
    var
        ...
        FAPostingType: Option Acquisition,Depr,WriteDown,Appr,Custom1,Custom2,Disposal,Maintenance,"Salvage Value",,,,Derogatory;
    ...
    begin
        with FAReclassJnlLine do begin
            ...
            TransferType[7] := "Reclassify Derogatory";
    ...
    local procedure Convert(OldNewFA: Option OldFA,NewFA; J: Integer; var FAPostingType: Option Acquisition,Depr,WriteDown,Appr,Custom1,Custom2,Disposal,Maintenance,"Salvage Value",,,,Derogatory; var Sign: Integer; var FANo: Code[20])
    begin
