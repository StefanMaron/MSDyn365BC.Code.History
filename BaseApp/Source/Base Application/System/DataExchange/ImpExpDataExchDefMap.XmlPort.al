    ...
    schema
    {
        textelement(root)
        {
            tableelement("Data Exch. Def"; "Data Exch. Def")
            {
                ...
                fieldattribute(ColumnsAsRows; "Data Exch. Def"."Columns as Rows")
                {
                    Occurrence = Optional;
                }
                fieldattribute(DocumentStartTag; "Data Exch. Def"."Document Start Tag")
                {
                    Occurrence = Optional;
                }
                fieldattribute(DocumentEndTag; "Data Exch. Def"."Document End Tag")
                {
                    Occurrence = Optional;
                }
                tableelement("Data Exch. Line Def"; "Data Exch. Line Def")
                {
                    ...
                    tableelement("Data Exch. Column Def"; "Data Exch. Column Def")
                    {
                        ...
                        fieldattribute(ColumnType; "Data Exch. Column Def"."Column Type")
                        {
                            Occurrence = Optional;
                        }
