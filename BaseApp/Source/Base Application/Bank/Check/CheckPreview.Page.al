    ...
    layout
    {
        area(content)
        {
            ...
            group(Payee)
            {
                ...
                field(Control1500007; PlaceholderLbl)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                field(Control1500006; PlaceholderLbl)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                field(Control1500005; PlaceholderLbl)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                ...
                field(Control1500010; PlaceholderLbl)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                field(Control1500009; PlaceholderLbl)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                field(Control1500008; PlaceholderLbl)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
