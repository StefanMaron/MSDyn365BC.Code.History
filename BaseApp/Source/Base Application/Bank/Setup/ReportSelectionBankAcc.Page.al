    ...
    begin
        ...
        case ReportUsage2 of
            ...
            "Report Selection Usage Bank"::"Unposted Cash Ingoing Order":
                Rec.SetRange(Usage, Enum::"Report Selection Usage"::UCI);
            "Report Selection Usage Bank"::"Unposted Cash Outgoing Order":
                Rec.SetRange(Usage, Enum::"Report Selection Usage"::UCO);
            "Report Selection Usage Bank"::"Cash Book":
                Rec.SetRange(Usage, Enum::"Report Selection Usage"::CB);
            "Report Selection Usage Bank"::"Cash Ingoing Order":
                Rec.SetRange(Usage, Enum::"Report Selection Usage"::CI);
            "Report Selection Usage Bank"::"Cash Outgoing Order":
                Rec.SetRange(Usage, Enum::"Report Selection Usage"::CO);
        end;
