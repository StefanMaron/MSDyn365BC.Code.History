        ...
        area(Sections)
        {
            group("Group")
            {
                ...
                group("Group1")
                {
                    ...
                    group("Group2")
                    {
                        ...
                        action("Crossborder Services")
                        {
                            ...
                            RunObject = report "Crossborder Services";
                        }
                    }
                }
                group("Group3")
                ...
                group("Group7")
                {
                    ...
                    group("Group11")
                    {
                        ...
                        action("G/L Setup Information")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'G/L Setup Information';
                            RunObject = report "G/L Setup Information";
                        }
                    }
                }
                group("Group12")
                ...
                group("Group44")
                {
                    ...
                    group("Group45")
                    {
                        ...
                        action("Report11011")
                        {
                            ...
                            RunObject = report "Fixed Asset - Book Value 03";
                        }
                        action("Details")
                        {
                            ApplicationArea = FixedAssets;
                        ...
                        action("Fixed Assets - List AT")
                        {
                            ApplicationArea = FixedAssets;
                            Caption = 'List AT';
                            RunObject = report "Fixed Assets - List AT";
                        }
            ...
            group("Group50")
            {
                ...
                group("Group53")
                {
                    ...
                    action("Phys. Invt. Order Diff. List")
                    {
                        ApplicationArea = Basic, Suite;
            ...
            group("Group55")
            {
                ...
                group("Group56")
                {
                    ...
                    action("Update VAT Statement Template")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Update VAT Statement Template';
                        RunObject = report "Update VAT Statement Template";
                    }
                    action("Report Selections VAT")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Report Selections VAT';
                        RunObject = page "Report Selection - VAT";
                    }
                ...
                group("Group57")
                {
                    ...
                    action("Place of Dispatchers")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Place of Dispatchers';
                        RunObject = page "Place of Dispatchers";
                    }
                    action("Place of Receivers")
                    {
                        ApplicationArea = Basic, Suite;
            ...
            group("Group62")
            {
                ...
                {
                    Caption = 'Misc';
                    action("G/L Entries with Foreign Curre")
                    {
                        ApplicationArea = Basic, Suite;
