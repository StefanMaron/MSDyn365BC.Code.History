        ...
        area(Sections)
        {
            group("Group")
            {
                ...
                group("Group1")
                {
                    ...
                    action("Settled VAT Periods")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Settled VAT Periods';
                        RunObject = page "Settled VAT Periods";
                        Tooltip = 'Open the Settled VAT Periods page.';
                    }
                    action("Trade Settlement")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Trade Settlement';
                        RunObject = report "Trade Settlement";
                        Tooltip = 'Run the Trade Settlement report.';
                    }
                    action("Trade Settlement from 2017")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Trade Settlement from 2017';
                        RunObject = report "Trade Settlement 2017";
                        Tooltip = 'Run the Trade Settlement from 2017 report.';
                    }
                    action("VAT Reconciliation")
                    {
                        ...
                        Tooltip = 'Run the VAT Reconciliation report.';
                    }
                    group("Group2")
                    {
                        Caption = 'Reports';
                ...
                group("Group7")
                {
                    ...
                    group("Group8")
                    {
                        ...
                        action("G/L Register Customer/Vendor")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'G/L Register Customer/Vendor';
                            RunObject = report "G/L Register Customer/Vendor";
                            Tooltip = 'Run the G/L Register Customer/Vendor report.';
                        }
                    ...
                    group("Group9")
                    {
                        ...
                        action("Trial Balance/Previous Period")
                        {
                            ApplicationArea = Basic, Suite;
            ...
            group("Group28")
            {
                ...
                group("Group34")
                {
                    ...
                    action("Cust. Ledger Entries on Hold")
                    {
                        ...
                        Tooltip = 'Run the Cust. Ledger Entries on Hold report.';
                    }
                    action("Customer - Balance")
                    {
                        ...
                        Tooltip = 'Run the Customer - Balance report.';
                    }
                    ...
                    action("Customer - Open Entries")
                    {
                        ...
                        Tooltip = 'Run the Customer - Open Entries report.';
                    }
                    ...
                    action("Customer - Collection List")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Customer - Collection List';
                        RunObject = report "Customer - Collection List";
                        Tooltip = 'Run the Customer - Collection List report.';
                    }
                    action("Customer - Address List")
                    {
                        ...
                        Tooltip = 'Run the Customer - Address List report.';
                    }
                    ...
                    action("Sales - Invoice")
                    {
                        ...
                        Tooltip = 'Run the Sales - Invoice report.';
                    }
                    ...
                    action("Sales - Credit Memo")
                    {
                        ...
                        Tooltip = 'Run the Sales - Credit Memo report.';
                    }
                    action("Finance Charge Memo")
                    {
                        ...
                        Tooltip = 'Run the Finance Charge Memo report.';
                    }
                    action("Reminder")
                    {
                        ApplicationArea = Basic, Suite;
                        ...
                        Tooltip = 'Run the Reminder report.';
                    }
            ...
            group("Group36")
            {
                ...
                {
                    Caption = 'Remittance';
                    action("Remittance Agreement Overview")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Remittance Agreement Overview';
                        RunObject = page "Remittance Agreement Overview";
                        Tooltip = 'Open the Remittance Agreement Overview page.';
                    }
                    action("Remittance Account Overview")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Remittance Account Overview';
                        RunObject = page "Remittance Account Overview";
                        Tooltip = 'Open the Remittance Account Overview page.';
                    }
                }
                group("Group37")
                {
                ...
                group("Group40")
                {
                    ...
                    action("Vendor - Balance")
                    {
                        ...
                        RunObject = report "Vendor - Balance";
                        Tooltip = 'Run the Vendor - Balance report.';
                    }
                    action("Vendor - Open Entries")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Vendor - Open Entries';
                        RunObject = report "Vendor - Open Entries";
                        Tooltip = 'Run the Vendor - Open Entries report.';
                    }
                    ...
                    action("Vendor - Address List")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Vendor - Address List';
                        RunObject = report "Vendor - Address List";
                        Tooltip = 'Run the Vendor - Address List report.';
                    }
            ...
            group("Group55")
            {
                ...
                action("OCR Setup")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'OCR Setup';
                    RunObject = page "OCR Setup";
                    Tooltip = 'Open the OCR Setup page.';
                }
                group("Group56")
                {
                    Caption = 'VAT';
