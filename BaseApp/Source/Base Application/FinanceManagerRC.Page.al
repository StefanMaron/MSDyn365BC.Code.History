            ...
            group("Group62")
            {
                ...
                group("Group67")
                {
                    ...
                    action("PO - Export N34.1")
                    {
                        ...
                        RunObject = report 7000060;
                    }
                    action("Void PO - Export")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Void PO - Export';
                        RunObject = report 7000061;
                    }
