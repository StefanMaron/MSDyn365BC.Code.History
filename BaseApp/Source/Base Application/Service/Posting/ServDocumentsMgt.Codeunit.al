...
codeunit 5988 "Serv-Documents Mgt."
{
    ...
    begin
        with ServHeader do begin
            ...
            SetGenJnlLineDocNos(GenJnlLineDocType::Invoice, ServInvHeader."No.", "No.", ServInvHeader."Reference No.");
    ...
    begin
        with ServHeader do begin
            ...
            SetGenJnlLineDocNos(GenJnlLineDocType::"Credit Memo", ServCrMemoHeader."No.", "No.", ServInvHeader."Reference No.");
