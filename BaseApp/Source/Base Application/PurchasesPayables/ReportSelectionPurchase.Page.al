            ...
            if Evaluate(NewReportUsage, Rec.GetFilter(Usage)) then
                case NewReportUsage of
                    ...
                    "Report Selection Usage"::UAS:
                        ReportUsage2 := "Report Selection Usage Purchase"::"UnPosted Advance Statement";
                    "Report Selection Usage"::AS:
                        ReportUsage2 := "Report Selection Usage Purchase"::"Advance Statement";
                    "Report Selection Usage"::UPI:
                        ReportUsage2 := "Report Selection Usage Purchase"::"UnPosted Invoice";
                    "Report Selection Usage"::UPCM:
                        ReportUsage2 := "Report Selection Usage Purchase"::"UnPosted Cr. Memo";
                    else
