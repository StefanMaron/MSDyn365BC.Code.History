...
report 394 "Suggest Employee Payments"
{
    ...
    dataset
    {
        dataitem("Employee Posting Group"; "Employee Posting Group")
        {
        }
    ...
    begin
        ...
        // NAVCZ
        if "Employee Posting Group".GetFilter(Code) <> '' then
    ...
    begin
        with GenJnlLine do begin
            ...
            "Posting Group" := EmployeeLedgerEntry."Employee Posting Group"; // NAVCZ
        ...
        if TempPayableEmployeeLedgerEntry.Find('-') then
            repeat
                ...
                repeat
                    ...
                    TempEmplPaymentBuffer."Employee Posting Group" := EmployeeLedgerEntry."Employee Posting Group"; // NAVCZ
        ...
        if TempEmplPaymentBuffer.FindSet() then
            repeat
                with GenJnlLine do begin
                    ...
                    Validate("Posting Group", TempEmplPaymentBuffer."Employee Posting Group"); // NAVCZ
