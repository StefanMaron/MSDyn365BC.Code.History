report 410 "Blanket Purchase Order"
{
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocumentDate_PurchHdr; Format("Purchase Header"."Document Date", 0, '<Day,2>.<Month,2>.<Year4>'))
                    {
                    }
    ...
    begin
        ...
        CHReportManagement.PrepareHeader(RecRef, REPORT::"Blanket Purchase Order", HeaderLabel, HeaderTxt);
    end;
