        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocDate_PurchaseHeaderCaption; DocDate_PurchaseHeaderCaptionLbl)
                    {
                    }
                    column(ShipmentMethodCommentCaption; ShipmentMethodCommentCaptionLbl)
                    {
                    }
                    ...
                    dataitem(DimensionLoop1; "Integer")
                    {
                        ...
                        column(DimLoopNo1; DimensionLoop1.Number)
                        {
                        }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Comment_PurchaseLineCaption; "Purchase Line".FieldCaption(Description))
                        {
                        }
                        ...
                        dataitem(DimensionLoop2; "Integer")
                        {
                            ...
                            column(DimLoopNo2; DimensionLoop2.Number)
                            {
                            }
