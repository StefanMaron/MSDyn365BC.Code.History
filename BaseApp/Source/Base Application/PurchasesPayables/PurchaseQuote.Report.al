report 404 "Purchase - Quote"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(CompanyInfoEnterpriseNoCap; CompanyInfoEnterpriseNoCapLbl)
            {
            }
            ...
            begin
                ...
                if not Country.DetermineCountry("Pay-to Country/Region Code") then begin
    ...
    var
        ...
        CompanyInfoEnterpriseNoCapLbl: Label 'Enterprise No.';
