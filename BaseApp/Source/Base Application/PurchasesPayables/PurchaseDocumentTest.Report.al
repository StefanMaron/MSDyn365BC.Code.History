report 402 "Purchase Document - Test"
{
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(TempPurchLine__Line_Amount____TempPurchLine__Inv__Discount_Amount_; -TempPurchLine."Pmt. Discount Amount")
                        {
                        }
                        ...
                        column(TempPurchLine__Line_Amount____TempPurchLine__Inv__Discount_Amount____VATAmount; TempPurchLine."Line Amount" - TempPurchLine."Inv. Discount Amount" - TempPurchLine."Pmt. Discount Amount" + VATAmount)
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(TempPurchLine__Line_Amount____TempPurchLine__Inv__Discount_Amount__Control224; TempPurchLine."Line Amount" - TempPurchLine."Inv. Discount Amount" - TempPurchLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(SumPmtDiscRcdAmount; SumPmtDiscRcdAmount)
                        {
                        }
                        ...
                        column(VATAmountLine__VAT_Calculation_Type_; TempVATAmountLine."VAT Calculation Type")
                        {
                        }
                        column(TotalExclVATText_Control1100011; TotalExclVATText)
                        {
                        }
                        column(TotalInclVATText_Control1100012; TotalInclVATText)
                        {
                        }
                        column(VATAmountLine_VATAmountText_Control1100013; TempVATAmountLine.VATAmountText())
                        {
                        }
                        column(TempPurchLine__Line_Amount__Control1100002; TempPurchLine."Line Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(TempPurchLine__Line_Amount__Control1100010; TempPurchLine."Line Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmount_Control1100014; VATAmount)
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        dataitem(DimensionLoop2; "Integer")
                        {
                            ...
                            begin
                                ...
                                SumPmtDiscRcdAmount := SumPmtDiscRcdAmount + TempPurchLine."Pmt. Discount Amount";
                            end;
                    ...
                    dataitem(VATCounter; "Integer")
                    {
                        ...
                        column(VATAmountLine__VAT_EC_Base_; TempVATAmountLine."VAT Base")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__Invoice_Discount_Amount___VATAmountLine__Pmt__Disc__Given_Amount_; TempVATAmountLine."Invoice Discount Amount" + TempVATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__Invoice_Discount_Amount__Control177; TempVATAmountLine."Invoice Discount Amount" + TempVATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(EC__; TempVATAmountLine."EC %")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__VAT_EC_Base__Control139; TempVATAmountLine."VAT Base")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__Invoice_Discount_Amount___VATAmountLine__Pmt__Disc__Given_Amount__Control181; TempVATAmountLine."Invoice Discount Amount" + TempVATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__Invoice_Discount_Amount__Control187; TempVATAmountLine."Invoice Discount Amount" + TempVATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__EC_Amount__Control1100009; TempVATAmountLine."EC Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(EC__Caption; EC__CaptionLbl)
                        {
                        }
                        column(EC_AmountCaption; EC_AmountCaptionLbl)
                        {
                        }
                        column(VATAmountLine__VAT_EC_Base_Caption; VATAmountLine__VAT_EC_Base_CaptionLbl)
                        {
                        }
                        column(VATAmountLine__VAT_EC_Base__Control139Caption; VATAmountLine__VAT_EC_Base__Control139CaptionLbl)
                        {
                        }
    ...
    var
        ...
        TotalTextLbl: Label 'Pmt. Disc. Rcd. Amount';
        ...
        VATAmountLine__VAT_Base__Control138CaptionLbl: Label 'VAT + EC Base';
        ...
        VATAmountLine__Invoice_Discount_Amount__Control177CaptionLbl: Label 'Inv. and Pmt. Discounts';
        EC__CaptionLbl: Label 'EC %';
        EC_AmountCaptionLbl: Label 'EC Amount';
        VATAmountLine__VAT_EC_Base_CaptionLbl: Label 'Continued';
        VATAmountLine__VAT_EC_Base__Control139CaptionLbl: Label 'Continued';
