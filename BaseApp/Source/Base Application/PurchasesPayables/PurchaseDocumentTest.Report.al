report 402 "Purchase Document - Test"
{
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(VATCounterACY; "Integer")
                    {
                        DataItemTableView = SORTING(Number);
                        column(PurchSetup__Enable_Vendor_GST_Amount__ACY__; PurchSetup."Enable Vendor GST Amount (ACY)")
                        {
                        }
                        column(VATAmountLine__VAT_Amount__ACY__; TempVATAmountLine."VAT Amount (ACY)")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__VAT_Base__ACY__; TempVATAmountLine."VAT Base (ACY)")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__VAT____Control1500006; TempVATAmountLine."VAT %")
                        {
                            DecimalPlaces = 0 : 5;
                        }
                        column(VATAmountLine__VAT_Identifier__Control1500007; TempVATAmountLine."VAT Identifier")
                        {
                        }
                        column(VATAmountLine__VAT_Amount__ACY___Control1500008; TempVATAmountLine."VAT Amount (ACY)")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__VAT_Base__ACY___Control1500009; TempVATAmountLine."VAT Base (ACY)")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATCounterACY_Number; Number)
                        {
                        }
                        column(GST_Amount__ACY_Caption; GST_Amount__ACY_CaptionLbl)
                        {
                        }
                        column(GST_Base__ACY_Caption; GST_Base__ACY_CaptionLbl)
                        {
                        }
                        column(VATAmountLine__VAT____Control1500006Caption; VATAmountLine__VAT____Control1500006CaptionLbl)
                        {
                        }
                        column(VATAmountLine__VAT_Identifier__Control1500007Caption; VATAmountLine__VAT_Identifier__Control1500007CaptionLbl)
                        {
                        }
                        column(VATAmountLine__VAT_Base__ACY___Control1500009Caption; VATAmountLine__VAT_Base__ACY___Control1500009CaptionLbl)
                        {
                        }
    ...
    var
        ...
        GST_Amount__ACY_CaptionLbl: Label 'GST Amount (ACY)';
        GST_Base__ACY_CaptionLbl: Label 'GST Base (ACY)';
        VATAmountLine__VAT____Control1500006CaptionLbl: Label 'GST %';
        VATAmountLine__VAT_Identifier__Control1500007CaptionLbl: Label 'GST Identifier';
        VATAmountLine__VAT_Base__ACY___Control1500009CaptionLbl: Label 'Total';
