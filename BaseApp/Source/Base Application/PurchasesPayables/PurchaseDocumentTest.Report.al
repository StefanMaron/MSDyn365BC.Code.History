            ...
            begin
                ...
                if "Vendor Invoice No." <> '' then begin
                    ...
                    // NAVCZ
                        ...
                        CheckExtDocNoInPostedPurchDoc("Purchase Header");
                    // NAVCZ
                end;
                ...
                if "Vendor Cr. Memo No." <> '' then begin
                    ...
                    if VendLedgEntry.FindFirst() then
                        AddError(
                          StrSubstNo(
                            Text017,
                            "Document Type", "Vendor Cr. Memo No."))
                    else
                        CheckExtDocNoInPostedPurchDoc("Purchase Header");
                end;
                // NAVCZ
            ...
            case "Document Type" of
                ...
                "Document Type"::"Credit Memo":
                    begin
                        ...
                        PurchCrMemoHdr.SetRange("Vendor Cr. Memo No.", "Vendor Cr. Memo No.");
                        PurchCrMemoHdr.SetRange("Pay-to Vendor No.", "Pay-to Vendor No.");
