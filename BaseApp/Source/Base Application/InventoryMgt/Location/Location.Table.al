...
table 14 Location
{
        ...
        field(7316; "Prod. Consump. Whse. Handling"; Enum "Prod. Consump. Whse. Handling")
        {
            ...
            begin
                if Rec."Prod. Consump. Whse. Handling" <> xRec."Prod. Consump. Whse. Handling" then
                    CheckShipmentAndPickExists(Rec.Code, Rec.FieldCaption("Prod. Consump. Whse. Handling"));
            end;
        }
        ...
        field(7334; "Asm. Consump. Whse. Handling"; Enum "Asm. Consump. Whse. Handling")
        {
            ...
            begin
                if Rec."Asm. Consump. Whse. Handling" <> xRec."Asm. Consump. Whse. Handling" then
                    CheckShipmentAndPickExists(Rec.Code, Rec.FieldCaption("Asm. Consump. Whse. Handling"));
        ...
        field(7335; "Job Consump. Whse. Handling"; Enum "Job Consump. Whse. Handling")
        {
            ...
            begin
                if Rec."Job Consump. Whse. Handling" <> xRec."Job Consump. Whse. Handling" then
                    CheckShipmentAndPickExists(Rec.Code, Rec.FieldCaption("Job Consump. Whse. Handling"));
            end;
        }
    ...
    var
        ...
        PickExistsFieldValidationErr: Label 'You cannot change %1 because one or more pick documents exists for this location.', Comment = '%1 = field caption';
        ShipmentExistsFieldValidationErr: Label 'You cannot change %1 because one or more shipment documents exists for this location.', Comment = '%1 = field caption';
    ...
    local procedure CheckShipmentAndPickExists(LocationCode: Code[20]; FieldCaption: Text)
    var
    ...
    begin
        ...
        if not WarehouseShipmentHeader.IsEmpty() then
            Error(ShipmentExistsFieldValidationErr, FieldCaption);
        ...
        if not WarehouseActivityHeader.IsEmpty() then
            Error(PickExistsFieldValidationErr, FieldCaption);
    end;
