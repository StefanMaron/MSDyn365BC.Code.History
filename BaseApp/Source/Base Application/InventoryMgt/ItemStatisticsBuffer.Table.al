...
#pragma warning restore AS0070
        ...
        field(11500; "Inv. Valuation Actual"; Decimal)
        {
            Caption = 'Inv. Valuation Actual';
            DataClassification = SystemMetadata;
        }
        field(11501; "Inv. Valuation Exp."; Decimal)
        {
            Caption = 'Inv. Valuation Exp.';
            DataClassification = SystemMetadata;
        }
        field(11502; "Inv. Posted to GL"; Decimal)
        {
            Caption = 'Inv. Posted to GL';
            DataClassification = SystemMetadata;
        }
    }
