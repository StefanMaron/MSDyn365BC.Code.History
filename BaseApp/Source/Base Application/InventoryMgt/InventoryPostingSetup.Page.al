    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Purch. PD Gains Acc."; Rec."Purch. PD Gains Acc.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the purchases prepayment document gains account associated with the fixed asset allocation.';
                }
                field("Purch. PD Losses Acc."; Rec."Purch. PD Losses Acc.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the purchases prepayment document losses account associated with the inventory posting setup information.';
                }
