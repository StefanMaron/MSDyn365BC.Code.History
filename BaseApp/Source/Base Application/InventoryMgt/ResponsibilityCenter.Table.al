...
#pragma warning restore AS0086
        ...
        field(12400; "Region Name"; Text[50])
        {
            Caption = 'Region Name';
        }
        field(12401; "Region Code"; Code[10])
        {
            Caption = 'Region Code';
            //This property is currently not supported
            //TestTableRelation = false;
        ...
        field(12402; Settlement; Text[50])
        {
            Caption = 'Settlement';
        }
        field(12403; Street; Text[50])
        {
            Caption = 'Street';
        }
        field(12404; House; Text[10])
        {
            Caption = 'House';
        }
        field(12405; Building; Text[10])
        {
            Caption = 'Building';
        }
        field(12406; Apartment; Text[10])
        {
            Caption = 'Apartment';
        }
        field(12407; "MD Phone No."; Text[20])
        {
            Caption = 'MD Phone No.';
            ExtendedDatatype = PhoneNo;
        }
        field(12408; "CA Phone No."; Text[20])
        {
            Caption = 'CA Phone No.';
            ExtendedDatatype = PhoneNo;
        }
