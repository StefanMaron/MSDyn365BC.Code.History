        ...
        area(navigation)
        {
            group("&Receipt")
            {
                ...
                action(Dimensions)
                {
                    ...
                    Caption = 'Dimensions';
                    Image = Dimensions;
                    ToolTip = 'View dimensions, such as area, project, or department, that you can assign to journal lines to distribute costs and analyze transaction history.';
                ...
                action("Employee Si&gnatures")
                {
                    ...
                    ToolTip = 'View employee signatures.';
                }
            }
        }
        area(processing)
