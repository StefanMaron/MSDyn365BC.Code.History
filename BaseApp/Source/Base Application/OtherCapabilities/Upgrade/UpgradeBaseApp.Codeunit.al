...
codeunit 104000 "Upgrade - BaseApp"
{
    ...
    begin
        ...
        OutStream.WriteText('  <DataExchDef Code="SEPA CAMT 053-08-CH" Name="SEPA CAMT 053.001.08" Type="0" ExternalDataHandlingCodeunit="1240" FileType="0" ReadingWritingCodeunit="1200">');
        OutStream.WriteText('    <DataExchLineDef LineType="0" Code="SEPA CAMT 053-08-CH" Name="camt.053.001.08.xsd" ColumnCount="0" DataLineTag="/Document/BkToCstmrStmt/Stmt/Ntry" Namespace="urn:iso:std:iso:20022:tech:xsd:camt.053.001.08">');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="1" Name="Stmt/Id" Show="false" DataType="0" Description="ID" Path="/Document/BkToCstmrStmt/Stmt/Id" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="2" Name="Stmt/CreDtTm" Show="true" DataType="1" Description="CreDtTm" Path="/Document/BkToCstmrStmt/Stmt/CreDtTm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="3" Name="Stmt/Bal/Tp/CdOrPrtry/Cd" Show="true" DataType="0" Description="Cd" Path="/Document/BkToCstmrStmt/Stmt/Bal/Tp/CdOrPrtry/Cd" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="4" Name="Stmt/Bal/Amt" Show="true" DataType="2" Description="Amt" Path="/Document/BkToCstmrStmt/Stmt/Bal/Amt" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="5" Name="Stmt/Acct/Id/IBAN" Show="false" DataType="0" Description="IBAN" Path="/Document/BkToCstmrStmt/Stmt/Acct/Id/IBAN" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="6" Name="Stmt/Bal/Amt[@Ccy]" Show="true" DataType="0" Description="Ccy" Path="/Document/BkToCstmrStmt/Stmt/Bal/Amt[@Ccy]" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="7" Name="Stmt/Bal/CdtDbtInd" Show="true" DataType="0" Description="CdtDbtInd" Path="/Document/BkToCstmrStmt/Stmt/Bal/CdtDbtInd" NegativeSignIdentifier="DBIT" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="8" Name="Stmt/Ntry/Amt" Show="true" DataType="2" Description="Amt" Path="/Document/BkToCstmrStmt/Stmt/Ntry/Amt" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="9" Name="Stmt/Ntry/Amt[@Ccy]" Show="true" DataType="0" Description="Ccy" Path="/Document/BkToCstmrStmt/Stmt/Ntry/Amt[@Ccy]" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="10" Name="Stmt/Ntry/CdtDbtInd" Show="true" DataType="0" Description="CdtDbtInd" Path="/Document/BkToCstmrStmt/Stmt/Ntry/CdtDbtInd" NegativeSignIdentifier="DBIT" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="11" Name="Stmt/Ntry/BookgDt/Dt" Show="true" DataType="1" Description="Dt" Path="/Document/BkToCstmrStmt/Stmt/Ntry/BookgDt/Dt" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="12" Name="Stmt/Ntry/ValDt/Dt" Show="true" DataType="1" Description="Dt" Path="/Document/BkToCstmrStmt/Stmt/Ntry/ValDt/Dt" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="13" Name="Stmt/Ntry/AcctSvcrRef" Show="true" DataType="0" Description="AcctSvcrRef" Path="/Document/BkToCstmrStmt/Stmt/Ntry/AcctSvcrRef" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="14" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/Nm" Show="true" DataType="0" Description="Nm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/Nm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="15" Name="Stmt/Ntry/NtryDtls/TxDtls/RmtInf/Ustrd" Show="true" DataType="0" Description="Ustrd" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RmtInf/Ustrd" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="16" Name="Stmt/Ntry/AddtlNtryInf" Show="true" DataType="0" Description="AddtlNtryInf" Path="/Document/BkToCstmrStmt/Stmt/Ntry/AddtlNtryInf" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="17" Name="Stmt/Ntry/BookgDt/DtTm" Show="false" DataType="1" Description="BookgDt/DtTm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/BookgDt/DtTm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="18" Name="Stmt/Ntry/ValDt/DtTm" Show="false" DataType="1" Description="ValDt/DtTm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/ValDt/DtTm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="19" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/DbtrAcct/Id/IBAN" Show="true" DataType="0" Description="IBAN" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/DbtrAcct/Id/IBAN" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="20" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/DbtrAcct/Id/Othr/Id" Show="true" DataType="0" Description="Id" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/DbtrAcct/Id/Othr/Id" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="21" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/PstlAdr/AdrLine" Show="true" DataType="0" Description="AdrLine" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/PstlAdr/AdrLine" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="22" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/PstlAdr/TwnNm" Show="true" DataType="0" Description="TwnNm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/PstlAdr/TwnNm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="23" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/Nm" Show="true" DataType="0" Description="Nm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/Nm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="24" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/CdtrAcct/Id/IBAN" Show="true" DataType="0" Description="IBAN" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/CdtrAcct/Id/IBAN" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="25" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/CdtrAcct/Id/Othr/Id" Show="true" DataType="0" Description="Id" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/CdtrAcct/Id/Othr/Id" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="26" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/PstlAdr/AdrLine" Show="true" DataType="0" Description="AdrLine" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/PstlAdr/AdrLine" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="27" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/PstlAdr/TwnNm" Show="true" DataType="0" Description="TwnNm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/PstlAdr/TwnNm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="28" Name="Stmt/Ntry/NtryDtls/TxDtls/Refs/EndToEndId" Show="true" DataType="0" Description="EndToEndId" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/Refs/EndToEndId" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="29" Name="Stmt/Ntry/NtryDtls/TxDtls/RmtInf/Strd/CdtrRefInf/Ref" Show="true" DataType="0" Description="StrdRef" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RmtInf/Strd/CdtrRefInf/Ref" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="30" Name="Stmt/Ntry/NtryDtls/TxDtls/Refs/AcctSvcrRef" Show="true" DataType="0" Description="EndToEndId" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/Refs/AcctSvcrRef" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="31" Name="Stmt/Acct/Id/Othr/Id" Show="false" DataType="0" Description="BankId" Path="/Document/BkToCstmrStmt/Stmt/Acct/Id/Othr/Id" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="32" Name="Stmt/Ntry/NtryDtls/TxDtls/Refs/UETR" Show="true" DataType="0" Description="UETR" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/Refs/UETR" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="33" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/PstlAdr/BldgNm" Show="true" DataType="0" Description="BldgNm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/PstlAdr/BldgNm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="34" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/PstlAdr/StrtNm" Show="true" DataType="0" Description="StrtNm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Cdtr/Pty/PstlAdr/StrtNm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="35" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/PstlAdr/BldgNm" Show="true" DataType="0" Description="BldgNm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/PstlAdr/BldgNm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="36" Name="Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/PstlAdr/StrtNm" Show="true" DataType="0" Description="StrtNm" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RltdPties/Dbtr/Pty/PstlAdr/StrtNm" TextPaddingRequired="false" Justification="0" />');
        OutStream.WriteText('      <DataExchColumnDef ColumnNo="37" Name="Stmt/Ntry/NtryDtls/TxDtls/RmtInf/Strd/RfrdDocInf/Nb" Show="true" DataType="0" Description="Nb" Path="/Document/BkToCstmrStmt/Stmt/Ntry/NtryDtls/TxDtls/RmtInf/Strd/RfrdDocInf/Nb" TextPaddingRequired="false" Justification="0" />');
        ...
        OutStream.WriteText('      <DataExchMapping TableId="274" Name="SEPA CAMT to Bank Acc. Reconciliation Line" MappingCodeunit="11521" DataExchNoFieldID="17" DataExchLineFieldID="18">');
        ...
        OutStream.WriteText('        <DataExchFieldMapping ColumnNo="29" FieldID="11500" Optional="true" />');
