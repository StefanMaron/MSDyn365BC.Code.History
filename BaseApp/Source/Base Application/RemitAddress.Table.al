...
#pragma warning restore AA0139
    ...
    var
        ...
        MissingOnlineMapSetupLbl: Label 'Before you can use Online Map, you must fill in the Online Map Setup window.\See Setting Up Online Map in Help.';
...
#pragma warning disable AA0139
    ...
    begin
        ...
        if OnlineMapSetup.IsEmpty() then
            Message(MissingOnlineMapSetupLbl)
        else
            OnlineMapManagement.MakeSelection(DATABASE::"Remit Address", GetPosition());
    end;
#pragma warning restore AA0139
