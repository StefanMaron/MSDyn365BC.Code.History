table 5110 "Purchase Line Archive"
{
    ...
    fields
    {
        ...
        field(12401; "Empl. Purchase Entry No."; Integer)
        {
            Caption = 'Empl. Purchase Entry No.';
            TableRelation = "Vendor Ledger Entry";
        }
        field(12402; "Empl. Purchase Document Date"; Date)
        {
            Caption = 'Empl. Purchase Document Date';
        }
        field(12403; "Empl. Purchase Vendor No."; Code[20])
        {
            Caption = 'Empl. Purchase Vendor No.';
        }
        field(12404; "Empl. Purchase Document No."; Code[20])
        {
            Caption = 'Empl. Purchase Document No.';
        }
