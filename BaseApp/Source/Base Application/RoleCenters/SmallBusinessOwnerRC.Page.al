    ...
    actions
    {
        area(reporting)
        {
            ...
            action("VAT Reconciliation")
            {
                ...
                Image = "Report";
                RunObject = Report "VAT Reconciliation Report";
                ToolTip = 'View the reconciliation settlement for the base amount and the VAT amount for general ledger accounts. These amounts are grouped by different VAT types.';
            }
            action(Tradesettlement)
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Tradesettlement';
                Image = "Report";
                RunObject = Report "Trade Settlement";
                ToolTip = 'View and calculate a Norwegian trade settlement. The report consists of two main parts. The first part shows the VAT details that are used to calculate the trade settlement. The second part shows the actual trade settlement. The report layout is like the trade settlement form that you use when you report VAT and taxes to the authorities.';
            }
        }
        area(embedding)
        {
