    ...
    actions
    {
        area(reporting)
        {
            ...
            action("G/L Total-Balance")
            {
                ...
                ToolTip = 'View the chart of accounts with balanced debit and credit movements depending on the selected date filter, for example, to view a sum and balance list for specific departments or projects. The correction postings lead to a correction of the monthly debits and credits. For example, the correction of a debit posting is shown as a negative debit posting. The report can be used for the completion of an accounting period or of a fiscal year.';
            }
            separator(Action49)
            {
            }
            ...
            action("Customer Total-Balance")
            {
                ...
                ToolTip = 'View the total balance for one or more customers. This consists of the balanced movements depending on the selected date filter. You can also display the overdue balances. Optionally, you can send the statement to the customer, such as when you are closing an accounting period or as a reminder. The correction postings lead to a correction of the monthly debits and credits. For example, the correction of a debit posting is shown as a negative debit posting.';
            }
            action("Vendor Total-Balance")
            {
                ...
                ToolTip = 'View the balanced debit and credit movements brought forward, debit and credit movements, as well as the balance. You can also view the overdue balances. For example, you can send the statement to a vendor on closing an accounting period for the reconciliation of balances. The correction postings lead to a correction of the monthly debits and credits. For example, the correction of a debit posting is shown as a negative debit posting.';
            }
            separator(Action53)
            {
            }
        ...
        area(processing)
        {
            ...
            action("Digital Audit Export")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Digital Audit Export';
                Image = "Report";
                RunObject = Report "Export Business Data";
                ToolTip = 'Set up data export record sources to be able to export digital audit data. For each data export type, you must define one or more record sources, where each source is a table from which you want to export data.';
            }
            separator(Action31)
            {
                Caption = 'Administration';
