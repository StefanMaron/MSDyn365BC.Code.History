...
page 9020 "Small Business Owner RC"
{
    ...
    actions
    {
        area(reporting)
        {
            ...
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Account Book Sheet';
                Image = "Report";
                RunObject = Report "Account Book Sheet - Print";
                ToolTip = 'Run a report that shows all entries posted in a specific period for each general ledger account.';
            }
            separator(Action61)
            {
            }
            ...
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Vendor Sheet';
                Image = "Report";
                RunObject = Report "Vendor Sheet - Print";
                ToolTip = 'View all entries posted in a specific period for each vendor.';
            }
            action("Vendor Account Bills List")
            {
                ...
                ToolTip = 'View the list of vendor account bills.';
            }
            separator(Action75)
            {
            }
            ...
            action("Bank Sheet")
            {
                ...
                ToolTip = 'Get a report that shows all entries posted in a specific period for each bank account.';
            }
            separator(Action53)
            {
            }
        ...
        area(embedding)
        {
            ...
            action("Customer Bills")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Customer Bills';
                RunObject = Page "List of Customer Bills";
                ToolTip = 'View the list of customer bills.';
            }
            ...
            action("Vendor Bills - Open")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Vendor Bills - Open';
                RunObject = Page "List of Open Vendor Bills";
                ToolTip = 'View the list of open vendor bills.';
            }
            action("Vendor Bills - Sent")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Vendor Bills - Sent';
                RunObject = Page "List of Sent Vendor Bills";
                ToolTip = 'View the list of sent vendor bills.';
            }
            action(Items)
            {
                ApplicationArea = Basic, Suite;
        ...
        area(sections)
        {
            ...
            group("Posted Documents")
            {
                ...
                action("Posted Vendor Bills")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Posted Vendor Bills';
                    RunObject = Page "List of Posted Vend. Bill List";
            ...
            group(Finance)
            {
                ...
                action("INAIL Contributions")
                {
                    ...
                    ToolTip = 'View the workers´Š¢ compensation taxes on non-inventory services that you have purchased from an independent contractor or consultant.';
                }
