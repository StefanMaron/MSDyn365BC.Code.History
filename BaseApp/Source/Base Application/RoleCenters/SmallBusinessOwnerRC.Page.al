    ...
    actions
    {
        area(reporting)
        {
            ...
            action("&Swiss VAT Statement")
            {
                ...
                ToolTip = 'View the standard VAT calculation for realized VAT. This report can be used for quarterly tax reporting. For customers using unrealized VAT, the VAT Statement setup has to be manually adjusted.';
            }
