codeunit 367 CheckManagement
{
    ...
    [Scope('OnPrem')]
    procedure GetVoidedCheckParameters(var BankLedgEntry: Record "Bank Account Ledger Entry")
    var
    ...
    [Scope('OnPrem')]
    procedure ShowPaymentDocument(var Rec: Record "Gen. Journal Line")
    var
        BankAcc: Record "Bank Account";
        BankOrderForm: Page "Bank Payment Order";
        CashInOrderForm: Page "Ingoing Cash Order";
        CashOutOrderForm: Page "Outgoing Cash Order";
    ...
    [Scope('OnPrem')]
    procedure CheckUnpostedVendor(var CheckLedgEntry: Record "Check Ledger Entry"; var GenJnlLine: Record "Gen. Journal Line")
    var
    ...
    [Scope('OnPrem')]
    procedure ModifyCheckLedgEntry(CheckLedgEntryRecSource: Record "Check Ledger Entry")
    var
        LocalCheckLedgEntryRec: Record "Check Ledger Entry";
    begin
