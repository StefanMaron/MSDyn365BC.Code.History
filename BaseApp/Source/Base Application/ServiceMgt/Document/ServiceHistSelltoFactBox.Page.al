        ...
        area(content)
        {
            ...
            group(Control1)
            {
                ...
                field(NoOfQuotes; NoOfQuotes)
                {
                    ...
                    begin
                        ServiceHeader.SetRange("Customer No.", Rec."No.");
                ...
                field(NoOfPostedShipments; NoOfPostedShipments)
                {
                    ...
                    begin
                        ServiceShipmentHdr.SetRange("Customer No.", Rec."No.");
                ...
                field(NoOfPostedInvoices; NoOfPostedInvoices)
                {
                    ...
                    begin
                        ServiceInvoiceHdr.SetRange("Customer No.", Rec."No.");
                ...
                field(NoOfPostedCreditMemos; NoOfPostedCreditMemos)
                {
                    ...
                    begin
                        ServiceCrMemoHdr.SetRange("Customer No.", Rec."No.");
