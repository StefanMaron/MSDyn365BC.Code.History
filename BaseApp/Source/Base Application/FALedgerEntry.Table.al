table 5601 "FA Ledger Entry"
{
    ...
    fields
    {
        ...
        field(13; "FA Posting Type"; Option)
        {
            ...
            OptionCaption = 'Acquisition Cost,Depreciation,Write-Down,Appreciation,Custom 1,Custom 2,Proceeds on Disposal,Salvage Value,Gain/Loss,Book Value on Disposal,Transfer';
            OptionMembers = "Acquisition Cost",Depreciation,"Write-Down",Appreciation,"Custom 1","Custom 2","Proceeds on Disposal","Salvage Value","Gain/Loss","Book Value on Disposal",Transfer;
        }
