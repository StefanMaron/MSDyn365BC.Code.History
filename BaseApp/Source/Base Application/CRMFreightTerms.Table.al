table 7204 "CRM Freight Terms"
{
    Caption = 'Dataverse Freight Terms';
    ...
    begin
        if TableMetadata.Get(Database::"CRM Account") then
            OptionSetMetadataDictionary := CDSIntegrationMgt.GetOptionSetMetadata(TableMetadata.ExternalName, 'address1_freighttermscode');
