codeunit 444 "Purchase-Post Prepayments"
{
        ...
        with PurchHeader do begin
            ...
            repeat
                ...
                case DocumentType of
                    DocumentType::Invoice:
                        begin
                            InsertPurchInvLine(PurchInvHeader, LineNo, TempPrepmtInvLineBuffer, "No.");
    ...
    local procedure PostPrepmtInvLineBuffer(PurchHeader: Record "Purchase Header"; PrepmtInvLineBuffer: Record "Prepayment Inv. Line Buffer"; DocumentType: Option Invoice,"Credit Memo"; PostingDescription: Text[100]; DocType: Option; DocNo: Code[20]; ExtDocNo: Text[35]; SrcCode: Code[10]; PostingNoSeriesCode: Code[20]; WHTAmountLCY: Decimal; WHTAmount: Decimal)
    var
        GenJnlLine: Record "Gen. Journal Line";
    begin
    ...
    local procedure InsertPurchInvLine(PurchInvHeader: Record "Purch. Inv. Header"; LineNo: Integer; PrepmtInvLineBuffer: Record "Prepayment Inv. Line Buffer"; DocNo: Code[20])
    var
        PurchInvLine: Record "Purch. Inv. Line";
    ...
    begin
        with PrepmtInvLineBuffer do begin
            ...
            if GLSetup.CheckFullGSTonPrepayment("VAT Bus. Posting Group", "VAT Prod. Posting Group") then begin
                ...
                PurchLine2.Reset;
                PurchLine2.SetFilter("Document No.", DocNo);
