codeunit 444 "Purchase-Post Prepayments"
{
    ...
    var
        ...
        Text1130004: Label 'Total Reg. %1 is different from total Document %2.', Comment = '%! and %2 - Total Amounts';
    ...
    begin
        ...
        with PurchHeader do begin
            ...
            if DocumentType <> DocumentType::"Credit Memo" then
                InsertPostedPaymentLines(PurchHeader, DocumentType, PurchInvHeader."No.")
            else
                InsertPostedPaymentLines(PurchHeader, DocumentType, PurchCrMemoHeader."No.");

            InsertPaymentJnlLine(PurchHeader);
            ...
            if Abs(TotalPrepmtInvLineBuffer."Amount Incl. VAT") <> "Check Total" then
                Error(Text1130004, Abs(TotalPrepmtInvLineBuffer."Amount Incl. VAT"), "Check Total");
    ...
    begin
        ...
        with PurchHeader do begin
            ...
            TestField("Operation Occurred Date");
            ...
            GLSetup.Get();
            if "Operation Occurred Date" < GLSetup."Last Gen. Jour. Printing Date" then
                FieldError("Operation Occurred Date", Text1130008);

            if "Applies-to Doc. No." <> '' then
                if "Applies-to Occurrence No." = 0 then
                    Error(Text1130007, FieldCaption("Applies-to Occurrence No."));
    ...
    begin
        with PurchHeader do begin
            case DocumentType of
                    ...
                    begin
                        ...
                        if "Prepayment No." = '' then
                            if not PreviewMode then begin
                                ...
                                NoSeriesMgt.TestDateOrder("Prepayment No. Series");
                ...
                DocumentType::"Credit Memo":
                    begin
                        ...
                        CheckPrepmtReferstoPeriod(PurchHeader);
                        if "Prepmt. Cr. Memo No." = '' then
                            if not PreviewMode then begin
                                TestField("Prepmt. Cr. Memo No. Series");
                                NoSeriesMgt.TestDateOrder("Prepmt. Cr. Memo No. Series");
            ...
            if HasReverseChargeVAT(PurchHeader) and ("Reverse Sales VAT No." = '') then
                if "Reverse Sales VAT No. Series" <> '' then begin
    ...
    begin
        ...
        NewPrepmtInvLineBuf.FillAdjInvLineBuffer(
          PrepmtInvLineBuf,
          GetPrepmtAccNo(PrepmtInvLineBuf."VAT Bus. Posting Group", PrepmtInvLineBuf."VAT Prod. Posting Group"),
                    ...
                    if NewAmount <> 0 then begin
                        ...
                        then
                            VATAmountLine.InsertNewLine(
                              ...
                              "Prepayment VAT %", NewAmount >= 0, true, "Deductible %");
                ...
                repeat
                    if PrepmtAmount(PurchLine, DocumentType) <> 0 then begin
                        if "Document Type" in ["Document Type"::Order, "Document Type"::Invoice, "Document Type"::"Credit Memo"] then begin
                            VATPostingSetup.Get(
                              PurchLine."VAT Bus. Posting Group", PurchLine."VAT Prod. Posting Group");
                            if VATPostingSetup."EU Service" then begin
                                if VATPostingSetup."Service Tariff No. Mandatory" then
                                    PurchLine.TestField("Service Tariff No.");
    ...
    begin
        with PrepmtInvLineBuf do begin
            Init;
            "G/L Account No." := GetPrepmtAccNo(PurchLine."VAT Bus. Posting Group", PurchLine."VAT Prod. Posting Group");
            ...
            "Prepmt. CM Refers to Period" := PurchLine."Prepmt. CM Refers to Period";
    ...
    begin
        with GenJnlLine do begin
            ...
            Validate("Document Date", PurchHeader."Document Date");
    ...
    [Scope('OnPrem')]
    procedure CheckPrepmtReferstoPeriod(var PurchHeader: Record "Purchase Header")
    var
        PurchLine: Record "Purchase Line";
    begin
        PurchLine.Reset();
        ...
        PurchLine.SetFilter("Prepayment %", '<>%1', 0);
        if PurchLine.FindSet then
            repeat
                PurchLine.TestField("Prepmt. CM Refers to Period")
            until PurchLine.Next = 0;
    end;

    local procedure HasReverseChargeVAT(PurchHeader: Record "Purchase Header"): Boolean
    var
    ...
    begin
        with PrepmtInvLineBuffer do begin
            ...
            PurchInvLine."Deductible %" := "Deductible %";
    ...
    begin
        with PrepmtInvLineBuffer do begin
            ...
            PurchCrMemoLine."Deductible %" := "Deductible %";
            ...
            PurchCrMemoLine."Prepmt. CM Refers to Period" := "Prepmt. CM Refers to Period";
    ...
    local procedure InsertPostedPaymentLines(PurchHeader: Record "Purchase Header"; DocumentType: Option Invoice,"Credit Memo"; DocumentNo: Code[20])
    var
    ...
    begin
        with PurchHeader do begin
            case DocumentType of
                DocumentType::Invoice:
                    PostedPaymentLines.Type := PostedPaymentLines.Type::Invoice;
                DocumentType::"Credit Memo":
                    PostedPaymentLines.Type := PostedPaymentLines.Type::"Credit Memo";
            end;
            PostedPaymentLines.Code := DocumentNo;
            PostedPaymentLines."Sales/Purchase" := PostedPaymentLines."Sales/Purchase"::Purchase;
            PostedPaymentLines."Line No." := 10000;
            PostedPaymentLines."Payment %" := 100;
            PostedPaymentLines."Due Date" := "Prepayment Due Date";
            PostedPaymentLines."Discount %" := "Prepmt. Payment Discount %";
            PostedPaymentLines."Pmt. Discount Date" := "Prepmt. Pmt. Discount Date";
            PostedPaymentLines.Insert();
        end;
    end;

    local procedure InsertPaymentJnlLine(PurchHeader: Record "Purchase Header")
    var
        PaymentLines: Record "Payment Lines";
    begin
        with PurchHeader do begin
            PaymentLines.Init();
            PaymentLines."Sales/Purchase" := 0;
            PaymentLines.Type := PaymentLines.Type::"General Journal";
            PaymentLines."Line No." := 10000;
            PaymentLines."Payment %" := 100;
            PaymentLines."Due Date" := "Prepayment Due Date";
            PaymentLines."Discount %" := "Prepmt. Payment Discount %";
            PaymentLines."Pmt. Discount Date" := "Prepmt. Pmt. Discount Date";
            PaymentLines.Insert();
        end;
    end;
