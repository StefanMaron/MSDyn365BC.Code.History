codeunit 444 "Purchase-Post Prepayments"
{
    ...
    begin
        ...
        with PurchHeader do begin
            ...
            if GenJnlCheckLine.DateNotAllowed("Posting Date", "Journal Template Name") then
            ...
            case DocumentType of
                DocumentType::Invoice:
                    begin
                        ...
                        PurchSetup.TestField("Jnl. Templ. Prep. P. Inv.");
                        GenJournalTemplate.Get(PurchSetup."Jnl. Templ. Prep. P. Inv.");
                        if "Prepayment No." = '' then
                            if not PreviewMode then begin
                                GenJournalTemplate.TestField("Posting No. Series");
                                "Prepayment No." := NoSeriesMgt.GetNextNo(GenJournalTemplate."Posting No. Series", "Posting Date", true);
                                ModifyHeader := true;
                            end else
                                "Prepayment No." := '***';
                        DocNo := "Prepayment No.";
                ...
                DocumentType::"Credit Memo":
                    begin
                        ...
                        PurchSetup.TestField("Jnl. Templ. Prep. P. Cr. Memo");
                        GenJournalTemplate.Get(PurchSetup."Jnl. Templ. Prep. P. Cr. Memo");
                        if "Prepmt. Cr. Memo No." = '' then
                            if not PreviewMode then begin
                                GenJournalTemplate.TestField("Posting No. Series");
                                "Prepmt. Cr. Memo No." := NoSeriesMgt.GetNextNo(GenJournalTemplate."Posting No. Series", "Posting Date", true);
                                ModifyHeader := true;
                            end else
                                "Prepmt. Cr. Memo No." := '***';
    ...
    begin
        with GenJnlLine do begin
            ...
            "Journal Template Name" := GenJournalTemplate.Name;
            "Original Pmt. Disc. Possible" := -TotalPrepmtInvLineBuffer."Original Pmt. Disc. Possible";
            "Org. Pmt. Disc. Possible (LCY)" := -TotalPrepmtInvLineBufferLCY."Original Pmt. Disc. Possible";
    ...
    begin
        with PrepmtInvLineBuffer do begin
            ...
            PurchCrMemoLine."Pmt. Discount Amount" := "Original Pmt. Disc. Possible";
