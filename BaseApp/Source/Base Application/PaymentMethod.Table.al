table 289 "Payment Method"
{
    ...
    fields
    {
        ...
        field(12171; "Bill Code"; Code[20])
        {
            ...
            begin
                if "Bal. Account No." <> '' then
                    Error(Text1130000, FieldCaption("Bal. Account No."));
            end;
        }
        field(12172; "Free Type"; Option)
        {
            Caption = 'Free Type';
            OptionCaption = ' ,Total Amt.,Only VAT Amt.';
            OptionMembers = " ","Total Amt.","Only VAT Amt.";
        }
        field(12173; "Intrastat Payment Method"; Code[1])
        {
            Caption = 'Intrastat Payment Method';
        }
        field(12174; "Fattura PA Payment Method"; Code[4])
        {
            Caption = 'Fattura PA Payment Method';
            TableRelation = "Fattura Code".Code WHERE(Type = FILTER("Payment Method"));
        }
    }
    ...
    var
        Text1130000: Label 'Delete %1 first';
