...
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesReceivables/SalesStatistics.rdlc';
        ...
        dataitem(Customer; Customer)
        {
            ...
            begin
                ...
                for i := 1 to 5 do begin
                    ...
                    CustSalesLCY[i] := ReportMgmnt.RoundAmount(CustSalesLCY[i], Rounding);
                    CustProfitLCY[i] := ReportMgmnt.RoundAmount(CustProfitLCY[i], Rounding);
                    CustInvDiscAmountLCY[i] := ReportMgmnt.RoundAmount(CustInvDiscAmountLCY[i], Rounding);
                    CustPaymentDiscLCY[i] := ReportMgmnt.RoundAmount(CustPaymentDiscLCY[i], Rounding);
                    AdjmtCostLCY[i] := ReportMgmnt.RoundAmount(AdjmtCostLCY[i], Rounding);
                    AdjCustProfitLCY[i] := ReportMgmnt.RoundAmount(AdjCustProfitLCY[i], Rounding);
                    CustPaymentDiscTolLCY[i] := ReportMgmnt.RoundAmount(CustPaymentDiscTolLCY[i], Rounding);
                    CustPaymentTolLCY[i] := ReportMgmnt.RoundAmount(CustPaymentTolLCY[i], Rounding);
