    ...
    layout
    {
        area(content)
        {
            ...
            group("Number Series")
            {
...
#if not CLEAN20
                field("Journal Templ. Sales Invoice"; Rec."Journal Templ. Sales Invoice")
                {
...
#if not CLEAN20
                field("Journal Templ. Sales Cr. Memo"; Rec."Journal Templ. Sales Cr. Memo")
                {
                    ApplicationArea = BasicBE;
...
#if not CLEAN20
                field("Jnl. Templ. Prep. S. Inv."; Rec."Jnl. Templ. Prep. S. Inv.")
                {
                    ApplicationArea = BasicBE;
                ...
                field("Jnl. Templ. Prep. S. Cr. Memo"; Rec."Jnl. Templ. Prep. S. Cr. Memo")
                {
                    ApplicationArea = BasicBE;
                ...
                field("IC Jnl. Templ. Sales Invoice"; Rec."IC Jnl. Templ. Sales Invoice")
                {
                    ApplicationArea = BasicBE;
                ...
                field("IC Jnl. Templ. Sales Cr. Memo"; Rec."IC Jnl. Templ. Sales Cr. Memo")
                {
                    ApplicationArea = BasicBE;
