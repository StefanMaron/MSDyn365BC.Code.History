    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Calc. VAT per Line"; Rec."Calc. VAT per Line")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies whether to calculate VAT per line or per total invoice.';
                }
                ...
                field("Allow Alter Posting Groups"; Rec."Allow Alter Posting Groups")
                {
                    ApplicationArea = Basic, Suite;
                    Importance = Additional;
                    ToolTip = 'Specifies if an alternate posting group can be assigned.';
                }
            ...
            group(Dimensions)
            {
                ...
                field("Customer Agreement Dim. Code"; Rec."Customer Agreement Dim. Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the customer agreement dimension code associated with the sales and receivables setup information.';
                }
                field("Synch. Agreement Dimension"; Rec."Synch. Agreement Dimension")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the synchronized agreement dimension code associated with the sales and receivables setup information.';
                }
            }
            group("Number Series")
            {
                ...
                field("Customer Agreement Nos."; Rec."Customer Agreement Nos.")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Posted Corr. Invoice Nos."; Rec."Posted Corr. Invoice Nos.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series from which numbers are assigned to new records.';
                }
                field("Posted Corr. Credit Memo Nos."; Rec."Posted Corr. Credit Memo Nos.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series from which numbers are assigned to new records.';
                }
            ...
            {
                Caption = 'Prepayment';
                field("Use Prepayment Account"; Rec."Use Prepayment Account")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies if you want to post prepayments using the general ledger account.';
                }
                field("Create Prepayment Invoice"; Rec."Create Prepayment Invoice")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies if you want to create an invoice for the prepayment.';
                }
                field("Posted Prepayment Nos."; Rec."Posted Prepayment Nos.")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies the number series from which numbers are assigned to new records.';
                }
                field("Posted PD Doc. Nos."; Rec."Posted PD Doc. Nos.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series from which numbers are assigned to new records.';
                }
                field("PD Doc. Nos. Type"; Rec."PD Doc. Nos. Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if you want to use a number series or symbol to identify prepayment transaction entries.';
                }
                field("Symbol for PD Doc."; Rec."Symbol for PD Doc.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies a symbol that identifies prepayment related entries.';
                }
                field("PD Gains Condition Dim Value"; Rec."PD Gains Condition Dim Value")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the code for the dimension that is used to generate conditional prepayment gains.';
                }
                field("PD Losses Condition Dim Value"; Rec."PD Losses Condition Dim Value")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the code for the dimension that is used to generate conditional prepayment losses.';
                }
                field("PD Gains Kind Dim Value"; Rec."PD Gains Kind Dim Value")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the code for the dimension that is used to generate payment in kind prepayment gains.';
                }
                field("PD Losses Kind Dim Value"; Rec."PD Losses Kind Dim Value")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the code for the dimension that is used to generate payment in kind prepayment losses.';
                }
            }
            group(Application)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the date is used to apply customer payments.';
                }
                field("Check Application Period"; Rec."Check Application Period")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the period is used to apply customer payments.';
                }
            }
            group(Other)
            {
                Caption = 'Other';
                field("Price Decimal Points"; Rec."Price Decimal Points")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of decimal places that will be displayed for price amounts.';
                }
                field("Price (LCY) Decimal Points"; Rec."Price (LCY) Decimal Points")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of decimal points that will be displayed for price amounts in the local currency (LCY).';
                }
                field("Discount Decimal Points"; Rec."Discount Decimal Points")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of decimal points that will be displayed for price discounts.';
                }
                field("Invoice Comment"; Rec."Invoice Comment")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies a comment that is displayed in sales invoices.';
                }
                field("Transfer Posting Description"; Rec."Transfer Posting Description")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the posting description code is transferable.';
                }
            }
            group(Templates)
            {
                Caption = 'Templates';
                field("Job Ticket Template Code"; Rec."Job Ticket Template Code")
                {
                    ApplicationArea = Basic, Suite;
                }
                field("Bill of Lading Template Code"; Rec."Bill of Lading Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Factura Template Code"; Rec."Factura Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("TORG-12 Template Code"; Rec."TORG-12 Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Proforma Template Code"; Rec."Proforma Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Corr. Factura Template Code"; Rec."Corr. Factura Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Sales Shipment M-15 Templ.Code"; Rec."Sales Shipment M-15 Templ.Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
