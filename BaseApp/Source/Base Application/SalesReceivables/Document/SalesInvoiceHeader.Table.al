table 112 "Sales Invoice Header"
{
    ...
    keys
    {
        ...
        key(Key9; "Printed Tax Document", "Bill-to Customer No.", "Currency Code", "Payment Discount %", "Posted Tax Document", "Tax Document Marked")
        {
        }
        key(Key10; "Tax Document Type", "Bill-to Customer No.", "Currency Code", "Payment Discount %", "Printed Tax Document", "Posted Tax Document")
        {
        }
        key(Key11; "Tax Document Marked")
        {
        }
        key(Key12; "Posting Date")
        {
        }
        key(Key13; "Document Exchange Status")
        {
        }
        key(Key14; "Due Date")
        {
