page 648 "Handled IC Inbox Sales Doc."
{
    Caption = 'Handled IC Inbox Sales Doc.';
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = Document;
    SourceTable = "Handled IC Inbox Sales Header";
    ...
    layout
    {
        area(content)
        {
            ...
            part(ICInboxSalesLines; "Handled IC Inbox Sales Lines")
            {
                ApplicationArea = Intercompany;
