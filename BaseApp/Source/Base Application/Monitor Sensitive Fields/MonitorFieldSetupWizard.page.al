            ...
            group(ChooseUser)
            {
                ...
                group("Choose User Description")
                {
                    ...
                    group("Permission Warning")
                    {
                        ...
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'The selected user can receive email notifications about changes to field values. To allow the user to address changes you must assign them either to the D365 Security user group or the D365 Monitor Fields permission set.',
