...
codeunit 3676 "BOM Tree Node Dictionary Impl."
{
    ...
    protected procedure GetBucket(RequestedBucketId: Integer; var Bucket: Codeunit "BOM Tree Nodes Bucket"; CreateBuckets: Boolean)
    var
    ...
    protected procedure IndexOf(UniqueKey: Text): Integer
    begin
        if LastIndex = 0 then
            exit(0);
