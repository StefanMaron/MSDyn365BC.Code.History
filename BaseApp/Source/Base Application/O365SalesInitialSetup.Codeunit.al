codeunit 2110 "O365 Sales Initial Setup"
{
    ...
    begin
        ...
        if CompanyInformation.Get then begin
            CompanyInformation.InferIsCanadaFromCurrency;
    ...
    local procedure GetUSTaxDefaults(var TaxAreaCode: Code[20])
    var
