...
page 6421 "FS Connection Setup Wizard"
{
            ...
            group(Step2)
            {
                ...
                group("Advanced Settings")
                {
                    ...
                    field(ImportFSSolution; ImportSolution)
                    {
                        ...
                        ToolTip = 'Specifies that the solution required for integration with Dynamics 365 Sales Field Service will be imported.';
                    }
