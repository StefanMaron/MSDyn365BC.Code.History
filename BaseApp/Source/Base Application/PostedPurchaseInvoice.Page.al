page 138 "Posted Purchase Invoice"
{
    ...
    SourceTableView = WHERE("Empl. Purchase" = FILTER(false));
    ...
    layout
    {
        area(content)
        {
            ...
            group("Shipping and Payment")
            {
                ...
                field("Vendor Receipts No."; Rec."Vendor Receipts No.")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    ToolTip = 'Specifies the vendor receipts number associated with this header.';
                }
                field("Vendor Receipts Date"; Rec."Vendor Receipts Date")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    ToolTip = 'Specifies the vendor receipts date associated with this header.';
                }
                group("Pay-to")
                {
                    Caption = 'Pay-to';
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the vendor VAT invoice number associated with this header.';
                }
                field("Vendor VAT Invoice Date"; Rec."Vendor VAT Invoice Date")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the vendor VAT invoice date associated with this header.';
                }
                field("Vendor VAT Invoice Rcvd Date"; Rec."Vendor VAT Invoice Rcvd Date")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the date that the vendor VAT invoice, which is associated with this header, was received.';
                }
                group("Remit-to")
                {
        ...
        area(navigation)
        {
            group("&Invoice")
            {
                ...
                action("Employee Si&gnatures")
                {
                    ...
                    RunPageLink = "Table ID" = CONST(122),
                                  "Document No." = FIELD("No.");
                }
                ...
                action(Receipts)
                {
                    ...
                    ToolTip = 'View the related posted purchase receipts.';
