...
codeunit 226 "CustEntry-Apply Posted Entries"
{
    ...
    begin
        ...
        // NAVCZ
        GenJnlLine.Prepayment := CustLedgEntry.Prepayment;
        GenJnlLine."Prepayment Type" := CustLedgEntry."Prepayment Type";
        // NAVCZ
    ...
    begin
        ...
        // NAVCZ
        if DtldCustLedgEntry."Applied Cust. Ledger Entry No." <> DtldCustLedgEntry."Cust. Ledger Entry No." then
            DtldCustLedgEntry.Get(FindLastApplEntry(DtldCustLedgEntry."Applied Cust. Ledger Entry No."));
        // NAVCZ
        DtldCustLedgEntry.TestField("Entry Type", DtldCustLedgEntry."Entry Type"::Application);
        DtldCustLedgEntry.TestField(Unapplied, false);
