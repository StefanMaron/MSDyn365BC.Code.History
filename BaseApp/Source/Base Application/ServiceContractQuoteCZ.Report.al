#if not CLEAN17
report 31112 "Service Contract Quote CZ"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ServiceContractQuoteCZ.rdlc';
    Caption = 'Service Contract Quote CZ (Obsolete)';
    ...
    begin
        LogInteraction := SegMgt.FindInteractTmplCode(24) <> '';
    end;
