...
{
    Caption = 'Posted Ship. Item Waybill 1-T';
    ProcessingOnly = true;
    ...
    local procedure CheckPrintOneDocument(var SalesHeader: Record "Sales Shipment Header")
    var
        SalesHeader2: Record "Sales Shipment Header";
    begin
    ...
    local procedure TransferLineValues(var LineValues: array[9] of Text; SalesLine: Record "Sales Shipment Line")
    begin
