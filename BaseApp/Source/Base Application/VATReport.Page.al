        ...
        area(content)
        {
            group(General)
            {
                ...
                field(BASIdNoCtrl; "BAS ID No.")
                {
                    ...
                    begin
                        ...
                        if PAGE.RunModal(0, BASCalculationSheet, BASCalculationSheet.A1) = ACTION::LookupOK then begin
                            ...
                            "Start Date" := BASCalculationSheet.A3;
                            "End Date" := BASCalculationSheet.A4;
                        end;
                    end;
                }
                field(BASVersionNoCtrl; "BAS Version No.")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'BAS Version';
                    Importance = Additional;
                    ...
                    var
                        BASCalculationSheet: Record "BAS Calculation Sheet";
                    begin
                        BASCalculationSheet.SetRange(A1, "BAS ID No.");
                ...
                group(Control23)
                {
                    ...
                    field("Settlement Posted"; "Settlement Posted")
                    {
                        ApplicationArea = Basic, Suite;
                        ToolTip = 'Specifies whether a settlement has been posted for this report.';
                    }
                    field("Include Prev. Open Entries"; "Include Prev. Open Entries")
                    {
                        ApplicationArea = Basic, Suite;
