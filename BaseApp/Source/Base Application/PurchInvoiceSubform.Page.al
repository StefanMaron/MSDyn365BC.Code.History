    ...
    layout
    {
        area(content)
        {
            repeater(PurchDetailLine)
            {
                ...
                {
                    ToolTip = 'Specifies if the purchase line contains a surplus.';
                    Visible = false;
                }
                ...
                field("FA Charge No."; Rec."FA Charge No.")
                {
                    ToolTip = 'Specifies the fixed asset charge number associated with the purchase line.';
                    Visible = false;
                }
                field("Tax Difference Code"; Rec."Tax Difference Code")
                {
                    ToolTip = 'Specifies the tax difference code associated with the purchase line.';
                    Visible = false;
                }
