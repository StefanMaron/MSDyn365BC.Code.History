    ...
    layout
    {
        area(content)
        {
            repeater(PurchDetailLine)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the WHT Business Posting Group is assigned from the Purchase Header Table and is used for all the WHT calculations.';
                    Visible = false;
                }
                field("WHT Product Posting Group"; "WHT Product Posting Group")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the WHT Product Posting Group is assigned from the Product Entity selected in Purchase Line.';
                    Visible = false;
                }
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Amount when you want WHT to be calculated on the Amount other than the Line Amount.';
                }
