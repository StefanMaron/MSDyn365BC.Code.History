...
#pragma warning restore AS0086
    ...
    begin
        ...
        if Type = Type::Person then begin
            Vend.Validate(Resident, Vend.Resident::"Non-Resident");
            Vend.Validate("Individual Person", true);
            Vend.Validate("First Name", "First Name");
            Vend.Validate("Last Name", Surname);
            Vend.Modify();
        end;
    ...
    procedure GetTDDAddr(ContactNo: Code[20]; var AddrArray: array[8] of Text[100])
    var
        FormatAddr: Codeunit "Format Address";
    begin
        if Get(ContactNo) then begin
