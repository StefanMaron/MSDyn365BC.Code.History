...
#pragma warning restore AS0086
    ...
    begin
        UpdateNeeded :=
          ...
          ("IRD No." <> ContactBeforeModify."IRD No.") or
          (ABN <> ContactBeforeModify.ABN) or
          ("ABN Division Part No." <> ContactBeforeModify."ABN Division Part No.") or
          (Registered <> ContactBeforeModify.Registered);
