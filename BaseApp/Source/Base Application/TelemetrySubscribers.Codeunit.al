codeunit 1351 "Telemetry Subscribers"
{
    ...
    var
        ...
        PostedDepositLinesTxt: Label 'Number of posted deposit lines: %1', Locked = true;	
    ...
    [EventSubscriber(ObjectType::Codeunit, 10140, 'OnAfterDepositPost', '', true, true)]
    ...
    begin
        ...
        SendTraceTag('0000AHQ', RecordCountCategoryTxt, VERBOSITY::Normal,
            StrSubstNo(PostedDepositLinesTxt, PostedDepositLine.Count), DATACLASSIFICATION::SystemMetadata);
    end;
