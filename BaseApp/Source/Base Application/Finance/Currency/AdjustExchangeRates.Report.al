...
report 595 "Adjust Exchange Rates"
{
    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            ...
            dataitem(Currency; Currency)
            {
                ...
                begin
                    if (Code = '') and AdjCustVendBank and (not AdjEmpl) then
                        Error(Text011Err);
                end;
    ...
    requestpage
    {
        ...
        begin
            ...
            if not (AdjCustVendBank or AdjGLAcc or AdjEmpl) then begin
    ...
    begin
        ...
        if not AdjCustVendBank and AdjGLAcc and (not AdjEmpl) then
