...
codeunit 579 "Run Template Retained Earn."
{
    ...
    var
        ...
        ServiceNameParmLbl: Label 'ExcelTemplateRetainedEarnings', Locked = true;
    ...
    begin
        TelemetryDimensions.Add('CodeunitId', Format(Codeunit::"Run Template Retained Earn.", 0, 9));
        TelemetryDimensions.Add('ExcelTemplateName', ServiceNameParmLbl);
        FeatureTelemetry.LogUsage('0000ONW', 'Excel Template', 'Run Retained Earnings Excel Report', TelemetryDimensions);
    end;
}
