...
/// <summary>
/// List part page for displaying handled intercompany inbox sales document lines.
/// Shows detailed line information including items, quantities, prices, and dimensions for processed sales transactions.
/// </summary>
