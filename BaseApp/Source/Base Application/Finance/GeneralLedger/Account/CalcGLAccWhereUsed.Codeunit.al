        ...
        case GLAccWhereUsed."Table ID" of
            ...
            Database::"Bill Posting Group":
                begin
                    ...
                    BillPostingGroup."Payment Method" := CopyStr(GLAccWhereUsed."Key 2", 1, MaxStrLen(BillPostingGroup."Payment Method"));
                    PAGE.Run(PAGE::"Bill Posting Group", BillPostingGroup);
                end;
            Database::Bill:
                begin
                    Bill.Code := CopyStr(GLAccWhereUsed."Key 1", 1, MaxStrLen(Bill.Code));
                    PAGE.Run(0, Bill);
                end;
            else
