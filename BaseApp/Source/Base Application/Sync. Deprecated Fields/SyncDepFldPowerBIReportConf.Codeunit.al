codeunit 9315 "Sync.Dep.Fld-PowerBIReportConf"
{
    ...
    [EventSubscriber(ObjectType::Table, Database::"Power BI Report Configuration", 'OnAfterValidateEvent', 'EmbedUrl', false, false)]
    local procedure SyncOnAfterValidateEmbedUrlInPBIReportBuffer(var Rec: Record "Power BI Report Configuration"; var xRec: Record "Power BI Report Configuration"; CurrFieldNo: Integer)
    var
    ...
    [EventSubscriber(ObjectType::Table, Database::"Power BI Report Configuration", 'OnAfterValidateEvent', 'ReportEmbedUrl', false, false)]
    local procedure SyncOnAfterValidateReportEmbedUrlInPBIReportBuffer(var Rec: Record "Power BI Report Configuration"; var xRec: Record "Power BI Report Configuration"; CurrFieldNo: Integer)
    var
        SyncLoopingHelper: Codeunit "Sync. Looping Helper";
    begin
    ...
    [EventSubscriber(ObjectType::Table, Database::"Power BI Report Configuration", 'OnBeforeInsertEvent', '', false, false)]
    local procedure SyncOnBeforeInsertPBIReportBuffer(RunTrigger: Boolean; var Rec: Record "Power BI Report Configuration")
    var
    ...
    [EventSubscriber(ObjectType::Table, Database::"Power BI Report Configuration", 'OnBeforeModifyEvent', '', false, false)]
    local procedure SyncOnBeforeModifyPBIReportBuffer(RunTrigger: Boolean; var Rec: Record "Power BI Report Configuration"; var xRec: Record "Power BI Report Configuration")
    var
        PreviousPowerBiReportConfiguration: Record "Power BI Report Configuration";
        SyncDepFldPowerBIUrlUtils: codeunit "Sync.Dep.Fld-PowerBIUrlUtils";
        SyncDepFldUtilities: codeunit "Sync.Dep.Fld-Utilities";
        PreviousRecordRef: RecordRef;
    begin
        if SyncDepFldUtilities.GetPreviousRecord(Rec, PreviousRecordRef) then begin
            PreviousRecordRef.SetTable(PreviousPowerBiReportConfiguration);
            SyncDepFldPowerBIUrlUtils.SyncUrlFields(Rec.EmbedUrl, Rec.ReportEmbedUrl, PreviousPowerBiReportConfiguration.EmbedUrl, PreviousPowerBiReportConfiguration.ReportEmbedUrl);
        end else
    ...
    begin
        SyncLoopingHelper.SkipFieldSynchronization(SyncLoopingHelper, Database::"Power BI Report Configuration", FieldNo);
    end;

    local procedure RestoreFieldSynchronization(var SyncLoopingHelper: Codeunit "Sync. Looping Helper"; FieldNo: Integer)
    begin
        SyncLoopingHelper.RestoreFieldSynchronization(Database::"Power BI Report Configuration", FieldNo);
    end;
