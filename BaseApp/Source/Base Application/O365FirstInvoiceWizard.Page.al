page 2142 "O365 First Invoice Wizard"
{
        ...
        area(content)
        {
            ...
            group(TaxStep)
            {
                ...
                group("Need to add sales tax?")
                {
                    ...
                    {
                        InstructionalText = 'Tell us your region.';
                        ShowCaption = false;
    ...
    var
        ...
        IsCanada: Boolean;
        TaxAreaCodeCA: Code[20];
        DefaultCityTxt: Label 'Default';
        DefaultStateTxt: Label 'NN';
    ...
    local procedure SetDefaultTaxAreaCodeForCA()
    var
        TaxArea: Record "Tax Area";
        CompanyInformation: Record "Company Information";
    begin
    ...
    var
        ...
        TaxAreaCode: Code[20];
        TaxJurisdictionCityCode: Code[10];
        TaxJurisdictionStateCode: Code[10];
    begin
    ...
    local procedure StoreSalesTaxSetupForCA()
    var
        TaxGroup: Record "Tax Group";
        TaxArea: Record "Tax Area";
        ConfigTemplateManagement: Codeunit "Config. Template Management";
