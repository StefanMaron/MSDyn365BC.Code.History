table 5767 "Warehouse Activity Line"
{
    ...
    begin
        ...
        "CD No." := PostedWhseRcptLine."CD No.";
    ...
    begin
        ...
        if "CD No." <> '' then begin
            if WhseItemTrackingSetup."CD No. Required" then
                ...
                Item.SetFilter("CD No. Filter", '%1|%2', "CD No.", '')
        end else
    ...
    begin
        ...
        if "CD No." <> '' then
            if WhseItemTrackingSetup."CD No. Required" then
                ...
                ItemLedgEntry.SetFilter("CD No.", '%1|%2', "CD No.", '');
    end;
    ...
    begin
        ...
        if "CD No." <> '' then
            if WhseItemTrackingSetup."CD No. Required" then
                WhseEntry.SetRange("CD No.", "CD No.")
            else
                WhseEntry.SetFilter("CD No.", '%1|%2', "CD No.", '');
    end;
    ...
    begin
        ...
        GetItem();
        ItemTrackingMgt.GetWhseItemTrkgSetup("Item No.", WhseItemTrackingSetup);
        ItemTrackingMgt.GetItemTrackingSetup(ItemTrackingCode, CDTrackingSetup, ItemJournalLine."Entry Type", false, ItemTrackingSetup);
