codeunit 8 AccSchedManagement
{
    ...
    begin
        ...
        OnAfterFormatCellAsText(ColumnLayout2, ValueAsText, NegativeAmounts);
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterFormatCellAsText(var ColumnLayout2: Record "Column Layout"; var ValueAsText: Text[30]; NegativeAmounts: Option)
    begin
    end;
