codeunit 6516 "Package Management"
{
    ...
    local procedure WhseActivityLineOnLookUpTrackingSummaryOnAfterAssignLotNoTracking(var WarehouseActivityLine: Record "Warehouse Activity Line"; TempTrackingSpecification: Record "Tracking Specification")
    begin
        WarehouseActivityLine.Validate("Package No.", TempTrackingSpecification."Package No.");
    end;
