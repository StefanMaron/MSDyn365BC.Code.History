codeunit 5611 "Calculate Normal Depreciation"
{
    ...
    begin
        with FA do begin
            if DateFromProjection > 0D then
                ...
                FirstDeprDate := DepreciationCalc.GetFirstDeprDate("No.", DeprBookCode, Year365Days, DeprBook."Use Accounting Period");
            ...
            // Method Last Depreciation Entry
                ...
                DepreciationCalc.GetDeprPeriod(
                  "No.", DeprBookCode, UntilDate, StartingDate, EndingDate, NumberOfDays, Year365Days, DeprBook."Use Accounting Period");
    ...
    begin
        with FADeprBook do begin
            ...
            if "Depreciation Ending Date" > 0D then begin
                ...
                DeprYears :=
                  DepreciationCalc.DeprDays(
                    "Depreciation Starting Date", "Depreciation Ending Date", false, DeprBook."Use Accounting Period") / 360;
            end;
            ...
            if Year365Days then begin
                ...
                DeprYears :=
                  DepreciationCalc.DeprDays(
                    "Depreciation Starting Date", "Depreciation Ending Date", true, false) / DaysInFiscalYear;
            end;
        end;
    ...
    begin
        ...
        if DeprInTwoFiscalYears then
            NumberOfDays :=
              DepreciationCalc.DeprDays(
                FirstDeprDate, DepreciationCalc.Yesterday(NewYearDate, Year365Days, DeprBook."Use Accounting Period"),
                Year365Days, DeprBook."Use Accounting Period");
        if FixedAmount > 0 then
