table 5600 "Fixed Asset"
{
    ...
    fields
    {
        ...
        field(12100; "Source FA No."; Code[20])
        {
            Caption = 'Source FA No.';
            TableRelation = "Fixed Asset";
        }
        field(12102; "Acquisition Year"; Integer)
        {
            Caption = 'Acquisition Year';
        }
    }
    ...
    keys
    {
        ...
        key(Key11; "Acquisition Year", "FA Class Code", "FA Subclass Code")
        {
        }
    }
