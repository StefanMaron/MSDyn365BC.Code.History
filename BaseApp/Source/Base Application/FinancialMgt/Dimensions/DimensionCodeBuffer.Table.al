...
table 367 "Dimension Code Buffer"
{
    ...
    fields
    {
        ...
        field(12410; "Credit Dim. 1 Value Filter"; Code[20])
        {
            Caption = 'Credit Dim. 1 Value Filter';
            FieldClass = FlowFilter;
        }
        field(12411; "Credit Dim. 2 Value Filter"; Code[20])
        {
            Caption = 'Credit Dim. 2 Value Filter';
            FieldClass = FlowFilter;
        }
        field(12412; "Credit Dim. 3 Value Filter"; Code[20])
        {
            Caption = 'Credit Dim. 3 Value Filter';
            FieldClass = FlowFilter;
        }
    }
