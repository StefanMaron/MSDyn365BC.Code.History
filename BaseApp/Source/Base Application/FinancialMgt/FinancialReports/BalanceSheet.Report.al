...
{
    DefaultLayout = RDLC;
    RDLCLayout = './FinancialMgt/FinancialReports/Balancesheet.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Balance Sheet';
    UsageCategory = ReportsAndAnalysis;
    ObsoleteReason = 'SE Balance sheet is moved to SE Core extensions, Balance sheet will be replaced by W1 Financial Report';
