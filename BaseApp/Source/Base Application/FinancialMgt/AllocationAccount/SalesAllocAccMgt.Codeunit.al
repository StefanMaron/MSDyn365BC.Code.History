...
codeunit 2678 "Sales Alloc. Acc. Mgt."
{
    ...
    begin
        ...
        if SalesLine."Alloc. Acc. Modified by User" then
            ...
            AllocationAccountMgt.GenerateAllocationLines(AllocationAccount, AllocationLine, SalesLine.Amount, SalesLine."Posting Date", SalesLine."Dimension Set ID", SalesLine."Currency Code");
