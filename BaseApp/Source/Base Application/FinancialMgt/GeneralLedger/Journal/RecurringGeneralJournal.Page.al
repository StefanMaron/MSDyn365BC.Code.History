...
page 283 "Recurring General Journal"
{
            ...
            repeater(Control1)
            {
                ...
                field(AccSchedLineDesc; AccSchedLineDesc)
                {
                    ...
                    begin
                        ...
                        AccScheduleLine.SetRange("Schedule Name", Rec."Acc. Schedule Name");
                        AccScheduleLine.FilterGroup(0);
                        AccScheduleLines.SetTableView(AccScheduleLine);
                        if Rec."Acc. Schedule Line No." <> 0 then
                            if AccScheduleLine.Get(Rec."Acc. Schedule Name", Rec."Acc. Schedule Line No.") then
                        ...
                        if AccScheduleLines.RunModal() = ACTION::LookupOK then begin
                            ...
                            Rec."Acc. Schedule Line No." := AccScheduleLine."Line No.";
                ...
                field(ColumnLayoutHeader; ColumnLayoutHeader)
                {
                    ...
                    begin
                        ...
                        ColumnLayout.SetRange("Column Layout Name", Rec."Column Layout Name");
                        ColumnLayout.FilterGroup(0);
                        ColumnLayouts.SetTableView(ColumnLayout);
                        if Rec."Column Layout Line No." <> 0 then
                            if ColumnLayout.Get(Rec."Column Layout Name", Rec."Column Layout Line No.") then
                        ...
                        if ColumnLayouts.RunModal() = ACTION::LookupOK then begin
                            ...
                            Rec."Column Layout Line No." := ColumnLayout."Line No.";
    ...
    begin
        AccSchedLineDesc := '';
        ColumnLayoutHeader := '';
        if (Rec."Acc. Schedule Name" <> '') and (Rec."Acc. Schedule Line No." <> 0) then
            if AccScheduleLine.Get(Rec."Acc. Schedule Name", Rec."Acc. Schedule Line No.") then
                AccSchedLineDesc := AccScheduleLine.Description;

        if (Rec."Column Layout Name" <> '') and (Rec."Column Layout Line No." <> 0) then
            if ColumnLayout.Get(Rec."Column Layout Name", Rec."Column Layout Line No.") then
                ColumnLayoutHeader := ColumnLayout."Column Header";
    end;
