table 179 "Reversal Entry"
{
    ...
    procedure CopyReverseFilters2(var ValueEntry2: Record "Value Entry"; var TaxDiffLedgEntry2: Record "Tax Diff. Ledger Entry")
    begin
        ...
        case "Entry Type" of
            ...
            "Entry Type"::"Tax Difference":
                begin
                    ...
                    exit(StrSubstNo(CaptionTxt, TaxDiff.TableCaption(), TaxDiff.Code, TaxDiff.Description));
                end;
            else begin
