table 179 "Reversal Entry"
{
    ...
    begin
        ...
        CheckPostingDate(
          ...
          EmployeeLedgerEntry2."Journal Templ. Name");
    ...
    local procedure CheckPostingDate(PostingDate: Date; Caption: Text; EntryNo: Integer; JnlTemplName: Code[10])
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
        OnBeforeCheckPostingDate(PostingDate, CopyStr(Caption, 1, 50), EntryNo, JnlTemplName, IsHandled, Rec, MaxPostingDate);
        if IsHandled then
            exit;
