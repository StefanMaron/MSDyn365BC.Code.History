table 461 "Prepayment Inv. Line Buffer"
{
    ...
    keys
    {
        key(Key1; "G/L Account No.", "Job No.", "Tax Area Code", "Tax Liable", "Tax Group Code", "Invoice Rounding", Adjustment, "Line No.", "Dimension Set ID", "Prepmt. CM Refers to Period")
        {
            Clustered = true;
        }
        key(Key2; Adjustment)
