report 1 "Chart of Accounts"
{
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            column(G_L_Account___Income_Stmt__Bal__Acc__Caption; FieldCaption("Income Stmt. Bal. Acc."))
            {
            }
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(G_L_Account___Income_Stmt__Bal__Acc__; "G/L Account"."Income Stmt. Bal. Acc.")
                {
                }
            }
