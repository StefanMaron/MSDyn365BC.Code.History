    ...
    begin
        if WhseShip and (WhseShptHeader2."Document Status" = WhseShptHeader2."Document Status"::"Partially Picked") then
            ...
            ReserveTransLine.TransferTransferToItemJnlLine(
              TransferLine, ItemJnlLine, ItemJnlLine."Quantity (Base)", 0, false);
    end;
                ...
                repeat
                    if WhsePosting or WhseShip or InvtPickPutaway then begin
                        ItemTrackingMgt.CheckWhseItemTrkgSetup(
                          TransShptLine."Item No.", TempHandlingSpecification2."Location Code",
                          WhseSNRequired, WhseLNRequired, WhseCDRequired, false);
                        if WhseSNRequired or WhseLNRequired or WhseCDRequired then begin
