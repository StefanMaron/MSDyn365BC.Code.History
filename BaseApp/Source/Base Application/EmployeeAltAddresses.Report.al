report 5213 "Employee - Alt. Addresses"
{
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            column(Employee_County; County)
            {
            }
            column(Employee__Country_Region_Code_; "Country/Region Code")
            {
            }
            ...
            column(Employee_CountyCaption; FieldCaption(County))
            {
            }
            column(Employee__Country_Region_Code_Caption; FieldCaption("Country/Region Code"))
            {
            }
