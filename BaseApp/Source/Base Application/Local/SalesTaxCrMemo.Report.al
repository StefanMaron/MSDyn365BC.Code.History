...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Local/SalesTaxCrMemo.rdlc';
        ...
        dataitem("Sales Tax Cr.Memo Header"; "Sales Tax Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    {
                        DataItemTableView = SORTING(Number);
                        column(VATAmtLineAmountPaidVATAmtLineVATRealized; TempVATAmountLine."Amount Paid" - TempVATAmountLine."VAT Realized")
                        {
                            AutoFormatExpression = "Sales Tax Cr.Memo Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmtLineVATRealized; TempVATAmountLine."VAT Realized")
                        {
                            AutoFormatExpression = "Sales Tax Cr.Memo Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmtLineInvoiceDiscountAmount; TempVATAmountLine."Invoice Discount Amount")
                        {
                            AutoFormatExpression = "Sales Tax Cr.Memo Header"."Currency Code";
                            AutoFormatType = 1;
                        }
