    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                Editable = false;
                ShowCaption = false;
                field("ReturnTemplateName[Number]"; ReturnTemplateName[Number])
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Journal, template name';
                    ToolTip = 'Specifies the journal template that is used for posting.';
                }
                field("ReturnJournalName[Number]"; ReturnJournalName[Number])
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Journal name';
                    ToolTip = 'Specifies the journal that is used for posting.';
                }
                field("ReturnNumber[Number]"; ReturnNumber[Number])
                {
                    ApplicationArea = Basic, Suite;
