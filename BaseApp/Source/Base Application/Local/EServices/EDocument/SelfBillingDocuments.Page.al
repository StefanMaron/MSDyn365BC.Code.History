    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1130001)
            {
                ...
                field("Fattura Vendor No."; Rec."Fattura Vendor No.")
                {
                    ApplicationArea = Basic, Suite;
                    ...
                    trigger OnValidate()
                    begin
                        FatturaDocHelper.SetFatturaVendorNoInVATEntry(Rec."Entry No.", Rec."Fattura Vendor No.");
                    end;
                }
                ...
                field("Fattura Document Type"; Rec."Fattura Document Type")
                {
                    ...
                    trigger OnValidate()
                    begin
                        FatturaDocHelper.UpdateFatturaDocTypeInVATEntry(Rec."Entry No.", Rec."Fattura Document Type");
                    end;
                }
                field("Fattura File Exported"; Rec."Fattura File Exported")
                {
                    ApplicationArea = Basic, Suite;
