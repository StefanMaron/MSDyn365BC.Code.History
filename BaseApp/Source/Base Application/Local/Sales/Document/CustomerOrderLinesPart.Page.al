...
page 10012 "Customer Order Lines Part"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("On Hold"; SalesHeader."On Hold")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'On Hold';
            ...
            Rec."Document Type"::"Return Order":
                begin
                    ...
                    if GetLastCrMemo() then
                        LastInvoiceDate := SalesCrMemoHeader."Posting Date"
                    else
                        LastInvoiceDate := 0D;
                end;
            else begin
    ...
    begin
        if (SalesHeader."Document Type" <> Rec."Document Type") or (SalesHeader."No." <> Rec."Document No.") then
            if not SalesHeader.Get(Rec."Document Type", Rec."Document No.") then
                Message(OrphanSalesLinesWarningTxt, Rec."Document Type", Rec."Document No.");
    end;
    ...
    begin
        ...
        ReturnReceiptHeader.SetRange("Return Order No.", Rec."Document No.");
    ...
    begin
        ...
        SalesCrMemoHeader.SetRange("Return Order No.", Rec."Document No.");
