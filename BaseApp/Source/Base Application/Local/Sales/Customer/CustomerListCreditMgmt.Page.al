    ...
    actions
    {
        ...
        area(Promoted)
        {
            ...
            group(Category_Process)
            {
                ...
                actionref("Statistics by C&urrencies_Promoted"; "Statistics by C&urrencies")
                {
                }
                ...
                actionref("Issued &Reminders_Promoted"; "Issued &Reminders")
                {
                }
                actionref("Issued &Finance Charge Memos_Promoted"; "Issued &Finance Charge Memos")
                {
                }
            }
        }
