...
{
    Caption = 'File Non Euro SEPA pain.001.001.09 Payments';
    ProcessingOnly = true;
    UseRequestPage = true;
    ...
    begin
        FeatureTelemetry.LogUptake('0000N25', SEPACTExportFile.FeatureName(), Enum::"Feature Uptake Status"::Used);
        FeatureTelemetry.LogUsage('0000N26', SEPACTExportFile.FeatureName(), 'Report (BE) File Non Euro SEPA pain.001.001.09 Payments');
