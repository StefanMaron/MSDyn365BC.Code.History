report 10118 "Vendor 1099 Div 2021"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Local/Vendor1099Div2021.rdlc';
            ...
            begin
                ...
                if TestPrintSwitch then begin
                    ...
                    for i := 1 to LastLineNo do
                        if IRS1099FormBox.Get(Codes[i]) then
                            if IRS1099FormBox."Minimum Reportable" < 0.0 then begin
    ...
    begin
        IRS1099Management.ThrowErrorfUpgrade2021Needed();
    end;
