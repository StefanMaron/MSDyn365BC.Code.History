...
report 13413 "Exp. SEPA CT pain.001.001.09"
{
    ...
    begin
        FeatureTelemetry.LogUptake('0000N29', SEPACTExportFile.FeatureName(), Enum::"Feature Uptake Status"::Used);
        FeatureTelemetry.LogUsage('0000N2A', SEPACTExportFile.FeatureName(), 'Report (FI) Exp. SEPA CT pain.001.001.09');
