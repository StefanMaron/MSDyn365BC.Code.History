...
codeunit 11000010 "Check SEPA ISO20022"
{
    ...
    begin
        ...
        if (ProposalLine."SWIFT Code" <> '') and (StrLen(ProposalLine."SWIFT Code") > 11) then begin
...
#if not CLEAN29
[Obsolete('SWIFT Code validation removed as SEPA supports IBAN-only payments.', '29.0')]
