...
{
    DefaultLayout = RDLC;
    RDLCLayout = './BlanketPurchaseOrderGB.rdlc';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocumentCaption; StrSubstNo(Text002, CopyText))
                    {
                    }
    ...
    var
        ...
        Text001: Label ' COPY';
        Text002: Label 'Blanket Purchase Order%1';
        ...
        Continue: Boolean;
        Text1040002: Label '%1 %, VAT discounted at %2 % ';
