...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Local/MonthlyVATDeclaration.rdlc';
    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            ...
            {
                DataItemTableView = SORTING(Type, "Country/Region Code", "VAT Registration No.", "VAT Bus. Posting Group", "VAT Prod. Posting Group", "Posting Date") ORDER(Ascending) WHERE(Amount = FILTER(<> 0));
