    ...
    layout
    {
        area(content)
        {
            ...
            group(Personal)
            {
                ...
                {
                    ApplicationArea = BasicHR;
                    ToolTip = 'Specifies the place of birth of the employee.';
                }
                field("Birth Place Code"; "Birth Place Code")
                {
                    ApplicationArea = BasicHR;
                    ToolTip = 'Specifies the identification code for the place of birth of the employee.';
                }
