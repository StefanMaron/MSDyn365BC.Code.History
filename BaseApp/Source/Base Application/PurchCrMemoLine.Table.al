table 125 "Purch. Cr. Memo Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Type';
            OptionCaption = ' ,G/L Account,Item,,Fixed Asset,Charge (Item),Empl. Purchase';
            OptionMembers = " ","G/L Account",Item,,"Fixed Asset","Charge (Item)","Empl. Purchase";
        }
        field(6; "No."; Code[20])
        {
        ...
        field(12490; "Agreement No."; Code[20])
        {
            ...
            Editable = false;
            TableRelation = "Vendor Agreement"."No." WHERE("Vendor No." = FIELD("Buy-from Vendor No."));
        }
