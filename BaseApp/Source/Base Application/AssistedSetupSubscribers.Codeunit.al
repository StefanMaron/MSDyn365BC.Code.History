codeunit 1814 "Assisted Setup Subscribers"
{
    ...
    begin
        ...
        AssistedSetup.Add(GetAppId(), PAGE::"Sales Tax Setup Wizard", SalesTaxSetupTxt, AssistedSetupGroup::Extensions, VideoUrlSalesTaxSetupTxt, HelpSetupSalesTaxTxt);
        GLOBALLANGUAGE(1033);
        AssistedSetup.AddTranslation(GetAppId(), PAGE::"VAT Setup Wizard", 1033, SalesTaxSetupTxt);
        GLOBALLANGUAGE(CurrentGlobalLanguage);
        ...
        if not EnvironmentInfo.IsSaaS then begin
            AssistedSetup.Add(GetAppId(), PAGE::"Mexican CFDI Wizard", SetupMexicanCFDITxt, AssistedSetupGroup::Extensions);
            GLOBALLANGUAGE(1033);
            AssistedSetup.AddTranslation(GetAppId(), PAGE::"Mexican CFDI Wizard", 1033, SetupMexicanCFDITxt);
            GLOBALLANGUAGE(CurrentGlobalLanguage);
        end;
        UpdateStatus;
    end;
    ...
    begin
        ...
        AssistedSetup.Complete(GetAppId(), PAGE::"Sales Tax Setup Wizard");
    end;
