table 5802 "Value Entry"
{
    ...
    keys
    {
        ...
        key(Key17; "Item Ledger Entry No.", "Posting Date")
        {
        }
        key(Key18; "Item Ledger Entry Type", "Order No.", "Valuation Date")
        {
        }
        key(Key19; "Item No.", "Item Ledger Entry Type", "Order Type", "Order No.", "Order Line No.")
        {
        }
    }
