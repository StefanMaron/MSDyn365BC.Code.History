...
codeunit 227 "VendEntry-Apply Posted Entries"
{
    ...
    begin
        ...
        // NAVCZ
        GenJnlLine.Prepayment := VendLedgEntry.Prepayment;
    ...
    begin
        ...
        // NAVCZ
        if DtldVendLedgEntry."Applied Vend. Ledger Entry No." <> DtldVendLedgEntry."Vendor Ledger Entry No." then
            DtldVendLedgEntry.Get(FindLastApplEntry(DtldVendLedgEntry."Applied Vend. Ledger Entry No."));
        // NAVCZ
        DtldVendLedgEntry.TestField("Entry Type", DtldVendLedgEntry."Entry Type"::Application);
        DtldVendLedgEntry.TestField(Unapplied, false);
