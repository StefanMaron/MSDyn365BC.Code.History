page 17484 "Payroll Doc. Line AE Periods"
{
    Caption = 'Payroll Doc. Line AE Periods';
    Editable = false;
    PageType = Card;
    SourceTable = "Payroll Period AE";
    ...
    [Scope('OnPrem')]
    procedure SetDocLine(NewDocLine: Record "Payroll Document Line")
    begin
