codeunit 99000836 "Transfer Line-Reserve"
{
    ...
    procedure CreateReservation(var TransLine: Record "Transfer Line"; Description: Text[100]; ExpectedReceiptDate: Date; Quantity: Decimal; QuantityBase: Decimal; ForSerialNo: Code[50]; ForLotNo: Code[50]; ForCDNo: Code[30]; Direction: Option Outbound,Inbound)
    var
        ShipmentDate: Date;
    begin
    ...
    procedure TransferTransferToItemJnlLine(var TransLine: Record "Transfer Line"; var ItemJnlLine: Record "Item Journal Line"; TransferQty: Decimal; Direction: Option Outbound,Inbound; IsReclass: Boolean)
    var
        ...
        if ReservEngineMgt.InitRecordSet(OldReservEntry) then
            repeat
                ...
                ItemTrackingMgt.CheckWhseItemTrkgSetup(
                  TransLine."Item No.", TransLine."Transfer-from Code", WhseSNRequired, WhseLNRequired, WhseCDRequired, false);
    ...
    procedure CallItemTracking(var TransLine: Record "Transfer Line"; Direction: Option Outbound,Inbound; DirectTransfer: Boolean)
    var
