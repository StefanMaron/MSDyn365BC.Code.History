                ...
                field(Enabled; Rec."Azure AI Enabled")
                {
                    ...
                    begin
                        ...
                        if Rec."Azure AI Enabled" then
                            MyCustomerAuditLoggerALHelper.LogAuditMessage(CashFlowForecastConsentProvidedLbl, MyALSecurityOperationResult::Success, MyALAuditCategory::ApplicationManagement, 4, 0);
                    end;
                }
