codeunit 1221 "SEPA CT-Fill Export Buffer"
{
    ...
    begin
        ...
        if SEPAFormat = SEPAFormat::CBI then
            BankAccount.TestField(ABI);
        ...
        with PaymentExportData do begin
            ...
            repeat
                Init;
                "Entry No." += 1;
                "General Journal Template" := TempGenJnlLine."Journal Template Name";
                "General Journal Batch Name" := TempGenJnlLine."Journal Batch Name";
                "General Journal Line No." := TempGenJnlLine."Line No.";
    ...
    local procedure ValidatePaymentExportData(var PaymentExportData: Record "Payment Export Data"; var GenJnlLine: Record "Gen. Journal Line"; SEPAFormat: Option pain,CBI,AMC)
    begin
