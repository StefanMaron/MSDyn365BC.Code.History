                ...
                fixed(Control1903895201)
                {
                    ...
                    group("This Period")
                    {
                        ...
                        field(Text000; Text000)
                        {
                            ...
                            ToolTip = 'Specifies the nonchargeable usage, which is displayed in units of measure. Nonchargeable usage can be posted in the resource journal and the job journal.';
                            Visible = false;
                        }
