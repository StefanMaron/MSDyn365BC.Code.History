...
#pragma warning restore AA0074
    ...
    begin
        ...
        if DeprType <> DeprType::Normal then
            TempDeprTableBuffer."Period Depreciation %" := 0;
    ...
    begin
        ...
        if DeprType = DeprType::Custom1 then
            TempDeprTableBuffer."Period Depreciation %" := DeprTableLine."Anticipated %";
