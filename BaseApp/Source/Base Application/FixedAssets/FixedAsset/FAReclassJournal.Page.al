    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the new depreciation book code associated with the fixed asset reclassification journal line.';
                }
                ...
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the new fixed asset posting group associated with the fixed asset reclassification journal line.';
                }
