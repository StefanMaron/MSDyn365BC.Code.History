page 9219 "Purch. Budget Overview Matrix"
{
    ...
    procedure Load(MatrixColumns1: array[32] of Text[80]; var MatrixRecords1: array[32] of Record "Dimension Code Buffer"; CurrentNoOfMatrixColumns: Integer; _CurrentBudgetName: Code[10]; _LineDimOption: Integer; _ColumnDimOption: Integer; _RoundingFactor: Integer; _ValueType: Integer; _PeriodType: Option)
    begin
        LoadMatrix(
            MatrixColumns1, MatrixRecords1, CurrentNoOfMatrixColumns, _CurrentBudgetName,
            "Item Budget Dimension Type".FromInteger(_LineDimOption), "Item Budget Dimension Type".FromInteger(_ColumnDimOption),
            "Analysis Rounding Factor".FromInteger(_RoundingFactor), "Item Analysis Value Type".FromInteger(_ValueType),
