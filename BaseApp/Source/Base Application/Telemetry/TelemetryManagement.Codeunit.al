...
#if not CLEAN19
    var
        GenerateMasterDataTelemetry: Codeunit "Generate Master Data Telemetry";
        GenerateActivityTelemetry: Codeunit "Generate Activity Telemetry";
#endif
    begin
        OnSendDailyTelemetry();
#if not CLEAN19
        GenerateMasterDataTelemetry.OnMasterDataTelemetry();
        GenerateActivityTelemetry.OnActivityTelemetry();
#endif
    end;
