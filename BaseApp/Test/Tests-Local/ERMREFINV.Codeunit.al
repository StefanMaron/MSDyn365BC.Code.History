codeunit 144018 "ERM REFINV"
{
    ...
    begin
        ...
        // Verify.
        VerifyPostedSalesCreditMemo(SalesHeader."No.", SalesHeader."Posting Date", SalesHeader.Amount);
        VerifyPostedSalesCreditMemo(SalesHeader2."No.", SalesHeader2."Posting Date", SalesHeader2.Amount);
    end;
    ...
    local procedure VerifyPostedSalesCreditMemo(PreAssignedNo: Code[20]; PostingDate: Date; Amount: Decimal)
    var
    ...
    begin
        ...
        SalesCrMemoHeader.TestField(Amount, Amount);
        SalesCrMemoLine.SetFilter("Document No.", SalesCrMemoHeader."No.");
        SalesCrMemoLine.FindFirst;
        Assert.AreEqual(SalesCrMemoLine."Line Discount Amount", 0, UnexpectedErr);  // Using 0 for Line Discount Amount.
    end;
