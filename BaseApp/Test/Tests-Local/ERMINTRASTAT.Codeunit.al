...
codeunit 144032 "ERM INTRASTAT"
{
    ...
    begin
        ...
        VerifyXMLFile(CompanyInformation.CISD, FlowCodeLetterATxt, CompanyInformation.GetPartyID());
    ...
    begin
        ...
        VerifyXMLFile(CompanyInformation.CISD, FlowCodeLetterDTxt, CompanyInformation.GetPartyID());
    ...
    local procedure VerifyXMLFile(EnvelopeId: Code[10]; FlowCode: Text; PartyID: Code[18])
    begin
