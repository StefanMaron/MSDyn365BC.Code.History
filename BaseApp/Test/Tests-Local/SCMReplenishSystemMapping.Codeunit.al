codeunit 144004 "SCM Replenish. System Mapping"
{
    ...
    begin
        VerifyGetReplenishmentSystem(
          StockkeepingUnitRef."Replenishment System"::" ", ItemRef."Replenishment System"::None);
    end;
    ...
    begin
        CheckValidateRequsitionLine(
          ItemRef."Replenishment System"::None, RequisitionLineRef."Replenishment System"::" ");
    end;
    ...
    begin
        CheckValidateStokkeepingUnit(
          ItemRef."Replenishment System"::None, StockkeepingUnitRef."Replenishment System"::" ");
    end;
