codeunit 144073 "ERM Corrected Invoice"
{
    ...
    begin
        ...
        VerifyGLEntriesDescription(GLEntry."Document Type"::"Credit Memo", PostedCrMemoNo, PostingDescription);
    end;
    ...
    begin
        ...
        VerifyGLEntriesDescription(GLEntry."Document Type"::"Credit Memo", PostedCrMemoNo, StrSubstNo(CorrectiveInvoiceTxt, SalesHeader."No."));
    end;
    ...
    begin
        ...
        VerifyGLEntriesDescription(GLEntry."Document Type"::"Credit Memo", PostedCrMemoNo, StrSubstNo(CorrectiveInvoiceTxt, PurchaseHeader."No."));
    end;
    ...
    begin
        ...
        // [GIVEN] Posted Service Invoice "I".
        LibraryService.CreateServiceDocumentForCustomerNo(ServiceHeader, ServiceHeader."Document Type"::Invoice, CustomerNo);
        ...
        LibraryService.CreateServiceDocumentForCustomerNo(ServiceHeader, ServiceHeader."Document Type"::"Credit Memo", CustomerNo);
    ...
    local procedure VerifyGLEntriesDescription(DocumentType: Option; DocumentNo: Code[20]; ExpectedDescription: Text[100])
    var
        GLEntry: Record "G/L Entry";
    begin
