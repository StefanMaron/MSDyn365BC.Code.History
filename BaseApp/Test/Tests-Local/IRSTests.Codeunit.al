...
codeunit 141003 "IRS - Tests"
{
    ...
    begin
        ...
        REPORT.Run(REPORT::"IRS Details", true, false, IRSNumbers);
    ...
    begin
        ...
        REPORT.Run(REPORT::"Trial Balance - IRS Number", true, false, IRS_GLAcc);
    ...
    begin
        IRSNumbers.Init();
        IRSNumbers."IRS Number" := LibraryUtility.GenerateRandomCode(IRSNumbers.FieldNo("IRS Number"), DATABASE::"IRS Numbers");
        IRSNumbers.Insert();

        LibraryERM.CreateGLAccount(VAT_GLAcc);
        VAT_GLAcc."IRS Number" := IRSNumbers."IRS Number";
        VAT_GLAcc.Modify();
    ...
    begin
        ...
        if SalesInvoiceLine.FindSet() then
            repeat
                ...
                if GLAcc."IRS Number" <> '' then begin
                    IRS_GLAcc := GLAcc;
                    IRS_GLAcc.Insert();
                end;
