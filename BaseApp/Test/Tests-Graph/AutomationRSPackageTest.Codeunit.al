codeunit 135542 "Automation RSPackage Test"
{
    ...
    begin
        ...
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(
            FormatRSCode(ConfigPackage.Code), PAGE::"Automation - Config. Package", RSPackageServiceTxt, ActionImportTxt);
    ...
    begin
        ...
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(
            FormatRSCode(ConfigPackage.Code), PAGE::"Automation - Config. Package", RSPackageServiceTxt, ActionApplyTxt);
        LibraryGraphMgt.PostToWebServiceAndCheckResponseCode(TargetURL, '', ResponseText, 200);
    ...
    begin
        ...
        JSONManagement.AddJPropertyToJObject(JsonObject, PackageCodeTxt, PackageCode);
