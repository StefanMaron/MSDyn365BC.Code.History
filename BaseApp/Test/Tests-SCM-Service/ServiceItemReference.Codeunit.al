...
codeunit 134467 "Service Item Reference"
{
    ...
    begin
        ...
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Service Item Reference");

        LibraryService.SetupServiceMgtNoSeries();
        Commit();
        IsInitialized := true;

        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Service Item Reference");
    end;
