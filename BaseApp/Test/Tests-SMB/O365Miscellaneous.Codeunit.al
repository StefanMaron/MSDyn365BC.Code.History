codeunit 138017 "O365 Miscellaneous"
{
    ...
    [TestPermissions(TestPermissions::Disabled)]
    [Scope('OnPrem')]
    procedure SandboxEnvironmentPageWindowsClient()
    var
        EnvironmentInfoTestLibrary: Codeunit "Environment Info Test Library";
        SandboxEnvironmentPage: TestPage "Sandbox Environment";
    begin
        ...
        asserterror SandboxEnvironmentPage.OpenView;
        // [THEN] Error message is appeared
        Assert.ExpectedError(EnvironmentErr);
    end;

    [Test]
    [TestPermissions(TestPermissions::Disabled)]
    [Scope('OnPrem')]
    procedure SandboxEnvironmentPageSaaSClient()
    var
        EnvironmentInfoTestLibrary: Codeunit "Environment Info Test Library";
        SandboxEnvironmentPage: TestPage "Sandbox Environment";
    begin
    ...
    [TestPermissions(TestPermissions::Disabled)]
    [Scope('OnPrem')]
    procedure ContainerSandboxPageWindowsClient()
    var
        EnvironmentInfoTestLibrary: Codeunit "Environment Info Test Library";
        ContainerSandboxPage: TestPage "Container Sandbox Environment";
    begin
        ...
        asserterror ContainerSandboxPage.OpenView;
        // [THEN] Error message is appeared
        Assert.ExpectedError(EnvironmentErr);
    end;
    ...
    [TestPermissions(TestPermissions::Disabled)]
    [Scope('OnPrem')]
    procedure ContainerSandboxPageSaaSClient()
    var
        EnvironmentInfoTestLibrary: Codeunit "Environment Info Test Library";
        ContainerSandboxPage: TestPage "Container Sandbox Environment";
    begin
