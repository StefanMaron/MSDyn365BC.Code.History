codeunit 137289 "SCM Inventory Costing IV"
{
    ...
    var
        ...
        ChangePostingDateMessage: Label 'You have changed Posting Date on the sales header, but it has not been changed on the existing sales lines.';
    ...
    begin
        ...
        // Exercise.
        UndoPurchaseReceiptLines(PurchaseLine); // NAVCZ
    end;
