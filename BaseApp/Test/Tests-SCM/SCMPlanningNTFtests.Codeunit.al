codeunit 137021 "SCM Planning - NTF tests"
{
    ...
    begin
        ...
        // [GIVEN] Item "I" with non-base Purchase UoM "U" with Qty per UoM = 3, Reordering Policy = Lot-for-Lot, and Job Planning Line "J" with quantity = 1.
        // Deterministic values are used to reliably reproduce the repeating-decimal rounding mismatch (1 / 3 = 0.33333...) that the production fix guards against.
        TestSetup();
        QtyPerUoM := 3;
        JobQuantity := 1;
