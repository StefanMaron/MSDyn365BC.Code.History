codeunit 137079 "SCM Production Order III"
{
    ...
    begin
        ...
        ChangeProuctionOrderStatus(ProductionOrder."No.", ProductionOrder.Status::Planned, ProductionOrder.Status::Released);
    ...
    local procedure ChangeProuctionOrderStatus(ProductionOrderNo: Code[20]; FromStatus: Enum "Production Order Status"; ToStatus: Enum "Production Order Status"): Code[20]
    var
        ProductionOrder: Record "Production Order";
    begin
        ProductionOrder.Get(FromStatus, ProductionOrderNo);
        LibraryManufacturing.ChangeProdOrderStatus(ProductionOrder, ToStatus, WorkDate(), true);
