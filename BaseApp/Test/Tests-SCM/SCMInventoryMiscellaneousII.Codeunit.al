codeunit 137294 "SCM Inventory Miscellaneous II"
{
    ...
    begin
        ...
        CreateInventory(CompItem, 3, Location.Code, Bin3.Code);
    ...
    local procedure CreateInventory(Item: Record Item; Quantity: Decimal; LocationCode: Code[10]; BinCode: Code[20])
    var
        ItemJournalLine: Record "Item Journal Line";
    begin
        CreateItemJournalLine(ItemJournalLine, Item."No.", Quantity, LocationCode);
        ItemJournalLine.Validate("Bin Code", BinCode);
        ItemJournalLine.Modify(true);
