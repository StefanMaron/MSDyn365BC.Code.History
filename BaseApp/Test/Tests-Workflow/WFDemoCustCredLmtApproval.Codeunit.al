codeunit 134190 "WF Demo Cust Cred Lmt Approval"
{
    ...
    local procedure VerifyApprovalRequests(Customer: Record Customer; ExpectedNumberOfApprovalEntries: Integer; SenderUserID: Code[50]; ApproverUserID1: Code[50]; ApproverUserID2: Code[50]; ApproverUserID3: Code[50]; Status1: Option; Status2: Option; Status3: Option)
    var
        ApprovalEntry: Record "Approval Entry";
    begin
        LibraryDocumentApprovals.GetApprovalEntries(ApprovalEntry, Customer.RecordId);
