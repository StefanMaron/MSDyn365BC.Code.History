codeunit 136121 "Service Reservation"
{
    ...
    var
        ...
        ReserveNeverErrorServiceTier: Label '%1 must not be %2 in %3: %4=%5, %6=%7, %8=%9';
        ...
        TypeReservationError: Label '%1 must be equal to ''Item'' ', Comment = '%1 Type Field Caption,%2 Table Caption,%3 Document Type FieldCaption,%4 Document Type,%5 Document No. Field Caption,%6 Document No.,%7 Line No. Field Caption,%8 Line No.';
    ...
    begin
        ...
        Assert.ExpectedError(
          StrSubstNo(TypeReservationError, ServiceLine.FieldCaption(Type)));
    end;
