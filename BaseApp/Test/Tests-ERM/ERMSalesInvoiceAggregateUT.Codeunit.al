codeunit 134396 "ERM Sales Invoice Aggregate UT"
{
    ...
    begin
        ...
        // [GIVEN] Create Sales Line with Quantity as 1 and Unit Price Excl VAT as 1190.13 (chosen so the calculated total is not a multiple of 0.05 for the CH VAT rate, ensuring an invoice rounding line is created).
        LibrarySales.CreateSalesLineWithUnitPrice(SalesLine, SalesHeader, LibraryInventory.CreateItemNo(), 1190.13, 1);
