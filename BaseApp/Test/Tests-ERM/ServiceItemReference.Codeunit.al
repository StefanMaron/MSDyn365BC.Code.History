codeunit 134467 "Service Item Reference"
{
    Subtype = Test;
    ...
    trigger OnRun()
    begin
        // [FEATURE] [Item Reference] [Reference No] [Service]
    end;
    ...
    [Scope('OnPrem')]
    procedure ICRLookupServiceItemWhenSameCustomersForSameItemsAndBarCodeShowDialogTrue()
    var
    ...
    begin
        ...
        // [SCENARIO 289240] ICRLookupServiceItem for Customer A and ShowDialog is Yes
        ...
        MockServiceLineForICRLookupServiceItem(ServiceLine, CustNo[1], ItemRefNo);

        // [GIVEN] Ran ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = TRUE
        ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ItemReference[1], true);
    ...
    begin
        ...
        // [GIVEN] Sales Line had Type = Item, "Sell-to Customer No." = 10000 and Reference No. = 1234
        MockServiceLineForICRLookupServiceItem(ServiceLine, CustNo, ItemRefNo);
    ...
    begin
        ...
        // [GIVEN] Ran ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = TRUE
        ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ItemReference[2], true);
    ...
    begin
        ...
        // [GIVEN] Sales Line had Type = Item, "Sell-to Customer No." = 10000 and Reference No. = 1234
        MockServiceLineForICRLookupServiceItem(ServiceLine, LibrarySales.CreateCustomerNo(), ItemRefNo);
    ...
    begin
        ...
        // [GIVEN] Sales Line had Type = Item, "Sell-to Customer No." = 10000 and Reference No. = 1234
        MockServiceLineForICRLookupServiceItem(
          ServiceLine, CopyStr(ItemReference[1]."Reference Type No.", 1, MaxStrLen(ServiceLine."Customer No.")), ItemRefNo);
    ...
    begin
        ...
        // [WHEN] Run ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = TRUE
        asserterror ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ItemReference, true);
    ...
    begin
        ...
        // [GIVEN] Sales Line had Type = Item, "Sell-to Customer No." = 10000 and Reference No. = 1234
        MockServiceLineForICRLookupServiceItem(
          ServiceLine, CopyStr(ItemReference."Reference Type No.", 1, MaxStrLen(ServiceLine."Customer No.")), ItemRefNo);

        // [WHEN] Run ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = TRUE
        ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ItemReference, true);
    ...
    begin
        ...
        // [WHEN] Run ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = TRUE
        asserterror ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, DummyItemReference, true);
    ...
    begin
        ...
        ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ItemReference[2], false);
    ...
    begin
        ...
        MockServiceLineForICRLookupServiceItem(
          ServiceLine, CopyStr(ItemReference[2]."Reference Type No.", 1, MaxStrLen(ServiceLine."Customer No.")), ItemRefNo);

        // [WHEN] Run ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = FALSE
        ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ItemReference[1], false);
    ...
    begin
        ...
        // [WHEN] Run ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = FALSE
        asserterror ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ItemReference, false);
    ...
    begin
        ...
        // [WHEN] Run ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = FALSE
        ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ItemReference, false);
    ...
    begin
        ...
        // [GIVEN] Sales Line had Type = Item, "Sell-to Customer No." = 10000 and Reference No. = 1234
        MockServiceLineForICRLookupServiceItem(
          ServiceLine, LibrarySales.CreateCustomerNo(), ItemRefNo);

        // [WHEN] Run ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = FALSE
        asserterror ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, DummyItemReference, false);
    ...
    begin
        ...
        // [GIVEN] Ran ICRLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = TRUE
        asserterror ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ItemReference[1], true);
    ...
    begin
        ...
        CreateServiceInvoiceOneLineWithLineTypeItem(ServiceLine, CustNo);

        // [GIVEN] Stan Looked up Item Reference No in Sales Line
        ServiceHeader.Get(ServiceLine."Document Type", ServiceLine."Document No.");
        ServItemReferenceMgt.ServiceReferenceNoLookup(ServiceLine, ServiceHeader);
        ...
        ServiceLine.TestField("No.", ItemReference[2]."Item No.");
        LibraryVariableStorage.AssertEmpty();
    end;
    ...
    begin
        ...
        CreateServiceInvoiceOneLineWithLineTypeItem(ServiceLine, LibrarySales.CreateCustomerNo());
        ServiceLine."Item Reference No." := ItemReferenceNo;
        ServiceLine.Modify();
        ...
        LibraryItemReference.CreateItemReferenceWithNoAndDates(ItemReference[1], ItemReferenceNo, LibraryInventory.CreateItemNo(),
          ItemReference[1]."Reference Type"::"Bar Code", LibraryUtility.GenerateGUID(),
           CalcDate('<-1M>', ServiceLine.GetDateForCalculations()), CalcDate('<-1D>', ServiceLine.GetDateForCalculations()));
        ...
        ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ReturnedItemReference, true);
    ...
    begin
        ...
        LibraryItemReference.CreateItemReferenceWithNoAndDates(ItemReference[1], ItemReferenceNo, LibraryInventory.CreateItemNo(),
          ItemReference[1]."Reference Type"::"Bar Code", LibraryUtility.GenerateGUID(),
           CalcDate('<-1M>', ServiceLine.GetDateForCalculations()), CalcDate('<+1M>', ServiceLine.GetDateForCalculations()));
        EnqueueItemReferenceFields(ItemReference[1]);
    ...
    begin
        ...
        LibraryItemReference.CreateItemReferenceWithNoAndDates(ItemReference[2], ItemReferenceNo, LibraryInventory.CreateItemNo(),
          ItemReference[2]."Reference Type"::"Bar Code", LibraryUtility.GenerateGUID(),
           CalcDate('<+1D>', ServiceLine.GetDateForCalculations()), CalcDate('<+1M>', ServiceLine.GetDateForCalculations()));

        // [WHEN] Ran ReferenceLookupSalesItem from codeunit Dist. Integration for the Sales Line with ShowDialog = TRUE
        asserterror ServItemReferenceMgt.ReferenceLookupServiceItem(ServiceLine, ReturnedItemReference, true);
    ...
    local procedure MockServiceLineForICRLookupServiceItem(var ServiceLine: Record "Service Line"; CustNo: Code[20]; ItemRefNo: Code[50])
    begin
        ServiceLine.Init();
        ServiceLine.Type := ServiceLine.Type::Item;
        ServiceLine."Customer No." := CustNo;
        ServiceLine."Item Reference No." := ItemRefNo;
    end;

    local procedure CreateServiceInvoiceOneLineWithLineTypeItem(var ServiceLine: Record "Service Line"; CustNo: Code[20])
    var
        ServiceHeader: Record "Service Header";
    begin
