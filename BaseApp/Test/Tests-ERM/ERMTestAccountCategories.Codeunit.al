codeunit 134444 "ERM Test Account Categories"
{
    ...
    var
        ...
        TotalAccountErr: Label 'Account Schedule Totaling Type are not matched.';
    ...
    begin
        ...
        Assert.AreEqual(AccScheduleLine."Totaling Type"::"Posting Accounts", AccScheduleLine."Totaling Type", TotalAccountErr);
    end;
