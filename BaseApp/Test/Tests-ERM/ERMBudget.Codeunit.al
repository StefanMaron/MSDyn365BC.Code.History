codeunit 134922 "ERM Budget"
{
    ...
    begin
        ...
        Quantity[2] := LibraryRandom.RandDecInRange(1, 10, 1);
    ...
    var
        ...
        EntryAmount: Integer;
    begin
        // [SCENARIO 612519] Importing G/L budgets from Excel works correctly when a filter is specified for one of the dimensions
        Initialize();
        LibraryApplicationArea.DisableApplicationAreaSetup();
