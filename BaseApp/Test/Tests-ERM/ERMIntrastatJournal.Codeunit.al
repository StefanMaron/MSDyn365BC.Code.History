...
codeunit 134150 "ERM Intrastat Journal"
{
    ...
    begin
        ...
        // [GIVEN] Sales Invoice for FR Bill-to Customer with EU 3-Party Trade = true
        ...
        // [THEN] Partner VAT ID  = 'FR999999999999' in Intrastat Journal Line (TFS 418764)
        CountryRegion.Get(SalesHeader."Bill-to Country/Region Code");
        VerifyPartnerID(IntrastatJnlBatch, SalesLine."No.", CountryRegion."Intrastat Code" + '999999999999');
    end;
    ...
    begin
        ...
        // [GIVEN] Sales Credit Memo for FR Bill-to Customer with EU 3-Party Trade = true
        CustomerNo := CreateCustomerWithVATRegNo(true);
        CreateSalesDocument(
            SalesHeader, SalesLine, CustomerNo, WorkDate(), SalesLine."Document Type"::"Credit Memo",
            SalesLine.Type::Item, CreateItem, 1);
        ...
        // [THEN] Partner VAT ID  = 'FR999999999999' in Intrastat Journal Line (TFS 418764)
        CountryRegion.Get(SalesHeader."Bill-to Country/Region Code");
        Assert.AreEqual(CountryRegion."Intrastat Code" + '999999999999', IntrastatJnlLine.GetPartnerID, '');
    end;
    ...
    begin
        ...
        // [GIVEN] Posted Service Invoice where FR Bill-to Customer with EU 3-Party Trade = true
        CustomerNo := CreateCustomerWithVATRegNo(true);
        CreatePostServiceInvoice(
            ItemLedgerEntry, DocumentNo, CustomerNo, CustomerNo, CreateItem);
        ...
        // [THEN] Partner VAT ID  = 'QV999999999999' in Intrastat Journal Line (TFS 418764)
        CountryRegion.Get(ServiceShipmentHeader."Bill-to Country/Region Code");
        VerifyPartnerID(IntrastatJnlBatch, ItemLedgerEntry."Item No.", CountryRegion."Intrastat Code" + '999999999999');
    end;
    ...
    begin
        ...
        // [GIVEN] Posted Service Credit Memo where FR Bill-to Customer with EU 3-Party Trade = true
        CustomerNo := CreateCustomerWithVATRegNo(true);
        CreatePostServiceCrMemo(
            ItemLedgerEntry, DocumentNo, CustomerNo, CustomerNo, CreateItem);
        ...
        // [THEN] Partner VAT ID  = 'FR999999999999' in Intrastat Journal Line (TFS 418764)
        CountryRegion.Get(ServiceCrMemoHeader."Bill-to Country/Region Code");
        Assert.AreEqual(CountryRegion."Intrastat Code" + '999999999999', IntrastatJnlLine.GetPartnerID, '');
    end;
