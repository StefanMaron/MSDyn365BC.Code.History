codeunit 134158 "Test Price Calc. Setup"
{
    ...
    begin
        ...
        with PriceCalculationSetup[5] do begin
            ...
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[3], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Price Calculation - V15", false);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[4], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Price Calculation - V16", true);
        end;
    ...
    begin
        ...
        with PriceCalculationSetup[5] do begin
            ...
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[1], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V15", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[2], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V16", false);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[3], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Price Calculation - V15", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[4], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Price Calculation - V16", false);
        end;
    ...
    begin
        ...
        with PriceCalculationSetup[5] do begin
            DeleteAll();
            ExpectedCode := LibraryPriceCalculation.AddSetup(PriceCalculationSetup[1], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V15", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[2], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V16", false);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[3], Method::"Lowest Price", Type::Purchase, "Asset Type"::" ", Codeunit::"Price Calculation - V15", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[4], Method::"Lowest Price", Type::Purchase, "Asset Type"::" ", Codeunit::"Price Calculation - V16", false);
        end;
    ...
    begin
        ...
        with PriceCalculationSetup[5] do begin
            ...
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[1], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V15", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[2], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V16", false);
            ExpectedCode := LibraryPriceCalculation.AddSetup(PriceCalculationSetup[3], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Price Calculation - Test", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[4], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Price Calculation - V16", false);
        end;
        // [GIVEN] Sales Line, where Item 'X' and Customer 'Y'
        SalesLineAsLineWithPrice(ItemNo, CustomerNo, LineWithPrice);
    ...
    begin
        ...
        with PriceCalculationSetup[5] do begin
            ...
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[1], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V15", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[2], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V16", false);
            ExpectedCode := LibraryPriceCalculation.AddSetup(PriceCalculationSetup[3], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Test Price Calc. Setup", false);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[4], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Price Calculation - V16", true);
        end;
        // [GIVEN] Sales Line, where Item 'X' and Customer 'Y'
        SalesLineAsLineWithPrice(ItemNo, CustomerNo, LineWithPrice);
    ...
    begin
        ...
        with PriceCalculationSetup[5] do begin
            ...
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[1], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V15", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[2], Method::"Lowest Price", Type::Sale, "Asset Type"::" ", Codeunit::"Price Calculation - V16", false);
            ExpectedCode := LibraryPriceCalculation.AddSetup(PriceCalculationSetup[3], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Price Calculation - Test", false);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[4], Method::"Lowest Price", Type::Sale, "Asset Type"::Item, Codeunit::"Price Calculation - V16", true);
        end;
    ...
    begin
        ...
        LibraryPriceCalculation.AddSetup(
            ...
            PriceCalculationSetup."Asset Type"::" ", Codeunit::"Price Calculation - Test", true);
    ...
    begin
        ...
        EnableExtendedPriceCalculation();
        isInitialized := true;
        Commit;
    ...
    begin
        BindSubscription(TestPriceCalcSetup);
    end;
    ...
    begin
        with PriceCalculationSetup[5] do begin
            DeleteAll();
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[1], Method::"Lowest Price", PriceType, "Asset Type"::" ", Codeunit::"Price Calculation - V15", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[2], Method::"Lowest Price", PriceType, "Asset Type"::" ", Codeunit::"Price Calculation - V16", false);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[3], Method::"Test Price", PriceType, "Asset Type"::" ", Codeunit::"Price Calculation - V15", true);
            LibraryPriceCalculation.AddSetup(PriceCalculationSetup[4], Method::"Test Price", PriceType, "Asset Type"::" ", Codeunit::"Price Calculation - V16", false);
        end;
    end;
    ...
    procedure OnIsExtendedPriceCalculationEnabled(var Result: Boolean);
    begin
        Result := true;
    end;
}