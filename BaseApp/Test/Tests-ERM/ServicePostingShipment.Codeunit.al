codeunit 136107 "Service Posting - Shipment"
{
    ...
    begin
        ...
        VerifyCountryRegionCodeOnItemLedgerEntry(ServiceHeader."No.", ItemLedgerEntry."Document Type"::"Service Shipment", CountryRegion.Code);
    end;
    ...
    begin
        ...
        VerifyCountryRegionCodeOnItemLedgerEntry(ServiceHeader."No.", ItemLedgerEntry."Document Type"::"Service Shipment", '');
    end;
    ...
    begin
        ...
        // [THEN] Item Ledger Entry is created, it has Country/Region Code = 'C'.
        VerifyCountryRegionCodeOnItemLedgerEntry(ServiceHeader."No.", ItemLedgerEntry."Document Type"::"Service Credit Memo", CountryRegionCode);
    end;
    ...
    local procedure VerifyCountryRegionCodeOnItemLedgerEntry(OrderNo: Code[20]; DocumentType: Option; CountryRegionCode: Code[10])
    var
        ItemLedgerEntry: Record "Item Ledger Entry";
    begin
