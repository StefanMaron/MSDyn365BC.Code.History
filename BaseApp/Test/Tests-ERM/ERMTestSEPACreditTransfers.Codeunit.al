codeunit 134403 "ERM Test SEPA Credit Transfers"
{
    ...
    begin
        GenJournalLine.Validate("Remittance Agreement Code", RemittanceAgreementCode);
        GenJournalLine.Validate("Recipient Ref. 1", RecipientRef1);
        GenJournalLine.Validate("Recipient Ref. 2", RecipientRef2);
        GenJournalLine.Modify();
    end;
