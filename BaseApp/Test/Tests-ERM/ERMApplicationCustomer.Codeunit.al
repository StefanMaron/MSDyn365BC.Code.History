codeunit 134010 "ERM Application Customer"
{
    ...
    local procedure ScenarioPostDocumentAndApplyToOtherDocumentFCYApplnRounding(DocumentTypeApplying: Option; DocumentTypeApplied: Option; CurrencyCodeApplying: Code[10]; CurrencyCodeApplied: Code[10]; AmountApplying: Decimal; AmountApplied: Decimal; var CustLedgerEntryApplying: Record "Cust. Ledger Entry"; var CustLedgerEntryApplied: Record "Cust. Ledger Entry")
    var
        Customer: Record Customer;
    ...
    local procedure CreateGenJournalLineFCY(var GenJournalLine: Record "Gen. Journal Line"; DocumentType: Option; CustomerNo: Code[20]; CurrencyCode: Code[10]; DocumentAmount: Decimal)
    begin
        LibraryJournals.CreateGenJournalLineWithBatch(
    ...
    local procedure FindCustLedgerEntry(var CustLedgerEntry: Record "Cust. Ledger Entry"; Customer: Record Customer; DocumentType: Option; DocumentNo: Code[20])
    begin
        Clear(CustLedgerEntry);
