codeunit 139151 DocumentSendingPostTestsSMTP
{
    Subtype = Test;
    TestPermissions = Disabled;
    ObsoleteState = Pending;
    ObsoleteReason = 'Replaced with ''DocumentSendingPostTests'' codeunit, using email module';
    ObsoleteTag = '17.0';
    ...
    var
        ...
        SalesInvoice: TestPage "Sales Invoice";
    begin
        // [WHEN] Disk (Electronic Doc) is selected as a sending profile in a default document sending profile, and Annie clicks Post and Send on a sales invoice
        // [THEN] the file is saved to disk
        Initialize();

        // create disk with electronic document sending profile default rule
    ...
    var
        ...
        ServiceInvoice: TestPage "Service Invoice";
    begin
        // [WHEN] Disk (Electronic Doc) is selected as a sending profile in a default document sending profile, and Annie clicks Post and Send on a service invoice
        // [THEN] the file is saved to disk
        Initialize();
    ...
    var
        ...
        ServiceCreditMemo: TestPage "Service Credit Memo";
    begin
        // [WHEN] Disk (Electronic Doc) is selected as a sending profile in a default document sending profile, and Annie clicks Post and Send on a service credit memo
        // [THEN] the file is saved to disk
        Initialize();
