codeunit 138090 "My Records Demo Setup Test"
{
    ...
    begin
        ...
        VendorNo := CreateVendorWithBalance(9);
        ...
        // [WHEN] Filtering the My Vendor table for VendorNo
        MyVendor.SetRange("Vendor No.", VendorNo);

        // [THEN] There should be exactly one entry in the My Vendor table
        Assert.AreEqual(1, MyVendor.Count,
          'There should be exactly one entry in the My Vendor table for this Vendor No.');
    end;
