codeunit 136131 "Service Demand Overview"
{
    ...
    var
        ...
        DemandOverviewAllFilter: Label 'All Demand';
        DemandOverviewSaleFilter: Label 'Sale';
        ...
        ItemNo: Code[20];
        NoDate: Integer;
        NeededDateBlankErrorText: Label 'Validation error for Field: Needed by Date,  Message = ''Needed by Date must have a value in Service Line: Document Type=Order, Document No.=%1, Line No.=10000. It cannot be zero or empty.''';
