codeunit 134390 "ERM Sales Doc. Reports"
{
    ...
    begin
        LibraryReportDataset.LoadDataSetFile();
        LibraryReportDataset.AssertElementWithValueExists('VATIdentifier_VATAmtLine', VATIdentifier);
        LibraryReportDataset.AssertElementWithValueExists('VATAmt_VATAmtLine', VATAmount);
        LibraryReportDataset.AssertElementWithValueExists('VATIdentifier_VATAmtLine', VATIdentifier);
        LibraryReportDataset.AssertElementWithValueExists('VALVATAmtLCY', VATAmount);
    end;
