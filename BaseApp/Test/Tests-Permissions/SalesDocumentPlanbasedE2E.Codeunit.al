codeunit 135404 "Sales Document Plan-based E2E"
{
    ...
    begin
        ...
        CreateSalesOrderWithLocation(SalesOrder, '', Location.Code);
    ...
    local procedure CreateSalesOrderWithLocation(var SalesOrder: TestPage "Sales Order"; ItemNo: Code[20]; LocationCode: Code[20])
    var
        SalesLine: Record "Sales Line";
    begin
        SalesOrder.OpenNew();
