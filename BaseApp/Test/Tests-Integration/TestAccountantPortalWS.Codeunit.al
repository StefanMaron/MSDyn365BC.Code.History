codeunit 134765 TestAccountantPortalWS
{
    ...
    begin
        ...
        VerifyActivitiesCues(AccountantPortalActivityCues, ActivitiesCue.FieldName("Ongoing Sales Invoices"), '                             8', MasterStyle::None);
        VerifyActivitiesCues(AccountantPortalActivityCues, ActivitiesCue.FieldName("Ongoing Purchase Invoices"), '                             4', MasterStyle::None);
        VerifyActivitiesCues(AccountantPortalActivityCues, ActivitiesCue.FieldName("Sales This Month"), '                         ' + AcctWebServicesMgt.FormatAmountString(0.0), MasterStyle::None);
        ...
        VerifyActivitiesCues(AccountantPortalActivityCues, ActivitiesCue.FieldName("Overdue Sales Invoice Amount"), '                       ' + AcctWebServicesMgt.FormatAmountString(654.32), MasterStyle::Favorable);
        ...
        VerifyActivitiesCues(AccountantPortalActivityCues, ActivitiesCue.FieldName("Ongoing Sales Quotes"), '                             3', MasterStyle::None);
        ...
        VerifyActivitiesCues(AccountantPortalActivityCues, ActivitiesCue.FieldName("Non-Applied Payments"), '                             2', MasterStyle::Favorable);
        ...
        VerifyActivitiesCues(AccountantPortalActivityCues, ActivitiesCue.FieldName("Ongoing Sales Orders"), '                             4', MasterStyle::None);
        ...
        VerifyActivitiesCues(AccountantPortalActivityCues, ActivitiesCue.FieldName("Purchase Orders"), '                             5', MasterStyle::None);
