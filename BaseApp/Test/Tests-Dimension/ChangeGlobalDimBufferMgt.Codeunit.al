codeunit 134484 "Change Global Dim. Buffer Mgt."
{
    ...
    [TransactionModel(TransactionModel::AutoRollback)]
    [Scope('OnPrem')]
    procedure T300_DisableIntegration()
    var
        ChangeGlobalDimLogMgt: Codeunit "Change Global Dim. Log Mgt.";
    ...
    begin
        ...
        IntegrationManagement.GetDatabaseTableTriggerSetup(
          DATABASE::"Sales Header", TableTrigger[1], TableTrigger[2], TableTrigger[3], TableTrigger[4]);
        VerifyTableTriggers(TableTrigger, false);
        Assert.IsFalse(IntegrationManagement.IsIntegrationActivated, 'IsIntegrationActivated');
    ...
    [TransactionModel(TransactionModel::AutoRollback)]
    [Scope('OnPrem')]
    procedure T301_EnableIntegration()
    var
        ChangeGlobalDimLogMgt: Codeunit "Change Global Dim. Log Mgt.";
        IntegrationManagement: Codeunit "Integration Management";
        APIMockEvents: Codeunit "API Mock Events";
