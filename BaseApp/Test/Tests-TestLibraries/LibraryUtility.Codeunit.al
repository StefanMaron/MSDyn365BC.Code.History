codeunit 131000 "Library - Utility"
{
    ...
    begin
        LibraryNoSeries.CreateNoSeriesRelationship(Code, SeriesCode);
    end;
    ...
    begin
        ...
        if not NoSeries.Get(NoSeriesCode) then begin
            ...
            LibraryNoSeries.CreateNoSeriesLine(NoSeriesCode, 1,
                PadStr(InsStr(NoSeriesCode, '00000000', 3), 10),
                PadStr(InsStr(NoSeriesCode, '99999999', 3), 10));
        end;
