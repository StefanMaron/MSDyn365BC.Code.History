codeunit 131015 "Library - Azure AD Auth Flow"
{
    ...
    [EventSubscriber(ObjectType::Codeunit, 6303, 'OnInitialize', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, 6303, 'OnAcquireTokenByAuthorizationCode', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, 6303, 'OnAcquireTokenByAuthorizationCodeWithCredentials', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, 6303, 'OnAcquireTokenFromCache', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, 6303, 'OnAcquireTokenFromCacheWithCredentials', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, 6303, 'OnAcquireGuestToken', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, 6303, 'OnGetSaasClientId', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, 6303, 'OnCreateExchangeServiceWrapperWithToken', '', false, false)]
