codeunit 4010 CalculateAmounts
{
    ...
    var
        ...
        OverDueSalesTxt: label '%1 of your customers are late with their payments to you';
        SalesInvoicesThisWeekTxt: label '%1 invoices are supposed to be paid by your customers this week';
        PurchInvoicesDueThisWeekTxt: label '%1 invoices from vendors should be paid this week';
        PurchInvoicesOverdueTxt: label '%1 invoices weren''t paid by you on time';
