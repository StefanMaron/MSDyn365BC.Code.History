codeunit 4011 "Hybrid Message Management"
{
    var
        ...
        WebhookFailureErr: Label 'Communication with Business Central was unsuccessful. Verify that the cloud migration user (%1) has the correct permissions.';
        TableDoesnotExistErrorCodeTxt: Label '50004';
        ColumnMappingErr: Label '%1 column could not be mapped: %2';
    ...
    begin
        ...
        case MessageCode of
            ...
            '52100':
                Message := HandleWebhookError(InnerMessage);
            else
    ...
    begin
        if ErrorCode = TableDoesnotExistErrorCodeTxt then
    ...
    local procedure HandleWebhookError(InnerError: Text) Message: Text
    var
