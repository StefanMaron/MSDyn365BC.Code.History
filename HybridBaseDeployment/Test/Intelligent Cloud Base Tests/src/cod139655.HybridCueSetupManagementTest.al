codeunit 139655 "Hybrid Cue Setup Mgt Tests"
{
    ...
    begin
        ...
        EnableReplicationForCompany(DummyCompanyName, true);
        for i := 1 to 4 do
            AddNormalTestRunToHybridReplicationDetail(DummyRunId, StrSubstNo('Table %1', i), DummyCompanyName, DummyDateTime, DummyDateTime, HybridReplicationDetail.Status::NotStarted);
