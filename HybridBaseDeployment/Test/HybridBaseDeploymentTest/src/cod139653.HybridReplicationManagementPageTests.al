codeunit 139653 "Replication Mgt Page Tests"
{
    ...
    begin
        ...
        AssistedSetup.Complete('58623bfa-0559-4bc2-ae1c-0979c29fd9e0', Page::"Hybrid Cloud Setup Wizard");
    ...
    begin
        // [THEN] The expected request trackingId is returned to the user
        Assert.AreEqual(StrSubstNo(RunReplicationTxt, TestTrackingIdTxt), message, 'The incoming test tracking id is not correct.');
    end;
