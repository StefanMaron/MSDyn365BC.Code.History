pageextension 18543 "CompanyInformation" extends "Company Information"
{
    layout
    {
        addlast(General)
        {
            field("Company Status"; "Company Status")
            {
