...
pageextension 18573 "Posted Sales Inv. Statistics" extends "Sales Invoice Statistics"
{
    layout
    {
        addlast(General)
    ...
    begin
        CalcStatistics.GetPostedsalesInvStatisticsAmount(Rec, TotalInclTaxAmount);
    end;
