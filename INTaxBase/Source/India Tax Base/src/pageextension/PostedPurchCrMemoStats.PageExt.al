pageextension 18570 "Posted Purch. Cr. Memo Stats." extends "Purch. Credit Memo Statistics"
{
    layout
    {
        addlast(General)
    ...
    begin
        CalcStatistics.GetPostedPurchCrMemoStatisticsAmount(Rec, TotalInclTaxAmount);
    end;
