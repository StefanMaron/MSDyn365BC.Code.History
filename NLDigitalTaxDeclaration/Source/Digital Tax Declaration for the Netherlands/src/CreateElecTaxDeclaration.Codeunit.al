codeunit 11421 "Create Elec. Tax Declaration"
{
    ...
    var
        ...
        XMLDoc: XmlDocument;
        BdINameSpaceTxt: Label 'http://www.nltaxonomie.nl/nt14/bd/20191211/dictionary/bd-data', Locked = true;
    ...
    begin
        ...
        SchemaRef.Add(XmlAttribute.Create('href', 'http://www.w3.org/1999/xlink', 'http://www.nltaxonomie.nl/nt14/bd/20191211/entrypoints/bd-rpt-ob-aangifte-2020.xsd').AsXmlNode());
    ...
    begin
        ...
        DigitalTaxDeclMgt.AddSmallEntrepreneurProvisionReduction(TempNameValueBufferAmtCode);
        AddAmount(RootElement, VATStatementReportLine, TempNameValueBufferAmtCode.Name, TempNameValueBufferAmtCode.Value);
