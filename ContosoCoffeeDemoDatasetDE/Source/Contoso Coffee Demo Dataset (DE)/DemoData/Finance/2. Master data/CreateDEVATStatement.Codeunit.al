...
codeunit 11120 "Create DE VAT Statement"
{
    ...
    begin
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 60000, '43', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Export(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Base, 0, true, 1, StfrUmsätzeMVorstAbzug43B1Lbl, '');
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 70000, '43', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Export(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", '', Enum::"VAT Statement Line Amount Type"::Base, 0, true, 1, StfrUmsätzeMVorstAbzug43B2Lbl, '');
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 160000, '86A', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Base, 0, true, 1, StpflUmsätze86BLbl, '');
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 170000, '86S', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Amount, 0, true, 1, Umsatzsteuer86SLbl, '');
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 180000, '87', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '', Enum::"VAT Statement Line Amount Type"::Base, 0, true, 1, StpflUmsätze87Lbl, '');
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 300000, '91', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '', Enum::"VAT Statement Line Amount Type"::Base, 1, true, 1, InnergemErwerbe91Lbl, '');
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 350000, '93', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Base, 1, true, 1, StpflInnergemErwerbe93BLbl, '');
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 360000, '93', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Amount, 1, true, 1, Erwerbsteuer93SLbl, '');
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 370000, '90', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Sale, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. No VAT", '', Enum::"VAT Statement Line Amount Type"::Base, 0, true, 1, StpflInnergemErwerbe90Lbl, '');
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 400000, '66A', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", '', Enum::"VAT Statement Line Amount Type"::Amount, 0, true, 0, VorsteuerN66S1Lbl, '');
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 410000, '66B', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.Domestic(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Amount, 0, true, 0, VorsteuerN66S2Lbl, '');
        ...
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 490000, '61A', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Standard", '', Enum::"VAT Statement Line Amount Type"::Amount, 0, true, 0, Erwerbvorsteuer61S1Lbl, '');
        ContosoVatStatement.InsertVatStatementLine(CreateVATStatement.VATTemplateName(), USTVATStatementName(), 500000, '61B', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", Enum::"General Posting Type"::Purchase, CreateVATPostingGroups.EU(), FinanceModuleSetup."VAT Prod. Post Grp. Reduced", '', Enum::"VAT Statement Line Amount Type"::Amount, 0, true, 0, Erwerbvorsteuer61S2Lbl, '');
