codeunit 139519 "E-Doc. Format Tests"
{
    ...
    begin
        ...
        AddEDocServiceSupportedType(this.EDocumentService, Enum::"E-Document Type"::"Service Order");
    ...
    local procedure AddEDocServiceSupportedType(EDocService: Record "E-Document Service"; EDocumentType: Enum "E-Document Type")
    var
