codeunit 11464 "Contoso Tax US"
{
    ...
    procedure InsertTaxJurisdiction(Code: Code[10]; Description: Text[100]; TaxAccountSales: Code[20]; TaxAccountPurchases: Code[20]; ReporttoJurisdiction: Code[10]; ReverseChargePurchases: Code[20]; CountryRegion: Option)
    var
