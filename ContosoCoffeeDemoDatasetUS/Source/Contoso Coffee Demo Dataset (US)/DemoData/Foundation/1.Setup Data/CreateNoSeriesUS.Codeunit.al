codeunit 11494 "Create No. Series US"
{
    SingleInstance = true;
    ...
    procedure ValidateRecordFields(var NoSeriesLine: Record "No. Series Line"; StartingNo: Code[20]; EndingNo: Code[20]; WarningNo: Code[20])
    begin
