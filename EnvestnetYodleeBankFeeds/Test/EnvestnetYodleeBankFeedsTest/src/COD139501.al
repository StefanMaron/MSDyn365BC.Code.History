codeunit 139501 "MS - Yodlee Bank Service Tests"
{
    ...
    var
        ...
        LibraryJobQueue: Codeunit 132458;
    ...
    var
        BankStatementServiceSetupPage: TestPage 1450;
    begin
        // Setup
        Initialize();
    ...
    var
        MSYodleeBankServiceSetup: TestPage 1450;
    begin
        // Setup
        Initialize();
    ...
    var
        MSYodleeBankServiceSetup: Record 1450;
        BankAccountListPage: TestPage 371;
    begin
        // Setup
        Initialize();
    ...
    var
        BankAccount: Record 270;
        NonLinkedBankAccount: Record 270;
        MSYodleeBankAccLink: Record 1451;
        BankAccountList: TestPage 371;
    begin
        // Setup
    ...
    begin
        ...
        Assert.IsFalse(BankAccount.FINDFIRST(), 'Linked bank accounts exist');
        Assert.IsFalse(MSYodleeBankAccLink.FINDFIRST(), 'Linked Yodlee accounts exist');
    ...
    var
        ...
        MSYodleeBankServiceSetup: Record 1450;
        PmtReconJnl: TestPage 1290;
        PmtReconciliationJournals: TestPage 1294;
    begin
        // Setup
        Initialize();
        SetupForOnlineImportingOfTransactions(MSYodleeBankServiceSetup, BankAccount);
    ...
    var
        BankAccount: Record 270;
        LibraryERM: Codeunit 131300;
        BankAccLinkingMockEvents: Codeunit 132470;
        BankAccountCard: TestPage 370;
    begin
        // Setup
        Initialize();
    ...
    var
        MSYodleeBankServiceSetupRec: Record 1450;
        MSYodleeServiceMgt: Codeunit 1450;
        MSYodleeBankServiceSetupPage: TestPage 1450;
        UserName: Text[250];
        Password: Text;
    ...
    var
        ApplicationAreaSetupRecord: Record 9178;
        LibraryApplicationArea: Codeunit 131102;
        MSYodleeBankServiceSetupPage: TestPage 1450;
    begin
    ...
    local procedure MakeMsYodleeBankAccLink(var MSYodleeBankAccLink: Record 1451; BankAccount: Record 270; OnlineBankID: Text[250]; OnlineBankAccountID: Text[250]);
    begin
    ...
    local procedure VerifyPmtReconJnlWithOnlineTransactions(PmtReconJnl: TestPage 1290);
    begin
    ...
    var
        TempMSYodleeBankAccLink: Record 1451 temporary;
        GeneralLedgerSetup: Record 98;
        MSYodleeServiceMgt: Codeunit 1450;
    begin
        GeneralLedgerSetup.GET();
    ...
    local procedure UpdateBankAccountLink(var BankAccount: Record 270);
    var
        BankAccountList: TestPage 371;
    begin
        CreateLinkedBankAccount(BankAccount);
    ...
    local procedure UpdateBankAccountPromptsMissingLink(var BankAccount: Record 270);
    var
        BankAccountList: TestPage 371;
    begin
        CreateLinkedBankAccount(BankAccount);
    ...
    [ModalPageHandler]
    procedure BankLinkingActionHandlerStepTwo(var BankAccountList: TestPage 371);
    var
        BankAccountNo: Variant;
    begin
        LibraryVariableStorage.Dequeue(BankAccountNo);
    ...
    [ModalPageHandler]
    procedure BankAccountCardHandler(var BankAccountCard: TestPage 370);
    begin
    ...
    local procedure OpenPmtReconJnl(BankAccRecon: Record 273; var PmtReconJnl: TestPage 1290);
    var
        PmtReconciliationJournals: TestPage 1294;
    begin
        PmtReconciliationJournals.OPENVIEW();
