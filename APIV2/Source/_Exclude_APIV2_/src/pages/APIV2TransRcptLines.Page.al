...
page 30209 "APIV2 - Trans. Rcpt. Lines"
{
    DelayedInsert = true;
    APIVersion = 'v2.0';
    EntityCaption = 'Transfer Receipt Line';
    EntitySetCaption = 'Transfer Receipt Lines';
    PageType = API;
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Transfer Receipt Line");
                }
            }
        }
    }
