...
page 30035 "APIV2 - Income Statement"
{
    ...
    Extensible = false;
    ODataKeyFields = Id;
    AboutText = 'Provides access to income statement data, including revenues, expenses, net change, and account breakdowns over specified periods. Supports GET operations for financial analysis, automated reporting, and integration with external business intelligence or management dashboards to deliver timely profitability insights.';
