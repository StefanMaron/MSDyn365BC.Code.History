...
page 30212 "APIV2 - Sales Qt. Archives"
{
    APIVersion = 'v2.0';
    EntityCaption = 'Sales Quote Archive';
    EntitySetCaption = 'Sales Quote Archives';
    ...
    InsertAllowed = false;
    ModifyAllowed = false;
    EntityName = 'salesQuoteArchive';
    EntitySetName = 'salesQuoteArchives';
        ...
        area(Content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Sales Quote Archive");
                }
                part(salesQuoteArchiveLines; "APIV2 - Sales Qt. Arch. Lines")
                {
                    Caption = 'Lines';
                    EntityName = 'salesQuoteArchiveLine';
                    EntitySetName = 'salesQuoteArchiveLines';
                ...
                part(pdfDocument; "APIV2 - PDF Document")
                {
                    ...
                    SubPageLink = "Document Id" = field(SystemId), "Document Type" = const("Sales Archive Quote");
                }
