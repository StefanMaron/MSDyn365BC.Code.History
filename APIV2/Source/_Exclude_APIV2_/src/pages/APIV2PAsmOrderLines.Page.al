...
page 30227 "APIV2 - P. Asm. Order Lines"
{
    DelayedInsert = true;
    APIVersion = 'v2.0';
    EntityCaption = 'Posted Assembly Order Line';
    EntitySetCaption = 'Posted Assembly Order Lines';
    PageType = API;
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Posted Assembly Order Line");
                }
            }
        }
    }
