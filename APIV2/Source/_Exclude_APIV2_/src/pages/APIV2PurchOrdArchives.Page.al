...
page 30218 "APIV2 - Purch. Ord. Archives"
{
    APIVersion = 'v2.0';
    EntityCaption = 'Purchase Order Archive';
    EntitySetCaption = 'Purchase Order Archives';
    ...
    InsertAllowed = false;
    ModifyAllowed = false;
    EntityName = 'purchaseOrderArchive';
    EntitySetName = 'purchaseOrderArchives';
        ...
        area(Content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Purchase Order Archive");
                }
                part(purchaseOrderArchiveLines; "APIV2 - P. Ord. Arch. Lines")
                {
                    Caption = 'Lines';
                ...
                part(pdfDocument; "APIV2 - PDF Document")
                {
                    ...
                    SubPageLink = "Document Id" = field(SystemId), "Document Type" = const("Purchase Archive Order");
                }
