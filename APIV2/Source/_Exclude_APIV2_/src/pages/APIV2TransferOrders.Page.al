...
page 30204 "APIV2 - Transfer Orders"
{
    APIVersion = 'v2.0';
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field(lastShipmentNumber; Rec."Last Shipment No.")
                {
                    Caption = 'Last Shipment No.';
                    Editable = false;
                }
                field(lastReceiptNumber; Rec."Last Receipt No.")
                {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Transfer Order");
                }
                part(transferOrderLines; "APIV2 - Trans. Order Lines")
                {
                    Caption = 'Lines';
                ...
                part(pdfDocument; "APIV2 - PDF Document")
                {
                    ...
                    SubPageLink = "Document Id" = field(SystemId), "Document Type" = const("Transfer Order");
                }
