...
page 30222 "APIV2 - P. Ret. Ord. Archives"
{
    APIVersion = 'v2.0';
    EntityCaption = 'Purchase Return Order Archive';
    EntitySetCaption = 'Purchase Return Order Archives';
    ...
    InsertAllowed = false;
    ModifyAllowed = false;
    EntityName = 'purchaseReturnOrderArchive';
    EntitySetName = 'purchaseReturnOrderArchives';
        ...
        area(Content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Purchase Return Order Archive");
                }
                part(purchaseReturnOrderArchiveLines; "APIV2 - P. Ret. Ord. A. Lines")
                {
                    Caption = 'Lines';
                    EntityName = 'purchaseReturnOrderArchiveLine';
                    EntitySetName = 'purchaseReturnOrderArchiveLines';
                    SubPageLink = "Document Type" = const("Return Order"), "Document No." = field("No."), "Doc. No. Occurrence" = field("Doc. No. Occurrence"), "Version No." = field("Version No.");
                }
                part(pdfDocument; "APIV2 - PDF Document")
                {
                    ...
                    SubPageLink = "Document Id" = field(SystemId), "Document Type" = const("Purchase Archive Return");
                }
