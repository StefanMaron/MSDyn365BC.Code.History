...
page 30003 "APIV2 - Bl. Purch. Orders"
{
    APIVersion = 'v2.0';
    EntityCaption = 'Blanket Purchase Order';
    EntitySetCaption = 'Blanket Purchase Orders';
    ...
    Extensible = false;
    AboutText = 'Exposes blanket purchase order documents for long-term procurement agreements, including vendor details, order status, delivery and payment information, addresses, and currency. Supports read-only (GET) operations for framework supplier contracts and procurement planning with external platforms.';
        ...
        area(Content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Blanket Purchase Order");
                }
                part(blanketPurchaseOrderLines; "APIV2 - Bl. Purch. Ord. Lines")
                {
                    Caption = 'Lines';
                ...
                part(pdfDocument; "APIV2 - PDF Document")
                {
                    ...
                    SubPageLink = "Document Id" = field(SystemId), "Document Type" = const("Blanket Purchase Order");
                }
