...
page 30084 "APIV2 - Purch. Cr. Memo Lines"
{
    ...
    begin
        GraphMgtPurchCrMemo.PropagateDeleteLine(Rec);
    end;
    ...
    begin
        GraphMgtPurchCrMemo.PropagateInsertLine(Rec, TempFieldBuffer);
    end;

    trigger OnModifyRecord(): Boolean
    begin
        GraphMgtPurchCrMemo.PropagateModifyLine(Rec, TempFieldBuffer);
    end;
