...
page 30251 "APIV2 - Sales Ret. Orders"
{
    APIVersion = 'v2.0';
    ...
    Extensible = false;
    AboutText = 'Exposes sales return order documents for processing customer returns, including customer details, return status, delivery and payment information, addresses, and currency. Supports read-only (GET) operations for customer returns and credit processing with external platforms.';
        ...
        area(Content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = field(SystemId), "Parent Type" = const("Sales Return Order");
                }
                part(salesReturnOrderLines; "APIV2 - Sales Ret. Ord. Lines")
                {
                    Caption = 'Lines';
                ...
                part(pdfDocument; "APIV2 - PDF Document")
                {
                    ...
                    SubPageLink = "Document Id" = field(SystemId), "Document Type" = const("Sales Return Order");
                }
