codeunit 139808 "APIV2 - Tax Groups E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL('', Page::"APIV2 - Tax Groups", ServiceNameTxt);
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(TaxGroupId, Page::"APIV2 - Tax Groups", ServiceNameTxt);
        LibraryGraphMgt.GetFromWebService(ResponseText, TargetURL);
