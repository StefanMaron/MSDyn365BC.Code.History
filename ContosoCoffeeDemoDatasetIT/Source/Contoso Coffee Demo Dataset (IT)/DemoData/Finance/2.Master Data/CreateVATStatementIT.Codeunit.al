...
codeunit 12229 "Create VAT Statement IT"
{
    ...
    begin
        ...
        ContosoVatStatementIT.InsertVatStatementLine(VATCommTemplateName(), DefaultStatementNameLbl, 1400000, '6', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", VATStatementLine."Gen. Posting Type"::Sale, CreateVATPostingGroups.Domestic(), CreateVATPostingGroups.NoVAT(), '', Enum::"VAT Statement Line Amount Type"::"Base", VATStatementLine."Calculate with"::"Opposite Sign", true, VATStatementLine."Print with"::Sign, SalesNoVATLbl);
        ...
        ContosoVatStatementIT.InsertVatStatementLine(VATCommTemplateName(), DefaultStatementNameLbl, 1550000, '14', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", VATStatementLine."Gen. Posting Type"::Purchase, CreateVATPostingGroups.Domestic(), CreateVATPostingGroups.NoVAT(), '', Enum::"VAT Statement Line Amount Type"::"Base", VATStatementLine."Calculate with"::"Opposite Sign", true, VATStatementLine."Print with"::Sign, PurchasesNonVATLbl);
    ...
    begin
        if (Rec."Statement Template Name" = CreateVATStatement.VATTemplateName()) and (Rec."Statement Name" = DefaultStatementNameLbl) then
            case Rec."Line No." of
                ...
                370000:
                    ValidateRecordFields(Rec, '1340', Enum::"VAT Statement Line Type"::"VAT Entry Totaling", '', Enum::"General Posting Type"::Sale, CreateVATPostingGroups.Domestic(), CreateVATPostingGroups.NoVAT(), '', Enum::"VAT Statement Line Amount Type"::"Base", VATStatementLine."Calculate with"::Sign, false, VATStatementLine."Print with"::Sign, NonVatLiableSalesDomesticLbl);
                380000:
