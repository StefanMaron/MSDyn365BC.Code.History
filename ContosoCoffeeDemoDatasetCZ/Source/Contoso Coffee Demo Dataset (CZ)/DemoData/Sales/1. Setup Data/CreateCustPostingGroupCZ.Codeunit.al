...
codeunit 31205 "Create Cust. Posting Group CZ"
{
    SingleInstance = true;
    ...
    begin
        case Rec.Code of
            CreateCustomerPostingGrp.Domestic():
                ValidateCustomerPostingGroup(Rec, CreateGLAccountCZ.DomesticCustomersReceivables(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.ContractualPenaltiesAndInterests(), CreateGLAccountCZ.ExchangeLossesRealized(), CreateGLAccountCZ.ExchangeGainsRealized(), CreateGLAccountCZ.Otherfinancialexpenses(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otheroperatingexpenses(), CreateGLAccountCZ.Otheroperatingexpenses());
            CreateCustomerPostingGrp.EU():
                ValidateCustomerPostingGroup(Rec, CreateGLAccountCZ.EUCustomersReceivables(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.ContractualPenaltiesAndInterests(), CreateGLAccountCZ.ExchangeLossesRealized(), CreateGLAccountCZ.ExchangeGainsRealized(), CreateGLAccountCZ.Otherfinancialexpenses(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otheroperatingexpenses(), CreateGLAccountCZ.Otheroperatingexpenses());
            CreateCustomerPostingGrp.Foreign():
                ValidateCustomerPostingGroup(Rec, CreateGLAccountCZ.ForeignCustomersOutsideEUReceivables(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.ContractualPenaltiesAndInterests(), CreateGLAccountCZ.ExchangeLossesRealized(), CreateGLAccountCZ.ExchangeGainsRealized(), CreateGLAccountCZ.Otherfinancialexpenses(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otherfinancialrevenues(), CreateGLAccountCZ.Otheroperatingexpenses(), CreateGLAccountCZ.Otheroperatingexpenses());
        end;
    end;
