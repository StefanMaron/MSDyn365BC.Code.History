codeunit 31189 "Create Vat Posting Groups CZ"
{
    ...
    begin
        ...
        ContosoPostingSetupCZ.InsertVATPostingSetup(CreateVATPostingGroups.EU(), VAT12I(), VAT12I(), 12, Enum::"Tax Calculation Type"::"Normal VAT", EU(), false, "VAT Rate CZL"::Reduced);
        ContosoPostingSetupCZ.InsertVATPostingSetup(CreateVATPostingGroups.EU(), VAT12S(), VAT12S(), 12, Enum::"Tax Calculation Type"::"Normal VAT", EU(), true, "VAT Rate CZL"::Reduced);
        ContosoPostingSetupCZ.InsertVATPostingSetup(CreateVATPostingGroups.EU(), VAT21I(), VAT21I(), 21, Enum::"Tax Calculation Type"::"Normal VAT", EU(), false, "VAT Rate CZL"::Base);
        ContosoPostingSetupCZ.InsertVATPostingSetup(CreateVATPostingGroups.EU(), VAT21S(), VAT21S(), 21, Enum::"Tax Calculation Type"::"Normal VAT", EU(), true, "VAT Rate CZL"::Base);
    ...
    begin
        ...
        ContosoPostingSetupCZ.UpdateVATPostingSetup(CreateVATPostingGroups.EU(), VAT12I(), CreateGLAccountCZ.OutputVAT12(), CreateGLAccountCZ.InputVAT12(), '');
        ContosoPostingSetupCZ.UpdateVATPostingSetup(CreateVATPostingGroups.EU(), VAT12S(), CreateGLAccountCZ.OutputVAT12(), CreateGLAccountCZ.InputVAT12(), '');
        ContosoPostingSetupCZ.UpdateVATPostingSetup(CreateVATPostingGroups.EU(), VAT21I(), CreateGLAccountCZ.OutputVAT21(), CreateGLAccountCZ.InputVAT21(), '');
        ContosoPostingSetupCZ.UpdateVATPostingSetup(CreateVATPostingGroups.EU(), VAT21S(), CreateGLAccountCZ.OutputVAT21(), CreateGLAccountCZ.InputVAT21(), '');
