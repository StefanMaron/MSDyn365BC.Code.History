...
codeunit 5223 "Create Acc. Schedule Name"
{
    ...
    var
        ...
        ReducedTrialBalanceDataInternalDescriptionLbl: Label 'Nine-row layout summarizing key trial balance metrics with posting account ranges for revenue, cost, operating expenses, and other expenses. This layout includes formulas for gross margin, operating margin, and their respective percentage, income before interest and tax, all based on net change for period performance. Useful for quick profitability checks, margin analysis, and providing financial insights. Internal row definition used for providing data for the Reduced Trial Balance Info Part.', MaxLength = 500;
