codeunit 4770 "Create Mfg Item"
{
    ...
    begin
        ...
        InsertData('SP-SCM1009', XAirpotTok, AdjustManufacturingData.AdjustPrice(399), AdjustManufacturingData.AdjustPrice(0), '', '', 0,
                    ManufacturingDemoDataSetup."Retail Code", ManufacturingDemoDataSetup."Finished Code", enum::"Costing Method"::Standard, enum::"Flushing Method"::Manual, '', 10, '', 0,
                    Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '', Enum::"Replenishment System"::"Prod. Order", 0.001,
        ...
        InsertData('SP-SCM1008', XAirpotLiteTok, AdjustManufacturingData.AdjustPrice(349), AdjustManufacturingData.AdjustPrice(0), '', '', 0,
                    ManufacturingDemoDataSetup."Retail Code", ManufacturingDemoDataSetup."Finished Code", enum::"Costing Method"::Standard, enum::"Flushing Method"::Manual, '', 10, '', 0,
                    Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '', Enum::"Replenishment System"::"Prod. Order", 1,
        ...
        InsertData('SP-BOM2000', XReservoirAssyTok, AdjustManufacturingData.AdjustPrice(0), AdjustManufacturingData.AdjustPrice(0), '', '', 0, '', '',
                    enum::"Costing Method"::FIFO, enum::"Flushing Method"::Manual, '', 10, '', 0, Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '',
                    Enum::"Replenishment System"::"Prod. Order", 1, '<1W>', 0, XPartsTok, '', ManufacturingDemoFiles.GetNoPicture(), '');
        ...
        InsertData('SP-BOM2001', XReservoirTok, AdjustManufacturingData.AdjustPrice(0), AdjustManufacturingData.AdjustPrice(14.94), '81000', '266666', 0, '', '',
                    enum::"Costing Method"::FIFO, enum::"Flushing Method"::Manual, '', 0, '', 0, Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '',
                    Enum::"Replenishment System"::Purchase, 1, '<1W>', 0, XPartsTok, '', ManufacturingDemoFiles.GetNoPicture(), '');
    ...
    begin
        ...
        InsertData('SP-SCM1011', XAirpotDuoTok, AdjustManufacturingData.AdjustPrice(499), AdjustManufacturingData.AdjustPrice(0), '', '', 0,
                    ManufacturingDemoDataSetup."Retail Code", ManufacturingDemoDataSetup."Finished Code", enum::"Costing Method"::Specific, enum::"Flushing Method"::Manual, '', 10, '', 0,
                    Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '', Enum::"Replenishment System"::"Prod. Order", 1, '<1W>', 0,
                    XCMCommerTok, XSNPRODTok, ManufacturingDemoFiles.GetAirPotDuoPicture(), '');  //Item Tracking SNALL
        ...
        InsertData('SP-BOM1207', XIoTSensorTok, AdjustManufacturingData.AdjustPrice(0), AdjustManufacturingData.AdjustPrice(8.88), '81000', '2777775', 0, '', '',
                    enum::"Costing Method"::FIFO, enum::"Flushing Method"::Manual, '', 0, '', 0, Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '',
                    Enum::"Replenishment System"::Purchase, 1, '<1W>', 0, XPartsTok, XSNPRODTok, ManufacturingDemoFiles.GetNoPicture(), '');  //Item Tracking SNALL
    ...
    begin
        ...
        InsertData('SP-SCM1004', XAutoDripTok, AdjustManufacturingData.AdjustPrice(179), AdjustManufacturingData.AdjustPrice(0), '', '', 0,
                    ManufacturingDemoDataSetup."Retail Code", ManufacturingDemoDataSetup."Finished Code", enum::"Costing Method"::FIFO, enum::"Flushing Method"::Backward, '', 10, '', 0,
                    Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '', Enum::"Replenishment System"::"Prod. Order", 1, '<1W>', 0,
        ...
        InsertData('SP-BOM1301', XHousingAutoDripTok, AdjustManufacturingData.AdjustPrice(0), AdjustManufacturingData.AdjustPrice(32.22), '81000', '4577-AA', 0, '', '',
                    enum::"Costing Method"::FIFO, enum::"Flushing Method"::Backward, '', 0, '', 0, Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '',
                    Enum::"Replenishment System"::Purchase, 1, '<1W>', 0, XPartsTok, '', ManufacturingDemoFiles.GetNoPicture(), '');
        ...
        InsertData('SP-BOM1303', XButtonTok, AdjustManufacturingData.AdjustPrice(0), AdjustManufacturingData.AdjustPrice(2.89), '81000', 'T5555-FF', 0, '', '',
                    enum::"Costing Method"::FIFO, enum::"Flushing Method"::Forward, '', 0, '', 0, Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '',
                    Enum::"Replenishment System"::Purchase, 1, '<1W>', 0, XPartsTok, '', ManufacturingDemoFiles.GetNoPicture(), '');
    ...
    begin
        ...
        InsertData('SP-SCM1006', XAutoDripLiteTok, AdjustManufacturingData.AdjustPrice(149), AdjustManufacturingData.AdjustPrice(0), '', '', 0,
                    ManufacturingDemoDataSetup."Retail Code", ManufacturingDemoDataSetup."Finished Code", enum::"Costing Method"::FIFO, enum::"Flushing Method"::Manual, '', 10, '', 0,
                    Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '', Enum::"Replenishment System"::"Prod. Order", 1,
        ...
        InsertData('SP-SCM3001', XPaintBlackTok, AdjustManufacturingData.AdjustPrice(0), AdjustManufacturingData.AdjustPrice(1.6), '81000', '4599-B1', 0, '', '',
                    enum::"Costing Method"::FIFO, enum::"Flushing Method"::Manual, XCANTok, 0, '', 0, Enum::"Reordering Policy"::"Lot-for-Lot", true, Enum::"Manufacturing Policy"::"Make-to-Stock", 0, 0, 0, 0, 0, '',
                    Enum::"Replenishment System"::Purchase, 0.001, '<1W>', 0, XPartsTok, '', ManufacturingDemoFiles.GetNoPicture(), '');
    ...
    local procedure InsertData("No.": Code[20]; Description: Text[30]; UnitPrice: Decimal; LastDirectCost: Decimal; VendorNo: Code[20]; VendorItemNo: Text[20];
                                ...
                                ReorderQty: Decimal; CategoryCode: Code[20]; ItemTrackingCode: Code[10]; ItempPicTempBlob: Codeunit "Temp Blob"; ItemPictureDescription: Text)
    var
        Item: Record Item;
