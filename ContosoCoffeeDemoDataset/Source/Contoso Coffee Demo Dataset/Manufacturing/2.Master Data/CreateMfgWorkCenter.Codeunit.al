codeunit 4778 "Create Mfg Work Center"
{
    ...
    begin
        ...
        InsertMachineCenter('110', XFlushManualTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
        InsertMachineCenter('120', XFlushBackTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Backward);
        InsertMachineCenter('130', XFlushForwardTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Forward);
        ...
        InsertMachineCenter('210', XPackingtable1Tok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
        InsertMachineCenter('220', XPackingtable2Tok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
        InsertMachineCenter('230', XPackingMachineTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Backward);
        ...
        InsertMachineCenter('310', XPaintingCabinTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
        InsertMachineCenter('330', XDryingCabinTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
        InsertMachineCenter('340', XPaintinginspectionTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
        ...
        InsertMachineCenter('410', XDrillingmachineTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
        InsertMachineCenter('420', XCNCmachineTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
        InsertMachineCenter('430', XMachinedeburrTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
        InsertMachineCenter('440', XMachineinspectionTok, WorkCenterCode, 0, '', 1, 100, 0, 0, ManufacturingDemoDataSetup."Manufact Code", Enum::"Flushing Method Routing"::Manual);
