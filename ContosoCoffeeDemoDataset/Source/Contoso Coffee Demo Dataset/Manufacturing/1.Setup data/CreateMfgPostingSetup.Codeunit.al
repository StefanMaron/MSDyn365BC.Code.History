codeunit 4768 "Create Mfg Posting Setup"
{
    ...
    begin
        ...
        InsertGenProdPostingGroup(ManufacturingDemoDataSetup."Retail Code", XCapacitiesTok, DefVATPostingGr);
    ...
    begin
        if not GeneralPostingSetup.Get(ManufacturingDemoDataSetup."Domestic Code", ManufacturingDemoDataSetup."Retail Code") then;
            InsertGeneralPostingSetup(ManufacturingDemoDataSetup."Domestic Code", ManufacturingDemoDataSetup."Retail Code", '', '', '', '', '', '', '', '', '');
    ...
    begin
        ...
        case "Income/Balance" of 
            "Income/Balance"::"Income Statement": GLAccount.Validate("Income/Balance", 0);
            "Income/Balance"::"Balance Sheet": GLAccount.Validate("Income/Balance", 1);
        end;
