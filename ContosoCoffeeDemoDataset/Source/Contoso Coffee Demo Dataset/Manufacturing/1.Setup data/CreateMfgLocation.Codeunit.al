codeunit 4764 "Create Mfg Location"
{
    ...
    begin
        ...
        If ManufacturingDemoDataSetup."Manufacturing Location" <> '' then
            InsertData(ManufacturingDemoDataSetup."Manufacturing Location", XMainWarehouseTok, '', XUKCampusBldg5Tok, '', '', '', '', '', '', '', false, false, false, false, '<0D>', '<0D>');
    end;

    var
        ManufacturingDemoDataSetup: Record "Manufacturing Demo Data Setup";
        XUKCampusBldg5Tok: Label 'UK Campus Bldg 5', MaxLength = 30;
        XMainWarehouseTok: Label 'Main Warehouse', MaxLength = 30;
