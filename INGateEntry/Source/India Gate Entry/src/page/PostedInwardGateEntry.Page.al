page 18614 "Posted Inward Gate Entry"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(PostedInwardGateEntrySubform; "Posted Inward Gate SubForm")
            {
                ApplicationArea = Basic, Suite;
        ...
        area(navigation)
        {
            group("&Gate Entry")
            {
                ...
                action(List)
                {
                    ...
                    RunObject = Page "Posted Inward Gate Entry List";
                    ShortCutKey = 'Shift+Ctrl+L';
                    ToolTip = 'View Posted Inward Gate Entry List.';
                }
            }
        }
    }
