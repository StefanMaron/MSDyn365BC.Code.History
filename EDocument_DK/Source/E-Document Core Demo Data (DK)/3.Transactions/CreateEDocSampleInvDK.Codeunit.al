...
codeunit 13671 "Create E-Doc Sample Inv. DK"
{
    Access = Internal;
    ...
    begin
        ...
        EDocSamplePurchaseInvoice.AddLine(
            Enum::"Purchase Line Type"::" ", '', CreateDemoEDocsDK.GetShipmentDHLInvoiceDescription(), 1, 60, '', CreateCommonUnitOfMeasure.Piece());
        EDocSamplePurchaseInvoice.Generate();

        EDocSamplePurchaseInvoice.AddInvoice(CreateVendor.DomesticWorldImporter(), '108240', BasicCoffeeEquipmentLbl);
        EDocSamplePurchaseInvoice.AddLine(
