...
codeunit 148200 "Test Request Creation"
{
    ...
    begin
        ...
        // ProjectArg = 'Sandbox'
        AssertThat.AreEqual(GetApiKey(APIMgmt), StagApiKey, IncorrectValueErr);
    ...
    begin
        ...
        // ProjectArg = 'Prod'
        AssertThat.AreEqual(ProdApiKey, GetApiKey(APIMgmt), IncorrectValueErr);
    ...
    [NonDebuggable]
    local procedure GetApiKey(APIMgmt: Codeunit "B2Brouter Api Management"): Text
    begin
        exit(APIMgmt.GetApiKey().Unwrap())
    end;
