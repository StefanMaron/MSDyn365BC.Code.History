codeunit 19012 "Migration Data Sensitivity"
{
    ...
    begin
        SetTableFieldsToNormal(Database::"India Data Transfer Statistics");
        SetTableFieldsToNormal(Database::"India Migration Company");
        SetTableFieldsToNormal(Database::"India Migration Worksheet");
    end;
