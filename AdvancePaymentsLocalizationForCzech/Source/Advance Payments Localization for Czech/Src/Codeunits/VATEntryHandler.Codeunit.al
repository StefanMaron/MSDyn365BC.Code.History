...
codeunit 31011 "VAT Entry Handler CZZ"
{
    ...
    local procedure FindVATEntriesOfPurchAdvLettersOnAfterGetDocumentVATEntries(var VATLCYCorrectionBufferCZL: Record "VAT LCY Correction Buffer CZL" temporary; DocumentNo: Code[20]; PostingDate: Date)
    var
    ...
    begin
        ...
        if VATEntry.FindSet() then
            repeat
                if not VATLCYCorrectionBufferCZL.Get(VATEntry."Entry No.") then
