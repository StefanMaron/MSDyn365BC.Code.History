...
codeunit 139763 "Email Logging Tests"
{
    ...
    begin
        ...
        EmailLoggingMessage.GetToRecipients(ToRecipients);
        EmailLoggingMessage.GetCcRecipients(CcRecipients);
        EmailLoggingMessage.GetToAndCcRecipients(ToAndCcRecipients);
        Assert.AreEqual(1, ToRecipients.Count(), 'Unexpected toRecipients count');
        Assert.AreEqual(1, CcRecipients.Count(), 'Unexpected ccRecipients count');
        Assert.AreEqual(2, ToAndCcRecipients.Count(), 'Unexpected toAndCcRecipients count');
        Assert.AreEqual(ToRecipient, ToRecipients.Get(1), 'Unexpected toRecipient');
        Assert.AreEqual(CcRecipient, CcRecipients.Get(1), 'Unexpected ccRecipient');
        Assert.AreEqual(ToRecipient, ToAndCcRecipients.Get(1), 'Unexpected toAndCcRecipient #1');
        Assert.AreEqual(CcRecipient, ToAndCcRecipients.Get(2), 'Unexpected toAndCcRecipient #2');
    end;
