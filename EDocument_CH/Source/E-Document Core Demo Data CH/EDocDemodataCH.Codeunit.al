...
codeunit 11670 "EDoc. Demodata CH"
{
    Access = Internal;
    ...
    begin
        ...
        EDocumentModuleSetup."Recurring Expense G/L Acc. No" := CreateCHGLAccounts.SubcontrOfSpOperations();
        EDocumentModuleSetup."Delivery Expense G/L Acc. No" := CreateCHGLAccounts.TransportCosts();
