...
report 6789 "WHT Purch. - Cr. Memo"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src\Purchase\Report\WHTPurchCrMemo.rdlc';
        ...
        dataitem("Purch. Cr. Memo Hdr."; "Purch. Cr. Memo Hdr.")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PaytoVendNo_PurchTaxCrMemoHdr; "Purch. Cr. Memo Hdr."."Pay-to Vendor No.")
                    {
                    }
                    column(BuyfromVendNo_PurchTaxCrMemoHdr; "Purch. Cr. Memo Hdr."."Buy-from Vendor No.")
                    {
                    }
                    column(FormatedDocumentDate; Format("Purch. Cr. Memo Hdr."."Document Date", 0, 4))
                    {
                    }
                    column(VATNoText; VATNoText)
                    {
                    }
                    column(VATRegNo_PurchTaxCrMemoHdr; "Purch. Cr. Memo Hdr."."VAT Registration No.")
                    {
                    }
                    column(No_CopyLoop; "Purch. Cr. Memo Hdr."."No.")
                    {
                    }
                    ...
                    column(YourRef_PurchTaxCrMemoHdr; "Purch. Cr. Memo Hdr."."Your Reference")
                    {
                    }
                    ...
                    column(FormatedPostingDate; Format("Purch. Cr. Memo Hdr."."Posting Date"))
                    {
                    }
                    column(PricesIncluVAT_PurchTaxCrMemoHdr; "Purch. Cr. Memo Hdr."."Prices Including VAT")
                    {
                    }
                    column(ReturnOrderNo_PurchTaxCrMemoHdr; "Purch. Cr. Memo Hdr."."Return Order No.")
                    {
                    }
                    ...
                    column(PaytoVendNo_PurchTaxCrMemoHdrCaption; "Purch. Cr. Memo Hdr.".FieldCaption("Pay-to Vendor No."))
                    {
                    }
                    column(BuyfromVendNo_PurchTaxCrMemoHdrCaption; "Purch. Cr. Memo Hdr.".FieldCaption("Buy-from Vendor No."))
                    {
                    }
                    column(PricesIncluVAT_PurchTaxCrMemoHdrCaption; "Purch. Cr. Memo Hdr.".FieldCaption("Prices Including VAT"))
                    {
                    }
                    ...
                    dataitem("Purch. Cr. Memo Line"; "Purch. Cr. Memo Line")
                    {
                        ...
                        column(PurchTaxCrMemoHdrVATBaseDis0; "Purch. Cr. Memo Hdr."."VAT Base Discount %" <> 0)
                        {
                        }
                        column(CurrFactor_PurchTaxCrMemoHdr; "Purch. Cr. Memo Hdr."."Currency Factor")
                        {
                        }
                        ...
                        column(CurrCode_PurchTaxCrMemoHdr; "Purch. Cr. Memo Hdr."."Currency Code")
                        {
                        }
            ...
            begin
                ...
                WithholdingTaxMgmt.InitTextVariable();
                WithholdingTaxMgmt.FormatNoText(AmountLangA, "Amount Including VAT", "Currency Code");
                AmountLangB[1] := '';
                AmountLangB[2] := '';
