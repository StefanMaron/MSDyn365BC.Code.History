...
report 6788 "WHT Purch. - Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src\Purchase\Report\WHTPurchInvoice.rdlc';
        ...
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BuyfromVendNo_PurchTaxInvHdr; "Purch. Inv. Header"."Buy-from Vendor No.")
                    {
                    }
                    column(BuyfromVendNo_PurchTaxInvHdrCaption; "Purch. Inv. Header".FieldCaption("Buy-from Vendor No."))
                    {
                    }
                    ...
                    column(PaytoVendNo_PurchTaxInvHdr; "Purch. Inv. Header"."Pay-to Vendor No.")
                    {
                    }
                    column(FormatedDocumentDate; Format("Purch. Inv. Header"."Document Date", 0, 4))
                    {
                    }
                    column(VATNoText; VATNoText)
                    {
                    }
                    column(VATRegNo_PurchTaxInvHdr; "Purch. Inv. Header"."VAT Registration No.")
                    {
                    }
                    column(FormatedDueDate; Format("Purch. Inv. Header"."Due Date"))
                    {
                    }
                    ...
                    column(YourReference_PurchTaxInvHdr; "Purch. Inv. Header"."Your Reference")
                    {
                    }
                    column(OrderNoText; OrderNoText)
                    {
                    }
                    column(OrderNo_PurchTaxInvHdr; "Purch. Inv. Header"."Order No.")
                    {
                    }
                    ...
                    column(FormatedPostingDate; Format("Purch. Inv. Header"."Posting Date"))
                    {
                    }
                    column(PricesIncluVAT_PurchTaxInvHdr; "Purch. Inv. Header"."Prices Including VAT")
                    {
                    }
                    ...
                    column(PaytoVendNo_PurchTaxInvHdrCaption; "Purch. Inv. Header".FieldCaption("Pay-to Vendor No."))
                    {
                    }
                    column(PricesIncluVAT_PurchTaxInvHdrCaption; "Purch. Inv. Header".FieldCaption("Prices Including VAT"))
                    {
                    }
                    ...
                    dataitem("Purch. Inv. Line"; "Purch. Inv. Line")
                    {
                        ...
                        column(ExternalDoNo_PurchTaxInvLine; "Purch. Inv. Header"."Vendor Invoice No.")
                        {
                        }
                        ...
                        column(PurchTaxInvHdrVATBaseDiscount0; "Purch. Inv. Header"."VAT Base Discount %" <> 0)
                        {
                        }
                        ...
                        column(CurrFactor_PurchTaxInvHdr; "Purch. Inv. Header"."Currency Factor")
                        {
                        }
                        ...
                        column(CurrCode_PurchTaxInvHdr; "Purch. Inv. Header"."Currency Code")
                        {
                        }
