codeunit 18022 "Import GST Use Case"
{
    procedure ImportUseCases(FolderName: Text)
    var
    ...
    var
        ...
        JsonText: Text;
    begin
        NavApp.GetResource(IndiaGSTResourcesLbl, IStream);
    ...
    var
        IndiaGSTResourcesLbl: Label 'IndiaGSTResources.json', Locked = true;
}