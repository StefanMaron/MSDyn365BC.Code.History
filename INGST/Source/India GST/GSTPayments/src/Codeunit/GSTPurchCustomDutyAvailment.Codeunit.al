codeunit 18253 "GST Purch CustomDuty Availment"
{
    ...
    local procedure FillGenJournalLineNonAvailmentFA(InvoicePostBuffer: Record "Invoice Post. Buffer"; var GenJournalLine: Record "Gen. Journal Line")
    begin
        GenJournalLine."FA Availment" := InvoicePostBuffer."FA Availment";
        GenJournalLine."FA Custom Duty Amount" := InvoicePostBuffer."FA Custom Duty Amount";
    end;
