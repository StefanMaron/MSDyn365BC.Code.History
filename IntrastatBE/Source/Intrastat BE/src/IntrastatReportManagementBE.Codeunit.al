codeunit 11346 IntrastatReportManagementBE
{
    ...
    begin
        ...
        if not DataExchDef.Get('INTRA-2022-BE-RCPT-S') then begin
        ...
        if not DataExchDef.Get('INTRA-2022-BE-RCPT-E') then begin
            TempBlob.CreateOutStream(XMLOutStream);
        ...
        if not DataExchDef.Get('INTRA-2022-BE-SHPT-S') then begin
            TempBlob.CreateOutStream(XMLOutStream);
        ...
        if not DataExchDef.Get('INTRA-2022-BE-SHPT-E') then begin
            TempBlob.CreateOutStream(XMLOutStream);
