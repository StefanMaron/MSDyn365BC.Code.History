codeunit 20038 "APIV1 - Send Sales Document"
{
    ...
    local procedure GetSendToEmailAddress(DocumentType: Option; DocumentNo: Code[20]; CustomerNo: Code[20]): Text[250]
    var
    ...
    local procedure GetDocumentEmailAddress(DocumentNo: Code[20]; DocumentType: Option): Text[250]
    var
