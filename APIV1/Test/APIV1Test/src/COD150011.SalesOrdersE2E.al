codeunit 150011 "APIV1 - Sales Orders E2E"
{
    ...
    var
        ...
        GraphContactIdFieldTxt: Label 'contactId', Locked = true;
    ...
    begin
        ...
        SalesHeader.Reset();
        SalesHeader.SetRange("Id", OrderId);
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(SalesHeader.Id, PAGE::"APIV1 - Sales Orders", OrderServiceNameTxt);
        LibraryGraphMgt.GetFromWebService(ResponseText, TargetURL);
    ...
    begin
        ...
        SalesHeader.Reset();
        SalesHeader.SetRange(Id, OrderId);
        Assert.IsTrue(SalesHeader.IsEmpty(), OrderStillExistsErr);
    ...
    var
        ...
        OrderJSON: Text;
    begin
        OrderJSON := LibraryGraphMgt.AddPropertytoJSON('', GraphContactIdFieldTxt, GraphIntegrationRecord."Graph ID");
