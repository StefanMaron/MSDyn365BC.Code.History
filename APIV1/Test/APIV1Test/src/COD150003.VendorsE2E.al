codeunit 150003 "APIV1 - Vendors E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(Vendor.Id, PAGE::"APIV1 - Vendors", ServiceNameTxt);
    ...
    begin
        ...
        IF Vendor.FIND('-') THEN
            REPEAT
                Assert.IsTrue(IntegrationRecord.GET(Vendor.Id), 'The vendor id should exist in the integration record table');
                Assert.AreEqual(
