codeunit 150034 "APIV1 - Sales Inv. Lines E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt
          .CreateTargetURLWithSubpage(
            ...
            PAGE::"APIV1 - Sales Invoices",
            InvoiceServiceNameTxt,
            GetLineSubURL(SalesHeader.Id, SalesLine."Line No.", InvoiceServiceLinesNameTxt));
        LibraryGraphMgt.PatchToWebService(TargetURL, InvoiceLineJSON, ResponseText);
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt
          .CreateTargetURLWithSubpage(
            ...
            PAGE::"APIV1 - Sales Invoices",
            InvoiceServiceNameTxt,
            GetLineSubURL(SalesHeader.Id, LineNo, InvoiceServiceLinesNameTxt));
        LibraryGraphMgt.PatchToWebService(TargetURL, InvoiceLineJSON, ResponseText);
