codeunit 150009 "Sales Invoices E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(SalesHeader.Id, PAGE::"APIV1 - Sales Invoices", InvoiceServiceNameTxt);
    ...
    begin
        ...
        Assert.AreNotEqual(DocumentId, SalesHeader.Id, CreditMemoIdErr);
        VerifyDraftSalesCreditMemo(SalesHeader.Id, TempSalesCrMemoEntityBuffer.Status::Draft);
    ...
    begin
        SalesHeader.SetRange(Id, DocumentId);
        Assert.IsFalse(SalesHeader.IsEmpty(), CannotFindDraftCreditMemoErr);
    ...
    var
        ...
        InvoiceJSON: Text;
    begin
        InvoiceJSON := LibraryGraphMgt.AddPropertytoJSON('', GraphContactIdFieldTxt, GraphIntegrationRecord."Graph ID");
