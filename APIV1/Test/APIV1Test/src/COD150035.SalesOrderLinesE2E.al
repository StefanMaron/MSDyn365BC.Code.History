codeunit 150035 "APIV1 - Sales Order Lines E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt
          .CreateTargetURLWithSubpage(
            ...
            PAGE::"APIV1 - Sales Orders",
            OrderServiceNameTxt,
            SalesInvLinesE2E.GetLineSubURL(SalesHeader.Id, SalesLine."Line No.", OrderServiceLinesNameTxt));
        LibraryGraphMgt.PatchToWebService(TargetURL, OrderLineJSON, ResponseText);
    ...
    begin
        ...
        Initialize();
        CreateOrderWithAllPossibleLineTypes(SalesHeader, ExpectedNumberOfLines);
        OrderId := IntegrationManagement.GetIdWithoutBrackets(SalesHeader.Id);
