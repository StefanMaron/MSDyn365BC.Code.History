codeunit 150029 "APIV1 - Purchase Invoices E2E"
{
    ...
    begin
        ...
        InvoiceIntegrationID := PurchaseHeader.Id;
    ...
    begin
        ...
        TempRecordField.SETRANGE(TableNo, DATABASE::"Purchase Header");
        TempRecordField.SETRANGE(FieldName, 'Due Date Modified');
        if TempRecordField.FINDFIRST() then
            LibraryUtility.AddTempField(TempIgnoredFieldsForComparison, TempRecordField."No.", DATABASE::"Purchase Header");
    ...
    begin
        ...
        IF PurchaseHeader.FIND('-') THEN
            REPEAT
                Assert.IsTrue(IntegrationRecord.GET(PurchaseHeader.Id), 'The PurchaseHeader id should exist in the integration record table');
                Assert.AreEqual(
    ...
    var
        ...
        InvoiceWithComplexJSON: Text;
    begin
        InvoiceJSON := CreateInvoiceJSON('vendorId', BuyFromVendor.Id, 'invoiceDate', InvoiceDate);
    ...
    begin
        ...
        Assert.IsFalse(PurchaseHeader.IsEmpty(), CannotFindDraftInvoiceErr);
