    ...
    begin
        case Rec."No." of
            ...
            CreateResource.Terry():
                ValidateRecordFields(Rec, CanberraLbl, 150, 165, 43.10345, 290, PostCode2600Lbl);
            CreateResource.Marty():
                ValidateRecordFields(Rec, CanberraLbl, 130, 143, 45, 260, PostCode2600Lbl);
            CreateResource.Lina():
                ValidateRecordFields(Rec, CanberraLbl, 170, 187, 46.57143, 350, PostCode2600Lbl);
        end;
    end;
