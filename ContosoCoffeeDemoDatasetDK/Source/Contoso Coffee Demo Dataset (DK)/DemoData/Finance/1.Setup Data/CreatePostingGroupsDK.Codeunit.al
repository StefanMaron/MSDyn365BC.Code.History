...
codeunit 13714 "Create Posting Groups DK"
{
    ...
    begin
        ...
        ContosoGenPostingSetup.InsertGeneralPostingSetup(CreatePostingGroups.DomesticPostingGroup(), CreatePostingGroups.RetailPostingGroup(), CreateDKGLAcc.Salesofgoodsandservicestoothercountries(), CreateDKGLAcc.Itempurchases(), CreateDKGLAcc.Iteminventoryadjustment(), CreateDKGLAcc.Itempurchases(), '', '', CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Costofgoodssold(), '', '');
        ...
        ContosoGenPostingSetup.InsertGeneralPostingSetup(CreatePostingGroups.DomesticPostingGroup(), CreatePostingGroups.ZeroPostingGroup(), CreateDKGLAcc.Salesofgoodsandservicestoothercountries(), CreateDKGLAcc.Itempurchases(), CreateDKGLAcc.Iteminventoryadjustment(), CreateDKGLAcc.Itempurchases(), '', '', CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Costofgoodssold(), '', '');

        ContosoGenPostingSetup.InsertGeneralPostingSetup(CreatePostingGroups.EUPostingGroup(), CreatePostingGroups.RetailPostingGroup(), CreateDKGLAcc.Eusalesofgoodsandservices(), CreateDKGLAcc.Itempurchases(), CreateDKGLAcc.Iteminventoryadjustment(), CreateDKGLAcc.Itempurchases(), '', '', CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Costofgoodssold(), '', '');
        ...
        ContosoGenPostingSetup.InsertGeneralPostingSetup(CreatePostingGroups.EUPostingGroup(), CreatePostingGroups.ZeroPostingGroup(), CreateDKGLAcc.Eusalesofgoodsandservices(), CreateDKGLAcc.Itempurchases(), CreateDKGLAcc.Iteminventoryadjustment(), CreateDKGLAcc.Itempurchases(), '', '', CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Costofgoodssold(), '', '');

        ContosoGenPostingSetup.InsertGeneralPostingSetup(CreatePostingGroups.ExportPostingGroup(), CreatePostingGroups.RetailPostingGroup(), CreateDKGLAcc.Domesticsalesofgoodsandservices(), CreateDKGLAcc.Itempurchases(), CreateDKGLAcc.Iteminventoryadjustment(), CreateDKGLAcc.Itempurchases(), '', '', CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Costofgoodssold(), '', '');
        ...
        ContosoGenPostingSetup.InsertGeneralPostingSetup(CreatePostingGroups.ExportPostingGroup(), CreatePostingGroups.ZeroPostingGroup(), CreateDKGLAcc.Domesticsalesofgoodsandservices(), CreateDKGLAcc.Itempurchases(), CreateDKGLAcc.Iteminventoryadjustment(), CreateDKGLAcc.Itempurchases(), '', '', CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsgranted(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Discountsreceived(), CreateDKGLAcc.Costofgoodssold(), '', '');
