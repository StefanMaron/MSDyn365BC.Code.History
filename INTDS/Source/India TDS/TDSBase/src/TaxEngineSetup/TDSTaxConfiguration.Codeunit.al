codeunit 18694 "TDS Tax Configuration"
{
    ...
    begin
        ...
        UseCases.Add('{A8E114BF-F8CD-44DB-A2B3-614BC18F4442}', 7);
        ...
        UseCases.Add('{f8bf58d9-7681-458d-9dfc-71ea23a9f853}', 2);
        UseCases.Add('{1abe2c56-9700-4a30-a14a-5e8ecc2f32dd}', 2);
        UseCases.Add('{b8a33720-278b-45b4-8465-2d9fa273d813}', 2);
    end;
