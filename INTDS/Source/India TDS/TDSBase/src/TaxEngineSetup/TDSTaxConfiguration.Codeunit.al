codeunit 18694 "TDS Tax Configuration"
{
    ...
    begin
        ...
        UseCases.Add('{5D4C69D3-E776-4E9D-B397-09336BFDC884}', 2);
        UseCases.Add('{FED919F2-CBDB-45F9-9383-0E1607897400}', 2);
        UseCases.Add('{B0C259BC-64CC-4818-887A-3337D357CDFF}', 3);
        UseCases.Add('{33BFBE99-9140-4112-A55B-35EC0D9B61B9}', 3);
        ...
        UseCases.Add('{FEE5DFFF-0BC1-4246-AD90-6CB3DC44A451}', 2);
        UseCases.Add('{FA0E357D-1AC0-42AA-94DE-6DACA521D38E}', 3);
        UseCases.Add('{7D508D37-53AC-4E44-9669-743A8BA82A3F}', 2);
        UseCases.Add('{25EADDE7-E634-4A01-9E4B-74E7C9D5AA62}', 1);
        UseCases.Add('{9E57C058-0570-4828-B24A-760D35A38D19}', 1);
        UseCases.Add('{D9B47164-1681-4C6F-A746-8D710E5F103D}', 2);
        UseCases.Add('{EB2141B4-1220-462B-AB1A-9BB3FFDF704A}', 2);
        UseCases.Add('{C1C8C9A9-1AE8-48D7-AB60-9EA08AA0AF21}', 2);
        UseCases.Add('{61ED733A-A96B-45ED-BE21-A98A8B65566B}', 2);
        ...
        UseCases.Add('{98E3D17E-B644-4DBA-836C-CF26A20EDD3F}', 2);
        UseCases.Add('{D0CED206-BE26-47A3-A370-D064D8AFCE44}', 1);
        UseCases.Add('{487C3669-B12A-42C0-9FEA-D23AB1426BF6}', 2);
        UseCases.Add('{1E42FDF3-1868-4205-A6D6-D2FC67BD132F}', 3);
        UseCases.Add('{75222E87-A1A0-48EE-9211-D3F59009C287}', 2);
        UseCases.Add('{25C2D9C3-2A87-41A6-9AB9-DC76E818DF0C}', 1);
        UseCases.Add('{08737F79-35F1-4670-BD1D-E41764E3A9DE}', 2);
    end;
